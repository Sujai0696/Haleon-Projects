...
public class CentrumSampleHomepageTest extends BaseClass{
	...
	private void verifyRoundedPillOne() throws Exception {
		switchingTab(firstTab);
	...
	private void verifyRoundedPillTwo() throws Exception {
		switchingTab(firstTab);
	...
	public void verifyRoundedPillThree() throws Exception {
		switchingTab(firstTab);
		hp.clickVitaminPack();
		String preProdUrl = compareUrl(excelRead("Centrum", 1, 0));
		switchingTab(secondTab);
	...
	public void verifyRoundedPillFour() throws Exception {
		switchingTab(firstTab);
	...
	public void verifyFeaturedProductOne() throws Exception {
		switchingTab(firstTab);
		hp.clickFeaturedProductOne();
		String preProdUrl = compareUrl(excelRead("Centrum", 1, 0));
		switchingTab(secondTab);
		hp.clickFeaturedProductOne();
		String liveUrl = compareUrl(excelRead("Centrum", 1, 1));
	...
	private void verifyFeaturedProductTwo() throws Exception {
		switchingTab(firstTab);
		hp.clickFeaturedProductTwo();
		String preProdUrl = compareUrl(excelRead("Centrum", 1, 0));
		switchingTab(secondTab);
		hp.clickFeaturedProductTwo();
		String liveUrl = compareUrl(excelRead("Centrum", 1, 1));
	...
	private void verifyFeaturedProductThree() throws Exception {
		switchingTab(firstTab);
		hp.clickFeaturedProductThree();
		String preProdUrl = compareUrl(excelRead("Centrum", 1, 0));
		switchingTab(secondTab);
		hp.clickFeaturedProductThree();
		String liveUrl = compareUrl(excelRead("Centrum", 1, 1));
	...
	public void verifyFeaturedProductFour() throws Exception {
		switchingTab(firstTab);
		hp.clickFeaturedProductFour();
		String preProdUrl = compareUrl(excelRead("Centrum", 1, 0));
		switchingTab(secondTab);
		hp.clickFeaturedProductFour();
		String liveUrl = compareUrl(excelRead("Centrum", 1, 1));
