...
import com.qa.preph.pages.PrephRapidReliefSprayLidocainePage;


public class PrephRapidReliefSprayLidocaineTest extends BaseClass{
	
	PrephRapidReliefSprayLidocainePage ps;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 ps=new PrephRapidReliefSprayLidocainePage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("preph_Config.properties").getProperty("preProdRapidReliefSprayLidocaineUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("preph_Config.properties").getProperty("LiveRapidReliefSprayLidocaineUrl"));
		 }	
	 ...
	 @Test(priority=3,enabled=true)
		public void verifyRapidReliefsprayLidocaineBreadCrumbsLink() throws Throwable
		{
		 switchingTab(firstTab);
	        ps.clickonRapidReliefspraylidocaineBreadcrumbs();
	        String preProdUrl = compareUrl(excelRead("Preph_US", 1, 0));
	        switchingTab(secondTab);
	        ps.clickonRapidReliefspraylidocaineBreadcrumbs();
	        String liveUrl = compareUrl(excelRead("Preph_US", 1, 1));
	        boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	        System.out.println("Preprod URL and Live URL are same for RapidReliefSprayLidocaine_Breadcrumbs:"+compareTwoText);
		}						
	 ...
	 @Test(priority=5,enabled=true)
		public void verifyBuyNowLink() throws Throwable
		{
		 switchingTab(firstTab);
	        ps.clickonBuyNowBtn();
	        System.out.println("Verified BuyNow Btn is Displayed on PreProd Url");
	        switchingTab(secondTab);
	        ps.clickonBuyNowBtn();
	       System.out.println("Verified BuyNow Btn is Displayed on Live Url");
		}						
