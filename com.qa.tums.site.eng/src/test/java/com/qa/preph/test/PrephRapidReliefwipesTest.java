...
import com.qa.preph.pages.PrephRapidReliefwipesPage;

public class PrephRapidReliefwipesTest extends BaseClass{
	
	PrephRapidReliefwipesPage prw;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 prw=new PrephRapidReliefwipesPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("preph_Config.properties").getProperty("preProdRapidReliefwipesUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("preph_Config.properties").getProperty("LiveRapidReliefwipesUrl"));
		 }	
	 ...
	 @Test(priority=3,enabled=true)
		public void verifyRapidReliefwipesBreadCrumbsLink() throws Throwable
		{
		 switchingTab(firstTab);
	        prw.clickonRapidReliefwipesBreadcrumbs();
	        String preProdUrl = compareUrl(excelRead("Preph_US", 1, 0));
	        switchingTab(secondTab);
	        prw.clickonRapidReliefwipesBreadcrumbs();
	        String liveUrl = compareUrl(excelRead("Preph_US", 1, 1));
	        boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	        System.out.println("Preprod URL and Live URL are same for RapidreliefwipesBreadcrumbs:"+compareTwoText);
		}							
	 ...
	 @Test(priority=5,enabled=true)
		public void verifyBuyNowLink() throws Throwable
		{
		 switchingTab(firstTab);
	        prw.clickonBuyNow();
	        System.out.println("Verified BuyNow button is displayed successfully on Preprod Url");
	        switchingTab(secondTab);
	        prw.clickonBuyNow();
	        System.out.println("Verified BuyNow button is displayed successfully on Live Url");
		}							
