...
import com.qa.theraflu.pages.TherafluNighttimeFluReliefMaxStrengthSyrupPage;

public class TherafluNighttimeFluReliefMaxStrengthSyrupTest extends BaseClass{
	
	TherafluNighttimeFluReliefMaxStrengthSyrupPage mss;
	...
	private void launchingTheUrl() throws Exception {
		mss = new TherafluNighttimeFluReliefMaxStrengthSyrupPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeFluReliefMaxStrengthSyrupPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeFluReliefMaxStrengthSyrupLiveUrl"));
	}
