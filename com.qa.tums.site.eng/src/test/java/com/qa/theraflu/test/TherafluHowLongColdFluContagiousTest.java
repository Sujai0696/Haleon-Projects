...
import com.qa.theraflu.pages.TherafluHowLongColdFluContagiousPage;

public class TherafluHowLongColdFluContagiousTest extends BaseClass{
	
	TherafluHowLongColdFluContagiousPage cfc;
	...
	private void launchingTheUrl() throws Exception {
		cfc = new TherafluHowLongColdFluContagiousPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("howLongColdFluContagiousPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("howLongColdFluContagiousLiveUrl"));
	}
	...
	private void verifyRecommendedArticlesOne() throws Exception{
		switchingTab(firstTab);
		cfc.clickRecommendedArticleOne();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		cfc.clickRecommendedArticleOne();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesTwo() throws Exception{
		switchingTab(firstTab);
		cfc.clickRecommendedArticleTwo();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		cfc.clickRecommendedArticleTwo();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesThree() throws Exception{
		switchingTab(firstTab);
		cfc.clickRecommendedArticleThree();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		cfc.clickRecommendedArticleThree();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesFour() throws Exception{
		switchingTab(firstTab);
		cfc.clickRecommendedArticleFour();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		cfc.clickRecommendedArticleFour();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
