...
import com.qa.theraflu.pages.TherafluFrequentColdsPage;

public class TherafluFrequentColdsTest extends BaseClass{
	
	TherafluFrequentColdsPage fc;
	...
	private void launchingTheUrl() throws Exception {
		fc = new TherafluFrequentColdsPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("frequentColdsPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("frequentColdsLiveUrl"));
	}
	...
	private void verifyRecommendedArticlesThree() throws Exception{
		switchingTab(firstTab);
		fc.clickRecommendedArticleThree();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		fc.clickRecommendedArticleThree();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesFour() throws Exception{
		switchingTab(firstTab);
		fc.clickRecommendedArticleFour();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		fc.clickRecommendedArticleFour();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
