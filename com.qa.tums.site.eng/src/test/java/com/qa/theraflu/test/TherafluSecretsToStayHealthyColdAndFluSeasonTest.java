...
import com.qa.theraflu.pages.TherafluSecretsToStayHealthyColdAndFluSeasonPage;

public class TherafluSecretsToStayHealthyColdAndFluSeasonTest extends BaseClass{
	
	TherafluSecretsToStayHealthyColdAndFluSeasonPage cf;
	...
	private void launchingTheUrl() throws Exception {
		cf = new TherafluSecretsToStayHealthyColdAndFluSeasonPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("secretsToStayHealthyColdAndFluSeasonPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("secretsToStayHealthyColdAndFluSeasonLiveUrl"));
	}
