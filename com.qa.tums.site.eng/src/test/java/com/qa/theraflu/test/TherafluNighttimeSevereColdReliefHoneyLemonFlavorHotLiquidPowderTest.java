...
import com.qa.theraflu.pages.TherafluNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage;

public class TherafluNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderTest extends BaseClass{
	
	TherafluNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderLiveUrl"));
	}
