...
import com.qa.theraflu.pages.TherafluCausesOfCongestionInChestPage;

public class TherafluCausesOfCongestionInChestTest extends BaseClass{
	
	TherafluCausesOfCongestionInChestPage cc;
	...
	private void launchingTheUrl() throws Exception {
		cc = new TherafluCausesOfCongestionInChestPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("causesOfCongestionInChestPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("causesOfCongestionInChestLiveUrl"));
	}
