...
import com.qa.theraflu.pages.TherafluWhoShouldGetTheFluShotPage;

public class TherafluWhoShouldGetTheFluShotTest extends BaseClass{
	
	TherafluWhoShouldGetTheFluShotPage fs;
	...
	private void launchingTheUrl() throws Exception {
		fs = new TherafluWhoShouldGetTheFluShotPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("whoShouldGetTheFluShotPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("whoShouldGetTheFluShotLiveUrl"));
	}
