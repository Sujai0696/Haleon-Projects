...
import com.qa.theraflu.pages.TherafluNighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderPage;

public class TherafluNighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderTest extends BaseClass{
	
	TherafluNighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluNighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderLiveUrl"));
	}
