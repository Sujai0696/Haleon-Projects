...
import com.qa.theraflu.pages.TherafluDaytimeFluReliefMaxStrengthHotLiquidPowderPage;

public class TherafluDaytimeFluReliefMaxStrengthHotLiquidPowderTest extends BaseClass{
	
	TherafluDaytimeFluReliefMaxStrengthHotLiquidPowderPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluDaytimeFluReliefMaxStrengthHotLiquidPowderPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("daytimeFluReliefMaxStrengthHotLiquidPowderPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("daytimeFluReliefMaxStrengthHotLiquidPowderLiveUrl"));
	}
