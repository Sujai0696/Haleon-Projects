...
import com.qa.theraflu.pages.TherafluNighttimeFluReliefMaxStrengthHotLiquidPowderPage;

public class TherafluNighttimeFluReliefMaxStrengthHotLiquidPowderTest extends BaseClass{
	
	TherafluNighttimeFluReliefMaxStrengthHotLiquidPowderPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluNighttimeFluReliefMaxStrengthHotLiquidPowderPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeFluReliefMaxStrengthHotLiquidPowderPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("nighttimeFluReliefMaxStrengthHotLiquidPowderLiveUrl"));
	}
