...
import com.qa.theraflu.pages.TherafluStrangeFactsAboutFluVirusPage;

public class TherafluStrangeFactsAboutFluVirusTest extends BaseClass{
	
	TherafluStrangeFactsAboutFluVirusPage afv;
	...
	private void launchingTheUrl() throws Exception {
		afv = new TherafluStrangeFactsAboutFluVirusPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("strangeFactsAboutFluVirusPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("strangeFactsAboutFluVirusLiveUrl"));
	}
