...
import com.qa.theraflu.pages.TherafluHowToAvoidTheFluWhenYourFamilyIsSickPage;

public class TherafluHowToAvoidTheFluWhenYourFamilyIsSickTest extends BaseClass{
	
	TherafluHowToAvoidTheFluWhenYourFamilyIsSickPage af;
	...
	private void launchingTheUrl() throws Exception {
		af = new TherafluHowToAvoidTheFluWhenYourFamilyIsSickPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("howToAvoidTheFluWhenYourFamilyIsSickPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("howToAvoidTheFluWhenYourFamilyIsSickLiveUrl"));
	}
