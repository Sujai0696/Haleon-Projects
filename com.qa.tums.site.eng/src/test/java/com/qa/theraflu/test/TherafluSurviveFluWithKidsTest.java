...
import com.qa.theraflu.pages.TherafluSurviveFluWithKidsPage;

public class TherafluSurviveFluWithKidsTest extends BaseClass{
	
	TherafluSurviveFluWithKidsPage sfw;
	...
	private void launchingTheUrl() throws Exception {
		sfw = new TherafluSurviveFluWithKidsPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("surviveFluWithKidsPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("surviveFluWithKidsLiveUrl"));
	}
	...
	private void verifyRecommendedArticlesOne() throws Exception{
		switchingTab(firstTab);
		sfw.clickRecommendedArticleOne();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		sfw.clickRecommendedArticleOne();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesTwo() throws Exception{
		switchingTab(firstTab);
		sfw.clickRecommendedArticleTwo();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		sfw.clickRecommendedArticleTwo();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesThree() throws Exception{
		switchingTab(firstTab);
		sfw.clickRecommendedArticleThree();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		sfw.clickRecommendedArticleThree();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesFour() throws Exception{
		switchingTab(firstTab);
		sfw.clickRecommendedArticleFour();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		sfw.clickRecommendedArticleFour();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
