...
import com.qa.theraflu.pages.TherafluSinusProblemsGuidePage;

public class TherafluSinusProblemsGuideTest extends BaseClass{
	
	TherafluSinusProblemsGuidePage spg;
	...
	private void launchingTheUrl() throws Exception {
		spg = new TherafluSinusProblemsGuidePage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("sinusProblemsGuidePreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("sinusProblemsGuideLiveUrl"));
	}
	...
	private void verifyRecommendedArticlesOne() throws Exception{
		switchingTab(firstTab);
		spg.clickRecommendedArticleOne();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		spg.clickRecommendedArticleOne();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesTwo() throws Exception{
		switchingTab(firstTab);
		spg.clickRecommendedArticleTwo();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		spg.clickRecommendedArticleTwo();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesThree() throws Exception{
		switchingTab(firstTab);
		spg.clickRecommendedArticleThree();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		spg.clickRecommendedArticleThree();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
	...
	private void verifyRecommendedArticlesFour() throws Exception{
		switchingTab(firstTab);
		spg.clickRecommendedArticleFour();
		String preProdUrl = compareUrl(excelRead("Theraflu_US", 1, 0));
		switchingTab(secondTab);
		spg.clickRecommendedArticleFour();
		String liveUrl = compareUrl(excelRead("Theraflu_US", 1, 1));
