...
import com.qa.theraflu.pages.TherafluDaytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderPage;

public class TherafluDaytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderTest extends BaseClass{
	
	TherafluDaytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluDaytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("daytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("daytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderLiveUrl"));
	}
