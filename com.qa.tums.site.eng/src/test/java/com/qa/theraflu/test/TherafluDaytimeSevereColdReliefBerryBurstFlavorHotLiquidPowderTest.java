...
import com.qa.theraflu.pages.TherafluDaytimeSevereColdReliefBerryBurstFlavorHotLiquidPowderPage;

public class TherafluDaytimeSevereColdReliefBerryBurstFlavorHotLiquidPowderTest extends BaseClass{
	
	TherafluDaytimeSevereColdReliefBerryBurstFlavorHotLiquidPowderPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluDaytimeSevereColdReliefBerryBurstFlavorHotLiquidPowderPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("daytimeSevereColdReliefBerryBurstFlavorHotLiquidPowderPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("daytimeSevereColdReliefBerryBurstFlavorHotLiquidPowderLiveUrl"));
	}
