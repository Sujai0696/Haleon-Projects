...
import com.qa.theraflu.pages.TherafluComboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersPage;

public class TherafluComboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersTest extends BaseClass{
	
	TherafluComboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersPage hlp;
	...
	private void launchingTheUrl() throws Exception {
		hlp = new TherafluComboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("comboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("comboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersLiveUrl"));
	}
