...
import com.qa.theraflu.pages.TherafluWhatIsAHeadColdPage;

public class TherafluWhatIsAHeadColdTest extends BaseClass{
	
	TherafluWhatIsAHeadColdPage hc;
	...
	private void launchingTheUrl() throws Exception {
		hc = new TherafluWhatIsAHeadColdPage();
		switchingTab(firstTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("whatIsAHeadColdPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("theraflu_Config.properties").getProperty("whatIsAHeadColdLiveUrl"));
	}
