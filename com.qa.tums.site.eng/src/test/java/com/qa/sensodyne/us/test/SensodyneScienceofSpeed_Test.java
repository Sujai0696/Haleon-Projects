...
import com.qa.sensodyne.us.page.SensodyneScienceofSpeed_Pages;

public class SensodyneScienceofSpeed_Test extends BaseClass{
	
	SensodyneScienceofSpeed_Pages sp;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 sp=new SensodyneScienceofSpeed_Pages();
	        switchingTab(firstTab);
	        launchURL(loadConfig("sensodyneConfig.properties").getProperty("preProdSensodyneScienceofSpeedUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("sensodyneConfig.properties").getProperty("liveSensodyneScienceofSpeedUrl"));
		 }
	 ...
	 @Test(priority = 2, enabled = true)
	    private void VerifySensodyneSkiGearSpeedBreadCrumbs_Button() throws Exception {
		     switchingTab(firstTab);
	         sp.clickOnSensodyneSkiGearSpeedBreadcrumbs();
	         String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
	         switchingTab(secondTab);
	         sp.clickOnSensodyneSkiGearSpeedBreadcrumbs();
	         String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
