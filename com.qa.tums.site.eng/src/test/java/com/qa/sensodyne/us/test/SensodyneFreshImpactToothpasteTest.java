...
import com.qa.sensodyne.us.page.SensodyneFreshImpactToothpaste;

public class SensodyneFreshImpactToothpasteTest extends BaseClass {
	SensodyneFreshImpactToothpaste sfi;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL(loadConfig("sensodyneConfig.properties").getProperty("SensodyneFreshImpactToothpastePreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("sensodyneConfig.properties").getProperty("SensodyneFreshImpactToothpasteLiveUrl"));
	}
	@Test(priority = 1, enabled = true)
	private void cookieButton() throws Exception {
	sfi =new SensodyneFreshImpactToothpaste();
	switchingTab(firstTab);
	sfi.clickCookieBtn();
	sfi.clickGigyaForm();
	...
	private void verifyMostPopularProductsOne() throws Exception{
		switchingTab(firstTab);
		sfi.clickMostPopularProductsOne();
		String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
		switchingTab(secondTab);
		sfi.clickMostPopularProductsOne();
		String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
	...
	private void verifyMostPopularProductsTwo() throws Exception{
		switchingTab(firstTab);
		sfi.clickMostPopularProductsTwo();
		String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
		switchingTab(secondTab);
		sfi.clickMostPopularProductsTwo();
		String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
	...
	private void verifyMostPopularProductsThree() throws Exception{
		switchingTab(firstTab);
		sfi.clickMostPopularProductsThree();
		String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
		switchingTab(secondTab);
		sfi.clickMostPopularProductsThree();
		String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
	...
	private void verifyMostPopularProductsFour() throws Exception{
		switchingTab(firstTab);
		sfi.clickMostPopularProductsFour();
		String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
		switchingTab(secondTab);
		sfi.clickMostPopularProductsFour();
		String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
	...
	private void verifyMostPopularProductsFive() throws Exception{
		switchingTab(firstTab);
		sfi.clickMostPopularProductsFive();
		String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
		switchingTab(secondTab);
		sfi.clickMostPopularProductsFive();
		String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
