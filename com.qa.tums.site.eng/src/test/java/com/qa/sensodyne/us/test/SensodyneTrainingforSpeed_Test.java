...
import com.qa.sensodyne.us.page.SensodyneTrainingforSpeed_Pages;

public class SensodyneTrainingforSpeed_Test extends BaseClass{
	
	SensodyneTrainingforSpeed_Pages sp;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 sp=new SensodyneTrainingforSpeed_Pages();
	        switchingTab(firstTab);
	        launchURL(loadConfig("sensodyneConfig.properties").getProperty("preProdSensodyneTrainingforSpeedUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("sensodyneConfig.properties").getProperty("liveSensodyneTrainingforSpeedUrl"));
		 }
	 ...
	 @Test(priority = 2, enabled = true)
	    private void VerifyTrainingforSpeedBreadCrumbs_Button() throws Exception {
		     switchingTab(firstTab);
	         sp.clickOnSensodyneTrainingforSpeedBreadcrumbs();
	         String preProdUrl = compareUrl(excelRead("Sensodyne", 1, 0));
	         switchingTab(secondTab);
	         sp.clickOnSensodyneTrainingforSpeedBreadcrumbs();
	         String liveUrl = compareUrl(excelRead("Sensodyne", 1, 1));
