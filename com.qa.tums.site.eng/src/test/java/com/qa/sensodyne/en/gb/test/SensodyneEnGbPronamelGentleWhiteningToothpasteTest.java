...
import com.qa.sensodyne.en.gb.pages.SensodyneEnGbPronamelGentleWhiteningToothpastePage;

public class SensodyneEnGbPronamelGentleWhiteningToothpasteTest extends BaseClass{
	
	
	SensodyneEnGbPronamelGentleWhiteningToothpastePage pgwt;
	...
	private void launchingTheUrl() throws Exception {
		pgwt = new	SensodyneEnGbPronamelGentleWhiteningToothpastePage();
		switchingTab(firstTab);
		launchURL(loadConfig("sensodyne_en_gbConfig.properties").getProperty("pronamelGentleWhiteningToothpastePreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("sensodyne_en_gbConfig.properties").getProperty("pronamelGentleWhiteningToothpasteLiveUrl"));
	}
	...
	private void verifyMostPopularProductOne() throws Exception{
		switchingTab(firstTab);
		pgwt.clickMostPopularProductOne();
		String preProdUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 0));
		switchingTab(secondTab);
		pgwt.clickMostPopularProductOne();
		String liveUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 1));
	...
	private void verifyMostPopularProductTwo() throws Exception{
		switchingTab(firstTab);
		pgwt.clickMostPopularProductTwo();
		String preProdUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 0));
		switchingTab(secondTab);
		pgwt.clickMostPopularProductTwo();
		String liveUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 1));
	...
	private void verifyMostPopularProductThree() throws Exception{
		switchingTab(firstTab);
		pgwt.clickMostPopularProductThree();
		String preProdUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 0));
		switchingTab(secondTab);
		pgwt.clickMostPopularProductThree();
		String liveUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 1));
	...
	private void verifyMostPopularProductFour() throws Exception{
		switchingTab(firstTab);
		pgwt.clickMostPopularProductFour();
		String preProdUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 0));
		switchingTab(secondTab);
		pgwt.clickMostPopularProductFour();
		String liveUrl = compareUrl(excelRead("Sensodyne_EN_GB", 1, 1));
