...
import com.qa.sensodyne.ca.pages.SensodyneCaSoftBristleToothbrushPage;

public class SensodyneCaSoftBristleToothbrushTest extends BaseClass{
	
	SensodyneCaSoftBristleToothbrushPage sbt;
	...
	private void launchingTheUrl() throws Exception {
		sbt = new	SensodyneCaSoftBristleToothbrushPage();
		switchingTab(firstTab);
		launchURL(loadConfig("sensodyne_caConfig.properties").getProperty("softBristleToothbrushPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("sensodyne_caConfig.properties").getProperty("softBristleToothbrushLiveUrl"));
	}
	
	@Test(priority = 1)
	private void verifyBreadcrumbOne() throws Exception{
		switchingTab(firstTab);
		sbt.clickBreadcrumbOne();
	...
	private void verifyAvailableProductTextOne() throws Exception{
		switchingTab(firstTab);
		sbt.clickAvailableProductTextOne();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickAvailableProductTextOne();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyAvailableProductImgOne() throws Exception{
		switchingTab(firstTab);
		sbt.clickAvailableProductImgOne();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickAvailableProductImgOne();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyHyperLinkSensitiveTeeth() throws Exception{
		switchingTab(firstTab);
		sbt.clickHyperLinkSensitiveTeeth();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickHyperLinkSensitiveTeeth();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyHyperLinkSensodyneToothpaste() throws Exception{
		switchingTab(firstTab);
		sbt.clickHyperLinkSensodyneToothpaste();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickHyperLinkSensodyneToothpaste();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyHyperLinkFindOutHowBrushYourTeeth() throws Exception{
		switchingTab(firstTab);
		sbt.clickHyperLinkFindOutHowBrushYourTeeth();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickHyperLinkFindOutHowBrushYourTeeth();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyMostPopularProductOne() throws Exception{
		switchingTab(firstTab);
		sbt.clickMostPopularProductOne();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickMostPopularProductOne();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyMostPopularProductTwo() throws Exception{
		switchingTab(firstTab);
		sbt.clickMostPopularProductTwo();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickMostPopularProductTwo();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyMostPopularProductThree() throws Exception{
		switchingTab(firstTab);
		sbt.clickMostPopularProductThree();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickMostPopularProductThree();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyMostPopularProductFour() throws Exception{
		switchingTab(firstTab);
		sbt.clickMostPopularProductFour();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickMostPopularProductFour();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
	...
	private void verifyMostPopularProductFive() throws Exception{
		switchingTab(firstTab);
		sbt.clickMostPopularProductFive();
		String preProdUrl = compareUrl(excelRead("Sensodyne_CA", 1, 0));
		switchingTab(secondTab);
		sbt.clickMostPopularProductFive();
		String liveUrl = compareUrl(excelRead("Sensodyne_CA", 1, 1));
