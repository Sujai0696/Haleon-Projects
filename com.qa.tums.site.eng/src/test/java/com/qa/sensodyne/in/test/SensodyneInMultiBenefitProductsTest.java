...
import com.qa.sensodyne.in.pages.SensodyneInMultiBenefitProductsPage;

public class SensodyneInMultiBenefitProductsTest extends BaseClass{
	
	SensodyneInMultiBenefitProductsPage mbp;
	...
	private void launchingTheUrl() throws Exception {
		mbp = new	SensodyneInMultiBenefitProductsPage();
		switchingTab(firstTab);
		launchURL(loadConfig("sensodyne_inConfig.properties").getProperty("multiBenefitProductsPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("sensodyne_inConfig.properties").getProperty("multiBenefitProductsLiveUrl"));
	}
