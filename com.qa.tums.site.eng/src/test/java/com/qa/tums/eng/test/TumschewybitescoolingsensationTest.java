...
import com.qa.tums.eng.pages.TumschewybitescoolingsensationPages;

public class TumschewybitescoolingsensationTest extends BaseClass{

	TumschewybitescoolingsensationPages tc;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		tc=new TumschewybitescoolingsensationPages();
	        switchingTab(firstTab);
	        launchURL(loadConfig("tumsConfig.properties").getProperty("preProdTumschewybitescoolingsensationUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("tumsConfig.properties").getProperty("liveTumschewybitescoolingsensationUrl"));
		 }
	...
	public void verifychewybitecoolingsensationbreadcrumbsLink() throws Throwable
	{
		switchingTab(firstTab);
        tc.clickonchewybitecoolingsensationbreadcrumbs();
        String preProdUrl = compareUrl(excelRead("Tums", 1, 0));
        switchingTab(secondTab);
        tc.clickonchewybitecoolingsensationbreadcrumbs();
        String liveUrl = compareUrl(excelRead("Tums", 1, 1));
