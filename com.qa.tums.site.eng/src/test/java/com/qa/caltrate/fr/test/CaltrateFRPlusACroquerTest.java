...
import com.qa.caltrate.fr.pages.CaltrateFRPlusACroquerPage;

public class CaltrateFRPlusACroquerTest extends BaseClass{
	
	CaltrateFRPlusACroquerPage cp;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL(loadConfig("caltrate_frConfig.properties").getProperty("plusACroquerPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("caltrate_frConfig.properties").getProperty("plusACroquerLiveUrl"));
	}
	
	@Test(priority = 0)
	private void verifyBreadcrumbOne() throws Exception{
		cp = new CaltrateFRPlusACroquerPage();
		switchingTab(firstTab);
