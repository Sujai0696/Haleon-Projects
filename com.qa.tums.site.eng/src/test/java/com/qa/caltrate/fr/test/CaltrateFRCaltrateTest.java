...
import com.qa.caltrate.fr.pages.CaltrateFRCaltratePage;

public class CaltrateFRCaltrateTest extends BaseClass{
	
	CaltrateFRCaltratePage cp;
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL(loadConfig("caltrate_frConfig.properties").getProperty("caltratePreprodUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("caltrate_frConfig.properties").getProperty("caltrateLiveUrl"));
	}
	
	@Test(priority = 0)
	private void verifyBreadcrumbOne() throws Exception{
		cp = new CaltrateFRCaltratePage();
		switchingTab(firstTab);
