...
import com.qa.caltrate.ca.pages.CaltrateCaltratePlus;

public class CaltrateCaltratePlusTest extends BaseClass{
	CaltrateCaltratePlus ccp;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		ccp = new CaltrateCaltratePlus();
		switchingTab(firstTab);
		launchURL(loadConfig("Caltrate_caConfig.properties").getProperty("CaltratePlusPreprodURL"));
		switchingTab(secondTab);
		launchURL(loadConfig("Caltrate_caConfig.properties").getProperty("CaltratePlusLiveURL"));
