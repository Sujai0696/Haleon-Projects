...
import com.qa.caltrate.eng.pages.CaltrateKaleChips;

public class CaltrateKaleChipsTest extends BaseClass{
	CaltrateKaleChips ckc;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		ckc = new CaltrateKaleChips();
		switchingTab(firstTab);
		launchURL(loadConfig("CaltrateConfig.properties").getProperty("CaltrateKaleChipsPreprodURL"));
		switchingTab(secondTab);
		launchURL(loadConfig("CaltrateConfig.properties").getProperty("CaltrateKaleChipsLiveURL"));
	...
	private void verifyCALTRATEGUMMYBITES() throws Throwable {
		switchingTab(firstTab);
		ckc.clickOnCALTRATEGUMMYBITES();
		String preProdUrl = compareUrl(excelRead("Caltrate", 1, 0));
		switchingTab(secondTab);
		ckc.clickOnCALTRATEGUMMYBITES();
		String liveUrl = compareUrl(excelRead("Caltrate", 1, 1));
