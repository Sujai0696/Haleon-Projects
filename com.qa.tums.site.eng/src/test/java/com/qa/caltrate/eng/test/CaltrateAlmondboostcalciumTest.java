...
import com.qa.caltrate.eng.pages.CaltrateAlmondboostcalciumPage;


public class CaltrateAlmondboostcalciumTest extends BaseClass{
	
	CaltrateAlmondboostcalciumPage cc;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		cc=new CaltrateAlmondboostcalciumPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("caltrateConfig.properties").getProperty("preProdCaltrateAlmondboostcalciumUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("caltrateConfig.properties").getProperty("LiveCaltrateAlmondboostcalciumUrl"));
		 }
	 ...
	 @Test(priority=4,enabled=true)
		public void verifyMilkAddAlmondsbreadcrumbsLink() throws Throwable
		{
			switchingTab(firstTab);
	        cc.clickonMilkAddAlmondbreadcrumbs();
	        String preProdUrl = compareUrl(excelRead("Caltrate", 1, 0));
	        switchingTab(secondTab);
	        cc.clickonMilkAddAlmondbreadcrumbs();
	        String liveUrl = compareUrl(excelRead("Caltrate", 1, 1));
