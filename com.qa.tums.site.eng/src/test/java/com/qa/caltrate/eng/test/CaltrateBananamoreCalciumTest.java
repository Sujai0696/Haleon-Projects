...
import com.qa.caltrate.eng.pages.CaltrateBananamoreCalciumPage;


public class CaltrateBananamoreCalciumTest extends BaseClass{
	
	CaltrateBananamoreCalciumPage cc;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		cc=new CaltrateBananamoreCalciumPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("caltrateConfig.properties").getProperty("preProdCaltrateBananamorecalciumUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("caltrateConfig.properties").getProperty("LiveCaltrateBananamorecalciumUrl"));
		 }
	 ...
	 @Test(priority=4,enabled=true)
		public void verifyBreakfastbananaSplitbreadcrumbsLink() throws Throwable
		{
			switchingTab(firstTab);
	        cc.clickonbreakfastbananasplitbreadcrumbs();
	        String preProdUrl = compareUrl(excelRead("Caltrate", 1, 0));
	        switchingTab(secondTab);
	        cc.clickonbreakfastbananasplitbreadcrumbs();
	        String liveUrl = compareUrl(excelRead("Caltrate", 1, 1));
