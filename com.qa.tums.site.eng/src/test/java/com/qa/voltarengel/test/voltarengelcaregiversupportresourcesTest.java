...
import com.qa.voltarengel.pages.voltarengelcaregiversupportresourcesPage;

public class voltarengelcaregiversupportresourcesTest extends BaseClass{
	
	voltarengelcaregiversupportresourcesPage vn;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		vn=new voltarengelcaregiversupportresourcesPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("voltarengel_Config.properties").getProperty("preProdVoltarengelcaregiversupportresourcesUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("voltarengel_Config.properties").getProperty("LiveVoltarengelcaregiversupportresourcesUrl"));
		 }
	 ...
	 @Test(priority = 3, enabled = true)
	    private void Verifycaregiversupportresource_breadcrumbs_Button() throws Exception {
		     switchingTab(firstTab);
	         vn.clickoncaregiversupportresource_Breadcrumbs();
	         String preProdUrl = compareUrl(excelRead("Voltarengel", 1, 0));
	         switchingTab(secondTab);
	         vn.clickoncaregiversupportresource_Breadcrumbs();
	         String liveUrl = compareUrl(excelRead("Voltarengel", 1, 1));
	         boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	         System.out.println("Preprod URL and Live URL are same for using Care giver support Resource Breadcrumbs:"+compareTwoText);
	    }									
	 @Test(priority = 4, enabled = true)
	    private void VerifyShowReferences_Button() throws Exception {
		     switchingTab(firstTab);
	         vn.clickonShowReferences();
	        System.out.println("Verified Show References  clickable successfully on Preprod Url");
	         switchingTab(secondTab);
	         vn.clickonShowReferences();
	         System.out.println("Verified Show References  clickable successfully on Live Url");
	    }					
