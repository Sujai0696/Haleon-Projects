...
import com.qa.voltarengel.pages.VoltarengelAnklePage;

public class VoltarengelAnkleTest extends BaseClass{
	
	VoltarengelAnklePage ap;
	...
	private void launchingTheUrl() throws Exception {
		ap = new VoltarengelAnklePage();
		switchingTab(firstTab);
		launchURL(loadConfig("voltarengel_Config.properties").getProperty("anklePreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("voltarengel_Config.properties").getProperty("ankleLiveUrl"));
	}
