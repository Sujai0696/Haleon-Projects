...
import com.qa.voltarengel.pages.volatrengelNewsletterPage;

public class volatrengelNewsletterTest extends BaseClass{
	
	volatrengelNewsletterPage vn;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		vn=new volatrengelNewsletterPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("voltarengel_Config.properties").getProperty("preProdNewsletterUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("voltarengel_Config.properties").getProperty("LiveNewsletterUrl"));
		 }
	 ...
	 @Test(priority = 1)
	 private void verifyRadio() throws Exception{
		 switchingTab(firstTab);
		 vn.clickonRadiobtns();
