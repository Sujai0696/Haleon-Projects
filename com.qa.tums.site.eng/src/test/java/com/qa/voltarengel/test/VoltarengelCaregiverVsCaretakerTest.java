...
import com.qa.voltarengel.pages.VoltarengelCaregiverVsCaretaker;

public class VoltarengelCaregiverVsCaretakerTest extends BaseClass{
	VoltarengelCaregiverVsCaretaker vwc;
	@BeforeClass
	...
	private void launchingTheUrl() throws Exception {
		vwc = new VoltarengelCaregiverVsCaretaker();
		switchingTab(firstTab);
		launchURL(loadConfig("voltarengel_Config.properties").getProperty("VoltarengelCaregiverVsCaretakePreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("voltarengel_Config.properties").getProperty("VoltarengelCaregiverVsCaretakeLiveUrl"));
	}
