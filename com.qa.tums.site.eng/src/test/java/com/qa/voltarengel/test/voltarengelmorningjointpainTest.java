...
import com.qa.voltarengel.pages.voltarengelmorningjointpainPage;

public class voltarengelmorningjointpainTest extends BaseClass{
	
	voltarengelmorningjointpainPage vn;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		vn=new voltarengelmorningjointpainPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("voltarengel_Config.properties").getProperty("preProdvoltarengelmorningjointpainUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("voltarengel_Config.properties").getProperty("LivevoltarengelmorningjointpainUrl"));
		 }
	 ...
	 @Test(priority = 3, enabled = true)
	    private void VerifyMorningjointpain_breadcrumbs_Button() throws Exception {
		     switchingTab(firstTab);
	         vn.clickonMorningjointpain_Breadcrumbs();
	         String preProdUrl = compareUrl(excelRead("Voltarengel", 1, 0));
	         switchingTab(secondTab);
	         vn.clickonMorningjointpain_Breadcrumbs();
	         String liveUrl = compareUrl(excelRead("Voltarengel", 1, 1));
	         boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	         System.out.println("Preprod URL and Live URL are same for using Morning joint pain_Breadcrumbs:"+compareTwoText);
	    }									
