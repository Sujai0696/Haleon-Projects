...
import com.qa.voltarengel.pages.voltarengelcaregiverburdenPage;

public class voltarengelcaregiverburdenTest extends BaseClass{
	
	voltarengelcaregiverburdenPage vn;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
		...
		vn=new voltarengelcaregiverburdenPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("voltarengel_Config.properties").getProperty("preProdvoltarengelcaregiverburdenUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("voltarengel_Config.properties").getProperty("LivevoltarengelcaregiverburdenUrl"));
		 }
	 ...
	 @Test(priority = 3, enabled = true)
	    private void VerifyWhatiscaregiverburden_Breadcrumbs_Button() throws Exception {
		     switchingTab(firstTab);
	         vn.clickonwhatiscaregiverburden_Breadcrumbs();
	         String preProdUrl = compareUrl(excelRead("Voltarengel", 1, 0));
	         switchingTab(secondTab);
	         vn.clickonwhatiscaregiverburden_Breadcrumbs();
	         String liveUrl = compareUrl(excelRead("Voltarengel", 1, 1));
	         boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	         System.out.println("Preprod URL and Live URL are same for using What is caregiverburden_Breadcrumbs:"+compareTwoText);
	    }														
