...
import com.qa.drbest.ge.pages.drbestVibrationAtemfrischPage;

public class drbestVibrationAtemfrischTest extends BaseClass{
	
	drbestVibrationAtemfrischPage dv;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 dv=new drbestVibrationAtemfrischPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("drbest_deConfig.properties").getProperty("preProddrbestVibrationAtemfrischUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("drbest_deConfig.properties").getProperty("LivedrbestVibrationAtemfrischUrl"));
		 }	
