...
import com.qa.abreva.pages.AbrevawheregetcoldsorePage;

public class AbrevawheregetcoldsoreTest extends BaseClass{
	
	AbrevawheregetcoldsorePage ac;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 ac=new AbrevawheregetcoldsorePage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("abreva_Config.properties").getProperty("preProdAbrevawheregetcoldsoreUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("abreva_Config.properties").getProperty("LiveAbrevawheregetcoldsoreUrl"));
		 }	
