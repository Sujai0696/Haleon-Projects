...
import com.qa.abreva.pages.AbrevaStressPage;
import com.qa.baseClass.BaseClass;

public class AbrevaStressTest extends BaseClass{
	...
	private void launchingTheUrl() throws Exception {
		sp = new AbrevaStressPage();
		switchingTab(firstTab);
		launchURL(loadConfig("Abreva_Config.properties").getProperty("stressPreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("Abreva_Config.properties").getProperty("stressLiveUrl"));
	}
