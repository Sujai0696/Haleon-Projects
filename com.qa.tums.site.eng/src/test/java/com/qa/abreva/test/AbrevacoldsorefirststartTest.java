...
import com.qa.abreva.pages.AbrevacoldsorefirststartPage;


public class AbrevacoldsorefirststartTest extends BaseClass{

	AbrevacoldsorefirststartPage ac;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 ac=new AbrevacoldsorefirststartPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("abreva_Config.properties").getProperty("preProdAbrevacoldsorefirststartUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("abreva_Config.properties").getProperty("LiveAbrevacoldsorefirststartUrl"));
		 }	
	 ...
	 @Test(priority=9,enabled=true)
		public void verifyExercisingLink() throws Throwable
		{
		 switchingTab(firstTab);
	        ac.clickonExercising();
	        String preProdUrl = compareUrl(excelRead("Abreva", 1, 0));
	        switchingTab(secondTab);
	        ac.clickonExercising();
	        String liveUrl = compareUrl(excelRead("Abreva", 1, 1));
	        boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	        System.out.println("Preprod URL and Live URL are same for Exercising:"+compareTwoText);
		}						
	 ...
	 @Test(priority=11,enabled=true)
		public void verifyManageTriggersLink() throws Throwable
		{
		 switchingTab(firstTab);
	        ac.clickonManageTriggers();
	        String preProdUrl = compareUrl(excelRead("Abreva", 1, 0));
	        switchingTab(secondTab);
	        ac.clickonManageTriggers();
	        String liveUrl = compareUrl(excelRead("Abreva", 1, 1));
	        boolean compareTwoText = compareTwoText(preProdUrl, liveUrl);
	        System.out.println("Preprod URL and Live URL are same for Manage Triggers:"+compareTwoText);
		}					
