...
import com.qa.abreva.pages.AbrevahealthyliptipsPage;

public class AbrevahealthyliptipsTest extends BaseClass{
	
	AbrevahealthyliptipsPage ac;
	...
	private void launchingTheBrowser() throws IOException, Exception {
	 ...
	 @BeforeMethod
	    private void launchingTheUrl() throws IOException, Exception {
		 ac=new AbrevahealthyliptipsPage();
	        switchingTab(firstTab);
	        launchURL(loadConfig("abreva_Config.properties").getProperty("preProdAbrevahealthyliptipsUrl"));
			switchingTab(secondTab);
			launchURL(loadConfig("abreva_Config.properties").getProperty("LiveAbrevahealthyliptipsUrl"));
		 }	
