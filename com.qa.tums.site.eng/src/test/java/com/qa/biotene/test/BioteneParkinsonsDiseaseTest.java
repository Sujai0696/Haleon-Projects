...
public class BioteneParkinsonsDiseaseTest extends BaseClass{
	...
	private void launchingTheUrl() throws Exception {
		...
		launchURL(loadConfig("biotene_Config.properties").getProperty("BioteneParkinsonsDiseasePreProdUrl"));
		switchingTab(secondTab);
		launchURL(loadConfig("biotene_Config.properties").getProperty("BioteneParkinsonsDiseaseLiveUrl"));
	}
