...
public class DrBestkinderErsteZahne extends BaseClass{
	
	public DrBestkinderErsteZahne() {
	...
	@FindBy(xpath = "//span[text()='Meine Bewertung für Dr.BEST Erste Zähne Weich']")
...
//	private static WebElement ReviewClose1;
	...
	private static WebElement DrBESTMilchzahnImage;
...
//				
//			}
			public void clickonDrBESTMilchzahnImage() throws Exception {
				waitForPageLoadJava();
				scrollDownUsingElement(Heading);
				clickElementUsingJavaScript(DrBESTMilchzahnImage);
				pageLoad();
			}
