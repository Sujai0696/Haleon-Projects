...
public class DrBestProfessionalAtemfrisch extends BaseClass{
	public DrBestProfessionalAtemfrisch() {
	...
	@FindBy(xpath = "//span[text()='Meine Bewertung für Dr.BEST Polimed Mittel']")
...
//	private static WebElement ReviewClose1;
	...
	@FindBy(xpath = "//h2[text()='Weitere Produkte für eine gründliche Reinigung und frischen Atem:']")
