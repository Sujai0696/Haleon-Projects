...
public class DrBestKinderMilchzahn extends BaseClass{
	public DrBestKinderMilchzahn() {
	...
	@FindBy(xpath = "//span[text()='Meine Bewertung für Dr.BEST Milchzahn Weich']")
...
//	private static WebElement ReviewClose1;
	...
	private static WebElement Product1Image;
	...
	private static WebElement Product2Image;
	...
	@FindBy(xpath = "(//figure)[3]")
	private static WebElement Product3Image;

	@FindBy(xpath = "(//a[text()='Mehr erfahren'])[3]")
	private static WebElement MehrErfahren3;
	
	@FindBy(xpath = "(//div[@class='component-content']//buynow-button)[3]")
	private static WebElement JetztKaufen3;
...
//				
//			}
			public void clickonProduct1Image() throws Exception {
				waitForPageLoadJava();
				scrollDownUsingElement(Heading);
				clickElementUsingJavaScript(Product1Image);
				pageLoad();
			}
			...
			public void clickonProduct2Image() throws Exception {
				waitForPageLoadJava();
				scrollDownUsingElement(Heading);
				clickElementUsingJavaScript(Product2Image);
				pageLoad();
			}
