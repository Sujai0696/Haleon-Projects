...
public class TumsAntacidProductsSmoothiesPage extends BaseClass{
	
	public TumsAntacidProductsSmoothiesPage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Smoothies™']")
	...
	@FindBy(xpath = "//h2[text()='TUMS Smoothies Assorted Fruit, 12 ct']")
