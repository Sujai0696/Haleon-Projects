...
public class TumsAntacidProductsExtra750Page extends BaseClass{
	
	public TumsAntacidProductsExtra750Page() {
	...
	@FindBy(xpath = "//span[text()='My Review for Extra Strength 750']")
	...
	@FindBy(xpath = "//h2[text()='TUMS Extra Strength Tablets Assorted Berries, 8 ct Roll']")
