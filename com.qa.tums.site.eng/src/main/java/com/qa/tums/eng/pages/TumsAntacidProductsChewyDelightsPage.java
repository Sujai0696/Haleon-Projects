...
public class TumsAntacidProductsChewyDelightsPage extends BaseClass{
	
	public TumsAntacidProductsChewyDelightsPage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Chewy Delights®']")
	...
	@FindBy(xpath = "//h2[text()='TUMS Chewy Delights Very Cherry, 6 ct']")
