...
public class TumsAntacidProductsSugarFreePage extends BaseClass{
	
	public TumsAntacidProductsSugarFreePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Sugar Free']")
	...
	@FindBy(xpath = "//h2[text()='TUMS Sugar Free Melon Berry, 80 ct']")
