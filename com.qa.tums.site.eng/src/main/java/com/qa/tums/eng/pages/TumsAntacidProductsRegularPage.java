...
public class TumsAntacidProductsRegularPage extends BaseClass{
	
	public TumsAntacidProductsRegularPage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Regular Strength 500']")
	...
	@FindBy(xpath = "//h2[text()='TUMS Regular Strength Tablets Peppermint, 3 Roll Pack (36 ct)']")
