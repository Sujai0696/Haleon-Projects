...
public class BioteneDryMouthReliefPage extends BaseClass{
	
	public BioteneDryMouthReliefPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='DRY MOUTH RELIEF & CARE']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/living-with-dry-mouth/drinking-water-for-dry-mouth/']//ancestor::span[text()='water to cope with their Dry Mouth']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/living-with-dry-mouth/how-to-relieve-dry-mouth-symptoms/']//ancestor::span[text()='relieve Dry Mouth symptoms']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/dry-mouth-products/moisturizing-mouth-spray/']//ancestor::span[text()='Biotène® Moisturizing Spray']")
