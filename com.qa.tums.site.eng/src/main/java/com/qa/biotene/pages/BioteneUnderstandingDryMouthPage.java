...
public class BioteneUnderstandingDryMouthPage extends BaseClass{
	
	public BioteneUnderstandingDryMouthPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='UNDERSTANDING DRY MOUTH']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/what-is-dry-mouth/dry-mouth-symptoms/']//ancestor::span[text()='eating, swallowing, and speaking difficult']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/what-is-dry-mouth/dry-mouth-causes-medications/']//ancestor::span[text()='primary cause is medication usage']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/dry-mouth-products/mouthwash/']//ancestor::span[contains(text(),'Dry Mouth Oral Rinse')]")
