...
public class BioteneGentleToothpastePage extends BaseClass{
	
	public BioteneGentleToothpastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='BIOTÈNE® FLUORIDE TOOTHPASTE GENTLE MINT ORIGINAL']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[text()='BUY NOW']//preceding::div[@class='gtm-buynow']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[text()='Biotene Gentle Fluoride Toothpaste']")
