...
public class BioteneDryMouthSalivaPage extends BaseClass{
	
	public BioteneDryMouthSalivaPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='What Is Saliva?']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//*[@href='/living-with-dry-mouth/dry-mouth-tips/']//self::a[contains(text(),'keep your mouth moist')]")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//*[@href='/dry-mouth-products/']//ancestor::a[text()='Biotène']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//*[@href='/dry-mouth-products/moisturizing-gel/']//ancestor::a[text()='Biotène® Oralbalance Moisturizing Gel']")
