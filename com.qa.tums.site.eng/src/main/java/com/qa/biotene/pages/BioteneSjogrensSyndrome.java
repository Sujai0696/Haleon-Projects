...
public class BioteneSjogrensSyndrome extends BaseClass{
	public BioteneSjogrensSyndrome() {
	...
	@FindBy(xpath = "//span[text()='Biotène® Moisturizing Spray']")
	private static WebElement BioteneMoisturisingSpray;
...
public void clickEmailBtn() throws Exception {
	...
	public void clickonBioteneMoisturisingSpray() throws Exception {
		waitForPageLoadJava();
		scrollDownUsingElement(BioteneMoisturisingSpray);
		clickElementUsingJavaScript(BioteneMoisturisingSpray);
	}
