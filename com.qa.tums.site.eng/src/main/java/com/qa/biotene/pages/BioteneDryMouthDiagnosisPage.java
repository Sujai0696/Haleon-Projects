...
public class BioteneDryMouthDiagnosisPage extends BaseClass{
	
	public BioteneDryMouthDiagnosisPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='DRY MOUTH DIAGNOSIS']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/what-is-dry-mouth/dry-mouth-causes-medications/']//ancestor::span[text()='antihistamines, decongestants, and diuretics']")
