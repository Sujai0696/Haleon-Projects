...
public class BioteneFreshMintToothPastePage extends BaseClass{
	
	public BioteneFreshMintToothPastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='BIOTÈNE® FLUORIDE TOOTHPASTE FRESH MINT ORIGINAL']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[text()='BUY NOW']//preceding::div[@class='gtm-buynow']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[text()='Biotene Fluoride Toothpaste']")
