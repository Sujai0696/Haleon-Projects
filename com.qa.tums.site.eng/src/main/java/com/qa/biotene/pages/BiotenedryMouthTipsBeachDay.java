...
public class BiotenedryMouthTipsBeachDay extends BaseClass{
	public BiotenedryMouthTipsBeachDay() {
	...
	@FindBy(xpath = "//span[text()='water alone']")
	private static WebElement WaterAlone;
	
	@FindBy(xpath = "(//a[text()='Biotène® Moisturizing Spray'])[2]")
...
public void clickEmailBtn() throws Exception {
	...
	public void clickonWaterAlone() throws Exception {
		waitForPageLoadJava();
		scrollDownUsingElement(WaterAlone);
		clickElementUsingJavaScript(WaterAlone);
	}
	public void clickonBiotèneMoisturizingSpray() throws Exception {
		waitForPageLoadJava();
		scrollDownUsingElement(BiotèneMoisturizingSpray);
		clickElementUsingJavaScript(BiotèneMoisturizingSpray);
	}
