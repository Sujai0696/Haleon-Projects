...
public class CaltrateFRPlusACroquerPage extends BaseClass{
	
	public CaltrateFRPlusACroquerPage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item odd last is-current ']//self::li[normalize-space()='Caltrate PLUS à croquer']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[normalize-space()='ACHETER MAINTENANT']")
	private static WebElement acheterBtn;
	
	@FindBy(xpath = "//h2[normalize-space()='Caltrate PLUS à croquer 50s']")
