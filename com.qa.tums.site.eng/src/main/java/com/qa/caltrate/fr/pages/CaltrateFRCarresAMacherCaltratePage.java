...
public class CaltrateFRCarresAMacherCaltratePage extends BaseClass{
	
	public CaltrateFRCarresAMacherCaltratePage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item odd last is-current ']//self::li[normalize-space()='Carrés à mâcher Caltrate']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[normalize-space()='ACHETER MAINTENANT']")
	private static WebElement acheterBtn;
	
	@FindBy(xpath = "//h2[normalize-space()='Carrés à mâcher Caltrate chocolat 60s']")
