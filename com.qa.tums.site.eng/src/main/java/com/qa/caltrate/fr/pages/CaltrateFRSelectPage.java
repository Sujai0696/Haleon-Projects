...
public class CaltrateFRSelectPage extends BaseClass{
	
	public CaltrateFRSelectPage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item odd last is-current ']//self::li[normalize-space()='Caltrate SELECT']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[normalize-space()='ACHETER MAINTENANT']")
	private static WebElement acheterBtn;
	
	@FindBy(xpath = "//h2[normalize-space()='Caltrate SELECT 50s']")
