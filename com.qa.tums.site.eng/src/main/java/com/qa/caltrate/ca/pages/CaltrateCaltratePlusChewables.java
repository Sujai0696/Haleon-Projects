...
public class CaltrateCaltratePlusChewables extends BaseClass{
	public CaltrateCaltratePlusChewables() {
...
//	@FindBy(xpath = "//*[@class='breadcrumb-list-item odd last is-current ']")
//	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[normalize-space()='BUY NOW']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[normalize-space()='Caltrate PLUS Chewables 50s']")
