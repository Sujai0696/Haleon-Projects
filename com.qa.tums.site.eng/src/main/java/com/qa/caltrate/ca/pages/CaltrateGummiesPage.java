...
public class CaltrateGummiesPage extends BaseClass{
	
	public CaltrateGummiesPage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item odd last is-current ']//self::li[normalize-space()='Caltrate Gummies']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[normalize-space()='BUY NOW']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[normalize-space()='Caltrate Gummies 50s']")
