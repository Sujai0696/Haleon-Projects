...
public class CaltrateBananamoreCalciumPage extends BaseClass{
	
	public CaltrateBananamoreCalciumPage() {
    ...
    private static WebElement breakfastbananasplitbreadcrumbs;		
	
    @FindBy(xpath = "(//a[@href=\"/bone-health-central/health-tips/\"])[4]")
    private static WebElement healthtipstag;		
...
//methods
  	...
  	public void clickonbreakfastbananasplitbreadcrumbs() throws Throwable {
  		waitForPageLoadJava();
  		elementClick(breakfastbananasplitbreadcrumbs);
  }	
  	public void clickonhealthtipstag() throws Throwable {
  		waitForPageLoadJava();
  		elementClick(healthtipstag);
  }	
