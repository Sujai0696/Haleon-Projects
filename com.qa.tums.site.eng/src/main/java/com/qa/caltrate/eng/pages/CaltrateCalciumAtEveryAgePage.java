...
public class CaltrateCalciumAtEveryAgePage extends BaseClass{
	
	public CaltrateCalciumAtEveryAgePage() {
	...
	private static WebElement readArticles;
	
	@FindBy(xpath = "//div[contains(@class,'first odd last col-xs-12')]//following::img[contains(@src,'product-caltrateminis.jpg?auto=format')]")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd ']//ancestor::a[text()='Interactive Tools']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//*[@class='breadcrumb-list-item even last is-current ']//self::li[normalize-space()='The Story of Your Bones: Calcium at Every Age']")
	...
	public void clickReadArticles() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(readArticles);
		clickElementUsingJavaScript(readArticles);
	}
