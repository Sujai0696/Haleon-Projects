...
public class CaltrateGummyBites extends BaseClass{
	public CaltrateGummyBites() {
	...
	@FindBy(xpath = "(//div[@class='richTextEnhanced richText section richTextHyperlinkedImage title-h first odd component col-xs-12'])[3]")
