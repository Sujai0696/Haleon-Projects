...
public class CaltrateCouponsPage extends BaseClass{
	
	public CaltrateCouponsPage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Сoupons ']")
