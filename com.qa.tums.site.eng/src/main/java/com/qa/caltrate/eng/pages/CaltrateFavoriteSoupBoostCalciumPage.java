...
public class CaltrateFavoriteSoupBoostCalciumPage extends BaseClass{
	
	public CaltrateFavoriteSoupBoostCalciumPage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item even last is-current ']//self::li[normalize-space()='Add ¼ Cup Milk to Your Favorite Soup to Boost Calcium!']")
