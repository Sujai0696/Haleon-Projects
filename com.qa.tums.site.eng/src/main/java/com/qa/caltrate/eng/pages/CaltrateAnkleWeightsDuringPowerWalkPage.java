...
public class CaltrateAnkleWeightsDuringPowerWalkPage extends BaseClass{
	
	public CaltrateAnkleWeightsDuringPowerWalkPage() {
	...
	@FindBy(xpath = "//div[@class='richText component section default-style first odd last col-xs-12']//ancestor::a[normalize-space()='Health Tips']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd ']//ancestor::a[text()='Health Tips']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//*[@class='breadcrumb-list-item even last is-current ']//self::li[normalize-space()='Activate Your Muscles with Ankle Weights During A Power Walk!']")
