...
public class CaltrateRecipesPage extends BaseClass{
	
	public CaltrateRecipesPage() {
	...
	@FindBy(xpath = "//div[@class='richText component section text-left-d text-center-m odd col-xs-12']//following::a[normalize-space()='Recipes']")
	private static WebElement featuredArticleThree;
	
	@FindBy(xpath = "//div[@class='richText component section text-left-d text-center-m even last col-xs-12']//a[@href='/bone-health-central/recipes/summer-strong-shake/']")
	private static WebElement featuredArticleFour;
	
	
	@FindBy(xpath = "//h4[normalize-space()='ARUGULA SALAD']//ancestor::div[@class='box component section p-m-b-1 anchor-box first odd col-xs-12']")
	private static WebElement readMoreOne;
	
	@FindBy(xpath = "//h4[normalize-space()='KALE CHIPS']//ancestor::div[@class='box component section p-m-b-1 anchor-box even col-xs-12']")
	private static WebElement readMoreTwo;
	
	@FindBy(xpath = "//h4[normalize-space()='NEXT-DAY TURKEY SOUP']//ancestor::div[@class='box component section p-m-b-1 anchor-box odd col-xs-12']")
	private static WebElement readMoreThree;
	
	@FindBy(xpath = "//h4[normalize-space()='SALMON CAKES']//ancestor::div[@class='box component section p-m-b-1 anchor-box even col-xs-12']")
	private static WebElement readMoreFour;
	
	@FindBy(xpath = "//h4[normalize-space()='CHEESY CAULIFLOWER SOUP']//ancestor::div[@class='box component section p-d-b-2 p-m-b-1 odd last col-xs-12']")
