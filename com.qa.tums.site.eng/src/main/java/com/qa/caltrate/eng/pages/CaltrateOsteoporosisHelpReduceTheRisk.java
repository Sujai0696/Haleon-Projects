...
public class CaltrateOsteoporosisHelpReduceTheRisk extends BaseClass{
	public CaltrateOsteoporosisHelpReduceTheRisk() {
	...
	private static WebElement OsteoporosisLink;
	...
	@FindBy(xpath = "(//a[text()='Osteoporosis'])[3]")
	...
	public void clickOnOsteoporosisLink() throws Throwable {
		moveToElement(OsteoporosisLink);
		clickElementUsingJavaScript(OsteoporosisLink);
	}
	...
	public void clickOnCALTRATE600D3SOFTCHEWS() throws Throwable {
		moveToElement(CALTRATE600D3SOFTCHEWS);
