...
public class CaltrateHelpFillYourNutitionalGapPage extends BaseClass{

	public CaltrateHelpFillYourNutitionalGapPage() {
	...
	@FindBy(xpath = "//div[@class='richText component section default-style first odd last col-xs-12']//ancestor::a[normalize-space()='Vitamin D']")
	private static WebElement tagsLinkTwo;

	@FindBy(xpath = "//div[@class='richText component section default-style first odd last col-xs-12']//ancestor::a[normalize-space()='Calcium Supplements']")
	private static WebElement tagsLinkThree;

	@FindBy(xpath = "//div[@class='richText component section default-style first odd last col-xs-12']//ancestor::a[normalize-space()='Articles']")
	private static WebElement tagsLinkFour;

	@FindBy(xpath = "//div[@class='richText component section default-style first odd last col-xs-12']//following::a[normalize-space()='Dietary Guidelines']")
	private static WebElement tagsLinkFive;

	@FindBy(xpath = "//a[@href='/bone-health-central/tools/caltrate-beyond-bones/']")
	private static WebElement readMoreLink;
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd ']//ancestor::a[text()='Articles']")
	private static WebElement breadcrumbThree;

	@FindBy(xpath = "//*[@class='breadcrumb-list-item even last is-current ']//self::li[normalize-space()='Trust Calcium Supplements to Help Fill Your Nutritional Gap']")
	...
	public void clickTagsLinkThree() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(tagsLinkThree);
		clickElementUsingJavaScript(tagsLinkThree);
	}

	public void clickTagsLinkFour() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(tagsLinkFour);
		clickElementUsingJavaScript(tagsLinkFour);
	}

	public void clickTagsLinkFive() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(tagsLinkFive);
		clickElementUsingJavaScript(tagsLinkFive);
	}

	public void clickReadMoreLink() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(readMoreLink);
		clickElementUsingJavaScript(readMoreLink);
	}
