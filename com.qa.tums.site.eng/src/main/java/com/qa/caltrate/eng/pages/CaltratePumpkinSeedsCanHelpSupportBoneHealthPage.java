...
public class CaltratePumpkinSeedsCanHelpSupportBoneHealthPage extends BaseClass{
	
	public CaltratePumpkinSeedsCanHelpSupportBoneHealthPage() {
	...
	@FindBy(xpath = "//*[@class='breadcrumb-list-item even last is-current ']//self::li[normalize-space()='Pumpkin Seeds Can Help Support Bone Health!']")
