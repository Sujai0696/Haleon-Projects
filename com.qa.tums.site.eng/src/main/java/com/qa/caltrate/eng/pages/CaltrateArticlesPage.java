...
public class CaltrateArticlesPage extends BaseClass{
	
	public CaltrateArticlesPage() {
	...
	@FindBy(xpath = "//h4[normalize-space()='CALCIUM CARBONATE VS CALCIUM CITRATE']//ancestor::div[@class='box component section p-m-b-1 anchor-box odd col-xs-12']")
	...
	@FindBy(xpath = "//h4[normalize-space()='VITAMIN D: WHAT YOU NEED TO KNOW']//ancestor::div[@class='box component section p-m-b-1 anchor-box even col-xs-12']")
	...
	@FindBy(xpath = "//a[text()='READ MORE']//ancestor::div[@class='box component section p-m-b-1 anchor-box even last col-xs-12']")
