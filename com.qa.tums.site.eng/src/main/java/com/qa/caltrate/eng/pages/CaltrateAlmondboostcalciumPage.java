...
public class CaltrateAlmondboostcalciumPage extends BaseClass{
	
	public CaltrateAlmondboostcalciumPage() {
    ...
    private static WebElement MilkaddAlmondbreadcrumbs;	
...
//methods
  	...
  	public void clickonMilkAddAlmondbreadcrumbs() throws Throwable {
  		waitForPageLoadJava();
  		elementClick(MilkaddAlmondbreadcrumbs);
  }
