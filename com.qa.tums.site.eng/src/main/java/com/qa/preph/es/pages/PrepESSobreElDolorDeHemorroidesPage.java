...
public class PrepESSobreElDolorDeHemorroidesPage extends BaseClass{
	
	public PrepESSobreElDolorDeHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='hamamelis' and @href='/es/productos/toallas-limpiadoras-aliviadoras-relajantes-y-enfriadoras/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='Ungüento' and @href='/es/productos/ointment/']")
