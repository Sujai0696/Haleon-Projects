...
public class PrephESMedicinaBasicaParaHemorroidesPage extends BaseClass{
	
	public PrephESMedicinaBasicaParaHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='Crema de Hidrocortisona que Calma y Alivia Preparation H' and @href='/es/productos/anti-itch-hydrocortisone/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='Buscador de Alivio' and @href='/es/relief-finder/']")
