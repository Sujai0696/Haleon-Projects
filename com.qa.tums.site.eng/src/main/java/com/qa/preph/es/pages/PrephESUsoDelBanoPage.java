...
public class PrephESUsoDelBanoPage extends BaseClass{
	
	public PrephESUsoDelBanoPage() {
	...
	@FindBy(xpath = "//a[text()='dieta equilibrada y rica en fibra' and @href='/es/mas-informacion/la-dieta-para-las-hemorroides/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='haga ejercicio' and @href='/es/mas-informacion/actividad-fisica/']")
