...
public class PrephESQuienContraeHemorroidesPage extends BaseClass{
	
	public PrephESQuienContraeHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='embarazadas o después del parto' and @href='/es/mas-informacion/solo-para-mamas/']")
