...
public class PrephESAtaquesDeHemorroidesPage extends BaseClass{
	
	public PrephESAtaquesDeHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='síntomas habituales de una crisis' and @href='/es/mas-informacion/sintomas/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='productos PREPARATION H para aliviar los síntomas de las hemorroides.' and @href='/es/productos/']")
	private static WebElement hyperlinkTwo;
	
	@FindBy(xpath = "//a[text()='Toallitas Medicinales' and @href='/es/productos/medicated-portable-wipes/']")
	private static WebElement hyperlinkThree;
	
	@FindBy(xpath = "//a[text()='tratamientos caseros' and @href='/es/mas-informacion/tratando-ataques-de-hemorroides/']")
