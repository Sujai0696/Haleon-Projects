...
public class PrephESQueSonLasHemorroidesPage extends BaseClass{
	
	public PrephESQueSonLasHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='hacer ejercicio' and @href='/es/mas-informacion/actividad-fisica/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='dieta equilibrada con alto contenido de fibra' and @href='/es/mas-informacion/la-dieta-para-las-hemorroides/']")
