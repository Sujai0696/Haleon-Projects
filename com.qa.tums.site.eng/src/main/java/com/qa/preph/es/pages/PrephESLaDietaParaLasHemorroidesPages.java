...
public class PrephESLaDietaParaLasHemorroidesPages extends BaseClass{
	
	public PrephESLaDietaParaLasHemorroidesPages() {
	...
	@FindBy(xpath = "//a[text()='cuadro de alimentos con alto contenido de fibra' and @href='/es/mas-informacion/la-dieta-para-las-hemorroides/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='Tratamiento de las exacerbaciones mientras esté fuera del hogar' and @href='/es/mas-informacion/tratar-las-crisis-en-casa/']")
