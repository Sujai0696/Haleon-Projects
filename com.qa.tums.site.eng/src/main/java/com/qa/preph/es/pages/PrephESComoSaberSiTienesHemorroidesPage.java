...
public class PrephESComoSaberSiTienesHemorroidesPage extends BaseClass{
	
	public PrephESComoSaberSiTienesHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='causa las hemorroides' and @href='/es/mas-informacion/las-causas-de-las-hemorrides/']")
