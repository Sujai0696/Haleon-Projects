...
public class PrephESTratandoAtaquesDeHemorroidesPage extends BaseClass{
	
	public PrephESTratandoAtaquesDeHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='Buscador de alivio personal.' and @href='/es/relief-finder/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "(//a[text()='Toallitas medicinales PREPARATION H' and @href='/es/productos/medicated-portable-wipes/'])[1]")
	private static WebElement hyperlinkTwo;
	
	@FindBy(xpath = "(//a[text()='Toallitas medicinales PREPARATION H' and @href='/es/productos/medicated-portable-wipes/'])[2]")
	private static WebElement hyperlinkThree;
	
	@FindBy(xpath = "//a[text()='Tratamiento de las exacerbaciones fuera del hogar.' and @href='/es/mas-informacion/tratar-las-crisis-en-casa/']")
