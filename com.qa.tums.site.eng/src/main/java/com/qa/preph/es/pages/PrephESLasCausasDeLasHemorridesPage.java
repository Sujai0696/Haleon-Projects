...
public class PrephESLasCausasDeLasHemorridesPage extends BaseClass{
	
	public PrephESLasCausasDeLasHemorridesPage() {
	...
	@FindBy(xpath = "//a[text()='Viva mejor' and @href='/es/mas-informacion/']")
