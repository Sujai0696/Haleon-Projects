...
public class PrephESTodoLoQueTienesQueSaberSobreLasHemorroidesPage extends BaseClass{
	
	public PrephESTodoLoQueTienesQueSaberSobreLasHemorroidesPage() {
	...
	@FindBy(xpath = "//a[text()='hemorroides' and @href='/es/mas-informacion/que-son-las-hemorroides/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='ir al baño' and @href='/es/mas-informacion/uso-del-bano/']")
	private static WebElement hyperlinkTwo;
	
	@FindBy(xpath = "//a[text()='ayuda médica' and @href='/es/mas-informacion/tratamientos-medicos/']")
