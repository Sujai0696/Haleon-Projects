...
public class PrephESSoloParaMamasPage extends BaseClass{
	
	public PrephESSoloParaMamasPage() {
	...
	@FindBy(xpath = "//a[text()='Obtenga más información sobre las toallitas medicinales PREPARATION H para mujeres' and @href='/es/productos/toallitas-medicinales-preparation-h-para-mujeres/']")
	private static WebElement hyperlinkOne;
	
	@FindBy(xpath = "//a[text()='Siga una dieta equilibrada, con alto contenido de fibra' and @href='/es/mas-informacion/la-dieta-para-las-hemorroides/']")
	private static WebElement hyperlinkTwo;
	
	@FindBy(xpath = "//a[text()='uso del baño' and @href='/es/mas-informacion/uso-del-bano/']")
