...
public class PrephSoothingReliefsprayPage extends BaseClass{
	
	public PrephSoothingReliefsprayPage() {
	...
	@FindBy(xpath = "//li[text()=' Soothing Relief Cooling Spray ']")
	private static WebElement soothingreliefcoolingspray_Breadcrumbs;	
	...
	@FindBy(xpath = "//img[@alt='Soothing Relief Cooling Spray enlarged']")
	...
	public void clickonCookieBtn() throws Exception {
		...
		public void clickonSoothingreliefcoolingsprayBreadcrumbs() throws Exception{
	    	waitForPageLoadJava();
			moveToElement(soothingreliefcoolingspray_Breadcrumbs);
			if (isElementPresent(soothingreliefcoolingspray_Breadcrumbs)) {
				
				visibilityOf(soothingreliefcoolingspray_Breadcrumbs);
				boolean elementIsDisplayed=elementIsDisplayed(soothingreliefcoolingspray_Breadcrumbs);
				Assert.assertTrue(elementIsDisplayed(soothingreliefcoolingspray_Breadcrumbs));
				pageLoad();
			} else {
				throw new Exception("soothingreliefcoolingspray_Breadcrumbs are not Present on Page");
			}
