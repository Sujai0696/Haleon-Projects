...
public class PrephHemorrhoidSymptomsPage extends BaseClass{
	
	public PrephHemorrhoidSymptomsPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Symptoms ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[text()='internal or external hemorrhoids']//self::a[@href='/learn-more/what-are-hemorrhoids/']")
	private static WebElement hyperLinkInrernalOrExternal;
	
	@FindBy(xpath = "//p[contains(text(),'While the physical pain of hemorrhoids can be seve')]//a[@href='/learn-more/emotional-toll-of-hemorrhoids/'][normalize-space()='The Emotional Toll of Hemorrhoids']")
	private static WebElement hyperLinkTheEmotionalToll;
	
	@FindBy(xpath = "//p[@id='emotional-toll-title']//a[@aria-label='The Emotional Toll of Hemorrhoids'][normalize-space()='The Emotional Toll of Hemorrhoids']")
	...
	public void clickHyperLinkInrernalOrExternal() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkInrernalOrExternal)) {
			scrollDownUsingElement(hyperLinkInrernalOrExternal);
			clickElementUsingJavaScript(hyperLinkInrernalOrExternal);
			pageLoad();
			System.out.println("hyperLinkInrernalOrExternal clicked successfully");
		} else {
			System.out.println("hyperLinkInrernalOrExternal is not presented in the page");
			throw new Exception("hyperLinkInrernalOrExternal is not presented in the page");
		}
	}
	
	public void clickHyperLinkTheEmotionalToll() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkTheEmotionalToll)) {
			scrollDownUsingElement(hyperLinkTheEmotionalToll);
			clickElementUsingJavaScript(hyperLinkTheEmotionalToll);
			pageLoad();
			System.out.println("hyperLinkTheEmotionalToll clicked successfully");
		} else {
			System.out.println("hyperLinkTheEmotionalToll is not presented in the page");
			throw new Exception("hyperLinkTheEmotionalToll is not presented in the page");
		}
	}
