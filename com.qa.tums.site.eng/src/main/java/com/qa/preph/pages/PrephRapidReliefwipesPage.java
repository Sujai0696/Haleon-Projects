...
public class PrephRapidReliefwipesPage extends BaseClass{
	
	public PrephRapidReliefwipesPage() {
	...
	@FindBy(xpath = "//li[text()=' Rapid Relief Totables Wipes ']")
	private static WebElement rapidrelieftotableswipes_Breadcrumbs;	
	...
	@FindBy(xpath = "//img[@alt='PREPARATION H Rapid Relief Totables Wipes enlarged']")
	...
	//Methods//
			...
			public void clickonCookieBtn() throws Exception {
				...
				public void clickonRapidReliefwipesBreadcrumbs() throws Exception{
			    	waitForPageLoadJava();
					moveToElement(rapidrelieftotableswipes_Breadcrumbs);
					if (isElementPresent(rapidrelieftotableswipes_Breadcrumbs)) {
						visibilityOf(rapidrelieftotableswipes_Breadcrumbs);
						boolean elementIsDisplayed=elementIsDisplayed(rapidrelieftotableswipes_Breadcrumbs);
						Assert.assertTrue(elementIsDisplayed(rapidrelieftotableswipes_Breadcrumbs));
						pageLoad();
					} else {
						throw new Exception("rapidrelieftotableswipes_Breadcrumbs are not Present on Page");
					}
				...
				public void clickonFullproductLabel() throws Exception{
					...
					if (isElementPresent(fullproductlabel)) {
						...
						visibilityOf(fullproductlabel);
						boolean elementIsDisplayed=elementIsDisplayed(fullproductlabel);
						Assert.assertTrue(elementIsDisplayed(fullproductlabel));
						pageLoad();
					} else {
				...
				public void clickonBuyNow() throws Exception{
					...
					if (isElementPresent(buynow)) {
						...
						throw new Exception("BuyNow is  not Present on Page");
					}
