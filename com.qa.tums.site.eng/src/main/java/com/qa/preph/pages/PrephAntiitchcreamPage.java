...
public class PrephAntiitchcreamPage extends BaseClass{
	
	public PrephAntiitchcreamPage() {
	...
	@FindBy(xpath = "//li[text()=' Soothing Relief Anti-Itch Cream ']")
	private static WebElement antiitchcream_Breadcrumbs;	
	...
	@FindBy(xpath = "//img[@alt='Preparation H Soothing Relief Anti-Itch Cream enlarged']")
	...
	private static WebElement video_play;
	...
	//Methods//
		...
		public void clickonCookieBtn() throws Exception {
			...
			public void clickonantiitchcream_Breadcrumbs() throws Exception{
		    	waitForPageLoadJava();
				moveToElement(antiitchcream_Breadcrumbs);
				if (isElementPresent(antiitchcream_Breadcrumbs)) {
					visibilityOf(antiitchcream_Breadcrumbs);
					boolean elementIsDisplayed=elementIsDisplayed(antiitchcream_Breadcrumbs);
					Assert.assertTrue(elementIsDisplayed(antiitchcream_Breadcrumbs));
					pageLoad();
				} else {
					throw new Exception("antiitchcream_Breadcrumbs are not Present on Page");
				}
