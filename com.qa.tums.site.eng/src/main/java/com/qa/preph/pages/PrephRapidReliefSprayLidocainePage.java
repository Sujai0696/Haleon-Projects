...
public class PrephRapidReliefSprayLidocainePage extends BaseClass{
	
	public PrephRapidReliefSprayLidocainePage() {
	...
	@FindBy(xpath = "//li[text()=' Rapid Relief Spray with Lidocaine ']")
	private static WebElement rapidreliefspraylidocaine_Breadcrumbs;	
	...
	@FindBy(xpath = "//img[@alt='Rapid Relief with Lidocaine Spray enlarged']")
	...
	//Methods//
		...
		public void clickonCookieBtn() throws Exception {
			...
			public void clickonRapidReliefspraylidocaineBreadcrumbs() throws Exception{
		    	waitForPageLoadJava();
				moveToElement(rapidreliefspraylidocaine_Breadcrumbs);
				if (isElementPresent(rapidreliefspraylidocaine_Breadcrumbs)) {
					visibilityOf(rapidreliefspraylidocaine_Breadcrumbs);
					boolean elementIsDisplayed=elementIsDisplayed(rapidreliefspraylidocaine_Breadcrumbs);
					Assert.assertTrue(elementIsDisplayed(rapidreliefspraylidocaine_Breadcrumbs));
					pageLoad();
				} else {
					throw new Exception("rapidreliefspraylidocaine_Breadcrumbs are not Present on Page");
				}
			...
			public void clickonFullproductLabel() throws Exception{
				...
				if (isElementPresent(fullproductlabel)) {
					...
					throw new Exception("fullproductlabel Pdf is not Present on Page");
				}
			...
			public void clickonBuyNowBtn() throws Exception{
				...
				if (isElementPresent(BuyNow)) {
					...
					throw new Exception("BuyNow_txt are not Present on Page");
				}
