...
public class PrephHemorrhoidPainPage extends BaseClass{
	
	public PrephHemorrhoidPainPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Hemorrhoid Pain ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[text()='Ointment']//self::a[@href='/products/ointment/']")
	private static WebElement hyperLinkOinment;
	...
	public void clickHyperLinkOinment() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkOinment)) {
			scrollDownUsingElement(hyperLinkOinment);
			clickElementUsingJavaScript(hyperLinkOinment);
			pageLoad();
			System.out.println("hyperLinkOinment clicked successfully");
		} else {
			System.out.println("hyperLinkOinment is not presented in the page");
			throw new Exception("hyperLinkOinment is not presented in the page");
		}
	}
