...
public class PrephCleansingcoolingwipesPage extends BaseClass{

	public PrephCleansingcoolingwipesPage() {
	...
	@FindBy(xpath = "//li[text()=' Soothing Relief Cleansing & Cooling Wipes ']")
	private static WebElement Cleansingcoolingwipes_Breadcrumbs;	
	...
	@FindBy(xpath = "//img[@alt='Preparation H Soothing Relief Cleansing and Cooling Wipes enlarged']")
	...
	public void clickonCookieBtn() throws Exception {
		...
		public void clickonCleansingcoolingwipesBreadcrumbs() throws Exception{
	    	waitForPageLoadJava();
			moveToElement(Cleansingcoolingwipes_Breadcrumbs);
			if (isElementPresent(Cleansingcoolingwipes_Breadcrumbs)) {
				visibilityOf(Cleansingcoolingwipes_Breadcrumbs);
				boolean elementIsDisplayed=elementIsDisplayed(Cleansingcoolingwipes_Breadcrumbs);
				Assert.assertTrue(elementIsDisplayed(Cleansingcoolingwipes_Breadcrumbs));
				pageLoad();
			} else {
				throw new Exception("Cleansingcoolingwipes_Breadcrumbs are not Present on Page");
			}
