...
public class AbrevaStressPage extends BaseClass{
	
	public AbrevaStressPage() {
    ...
    @FindBy(xpath = "//a[normalize-space()='Managing Your Triggers']")
    private static WebElement breadcrumbOne;
    
    @FindBy(xpath = "//a[text()='TAKE THAT COFFEE BREAK']//self::a[@href='/managing-lip-health/cold-sore-triggers/stress-at-work/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
