...
public class AbrevaColdAndFluPage extends BaseClass{
	
	public AbrevaColdAndFluPage() {
    ...
    @FindBy(xpath = "//span[text()='healthy diet']//ancestor::a[@href='/managing-lip-health/lip-care/eating-for-lip-health/']")
    private static WebElement hyperLinkHealthyDiet;
    ...
    public void clickHyperLinkHealthyDiet() throws Exception{
    	waitForPageLoadJava();
    	if (isElementPresent(hyperLinkHealthyDiet)) {
			scrollDownUsingElement(hyperLinkHealthyDiet);
			clickElementUsingJavaScript(hyperLinkHealthyDiet);
			pageLoad();
			System.out.println("HyperLink Healthy Diet clicked successfully");
		} else {
			System.out.println("HyperLink Healthy Diet is not presented in the page");
			throw new Exception("HyperLink Healthy Diet is not presented in the page");
		}
	}
