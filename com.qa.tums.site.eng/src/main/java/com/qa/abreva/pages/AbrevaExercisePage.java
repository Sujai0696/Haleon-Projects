...
public class AbrevaExercisePage extends BaseClass{
	
	public AbrevaExercisePage() {
    ...
    @FindBy(xpath = "//a[text()='cold sore trigger']//self::a[@href='/managing-lip-health/cold-sore-triggers/']")
    private static WebElement hyperLinkColdSoreTrigger;
    ...
    public void clickHyperLinkColdSoreTrigger() throws Exception{
    	waitForPageLoadJava();
    	if (isElementPresent(hyperLinkColdSoreTrigger)) {
			scrollDownUsingElement(hyperLinkColdSoreTrigger);
			clickElementUsingJavaScript(hyperLinkColdSoreTrigger);
			pageLoad();
			System.out.println("HyperLink ColdSoreTrigger clicked successfully");
		} else {
			System.out.println("HyperLink ColdSoreTrigger is not presented in the page");
			throw new Exception("HyperLink Cold Sore Trigger is not presented in the page");
		}
	}
    ...
    public void clickHyperLinkStress() throws Exception{
    	...
    	if (isElementPresent(hyperLinkStress)) {
			...
			pageLoad();
			System.out.println("HyperLink Stress Tips clicked successfully");
		} else {
			System.out.println("HyperLink Stress Tips is not presented in the page");
			throw new Exception("HyperLink Stress Tips is not presented in the page");
		}
	}
