...
public class AbrevaPregnancyAndPeriodsPage extends BaseClass{
	
	public AbrevaPregnancyAndPeriodsPage() {
    ...
    @FindBy(xpath = "//strong[text()='breathing exercises']//ancestor::a[@href='/managing-lip-health/cold-sore-triggers/relaxation-techniques/']")
    private static WebElement hyperLinkBreathingExercise;
    
    @FindBy(xpath = "//a[text()='DON’T DITCH THE DENTIST']//self::a[@href='/managing-lip-health/cold-sore-triggers/dentist-visit/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
    ...
    public void clickCookieBtn() throws Exception {
      ...
      public void clickHyperLinkBreathingExercise() throws Exception{
      	waitForPageLoadJava();
      	if (isElementPresent(hyperLinkBreathingExercise)) {
  			scrollDownUsingElement(hyperLinkBreathingExercise);
  			clickElementUsingJavaScript(hyperLinkBreathingExercise);
  			pageLoad();
  			System.out.println("HyperLink Breathing Exercise clicked successfully");
  		} else {
  			System.out.println("HyperLink Breathing Exercise is not presented in the page");
  			throw new Exception("HyperLink Breathing Exercise is not presented in the page");
  		}
  	}
