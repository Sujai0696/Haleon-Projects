...
public class AbrevawheregetcoldsorePage extends BaseClass{
	
	public AbrevawheregetcoldsorePage() {
	...
	@FindBy(xpath = "//div[@class='richText component section abreva-txt lip-care-txt odd']//a[@href='/cold-sore-products/abreva-cream/']")
	...
	@FindBy(xpath = "//a[@href='/managing-lip-health/cold-sore-triggers/sun-and-cold-sores/']")
