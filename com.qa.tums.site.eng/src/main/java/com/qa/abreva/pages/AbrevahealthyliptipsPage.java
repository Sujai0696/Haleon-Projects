...
public class AbrevahealthyliptipsPage extends BaseClass{
	
	public AbrevahealthyliptipsPage() {
	...
	@FindBy(xpath = "//a[text()='4 WAYS TO FEEL MORE CONFIDENT WHEN YOU HAVE A CODE SORE']")
