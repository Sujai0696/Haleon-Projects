...
public class AbrevaPlanForImportantDaysPage extends BaseClass{
	
	public AbrevaPlanForImportantDaysPage() {
    ...
    @FindBy(xpath = "//h2[text()='Rest up']//following::strong[text()='7 to 8 hours of sleep']//ancestor::a[@href='/managing-lip-health/cold-sore-triggers/sleep/']")
    private static WebElement carouselRestUpHyperLinkOne;
    
    @FindBy(xpath = "//h2[text()='Rest up']//ancestor::li[@class='carousel-slide clearfix odd is-active first ']")
    private static WebElement carouselActiveOne;
    
    @FindBy(xpath = "//h2[text()='Eat fresh']//ancestor::li[@class='carousel-slide clearfix even is-active']")
    private static WebElement carouselActiveTwo;
    
    @FindBy(xpath = "//h2[text()='Walk it out']//ancestor::li[@class='carousel-slide clearfix odd is-active']")
    private static WebElement carouselActiveThree;
    
    @FindBy(xpath = "//h2[text()='Make time for yourself']//ancestor::li[@class='carousel-slide clearfix even is-active']")
    private static WebElement carouselActiveFour;
    
    @FindBy(xpath = "//h2[text()='Stay in the moment']//ancestor::li[@class='carousel-slide clearfix odd last is-active']")
    private static WebElement carouselActiveFive;
    
    @FindBy(xpath = "//h2[text()='Rest up']//ancestor::li[@class='carousel-slide clearfix odd first is-active']")
    ...
    @FindBy(xpath = "//a[text()='COPE WITH ILLNESS OR LOSS']//self::a[@href='/managing-lip-health/cold-sore-triggers/coping-with-loss-or-illness/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
    private static WebElement wholeCardSecOne;
    
    @FindBy(xpath = "//a[@href='/managing-lip-health/dealing-with-cold-sores/cold-sore-confessions/']//ancestor::div[@class='image component section article-promo-img clickable-box even grid_4']")
    private static WebElement wholeCardSecTwo;
    
    @FindBy(xpath = "//a[@href='/managing-lip-health/lip-care/eating-for-lip-health/']//ancestor::div[@class='image component section article-promo-img clickable-box odd last grid_4 omega']")
    ...
    public void clickHyperLinkCarouselRestUpOne() throws Exception{
    	waitForPageLoadJava();
    	if (isElementPresent(carouselActiveOne)) {
			scrollDownUsingElement(carouselActiveOne);
			clickElementUsingJavaScript(carouselRestUpHyperLinkOne);
			pageLoad();
			System.out.println("carouselRestUpHyperLinkOne clicked successfully");
		} else {
			System.out.println("carousel Rest Up HyperLink One is not presented in the page");
			throw new Exception("carousel RestUp HyperLink One is not presented in the page");
		}
	}
