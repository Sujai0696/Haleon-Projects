...
public class AbrevaRelaxationTechniquesPage extends BaseClass{
	
	public AbrevaRelaxationTechniquesPage() {
    ...
    @FindBy(xpath = "//a[text()='GET MOVING']//self::a[@href='/managing-lip-health/cold-sore-triggers/exercise/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
    private static WebElement wholeCardSecOne;
    
    @FindBy(xpath = "//a[text()='COLD SORE CONFESSIONS']//self::a[@href='/managing-lip-health/dealing-with-cold-sores/cold-sore-confessions/']//ancestor::div[@class='image component section article-promo-img clickable-box even grid_4']")
