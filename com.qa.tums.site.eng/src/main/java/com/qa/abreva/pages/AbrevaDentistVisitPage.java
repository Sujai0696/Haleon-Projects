...
public class AbrevaDentistVisitPage extends BaseClass{
	
	public AbrevaDentistVisitPage() {
    ...
    @FindBy(xpath = "//a[text()='PUMP UP YOUR BRAIN']//self::a[@href='/managing-lip-health/cold-sore-triggers/stress/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
