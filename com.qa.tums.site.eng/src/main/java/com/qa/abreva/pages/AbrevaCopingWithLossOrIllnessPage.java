...
public class AbrevaCopingWithLossOrIllnessPage extends BaseClass{
	

	public AbrevaCopingWithLossOrIllnessPage() {
    ...
    @FindBy(xpath = "//a[text()='WEATHER THE WINTER']//self::a[@href='/managing-lip-health/cold-sore-triggers/cold-weather/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
    private static WebElement wholeCardSecOne;
    
    @FindBy(xpath = "//self::a[@href='/managing-lip-health/dealing-with-cold-sores/staying-confident/']//ancestor::div[@class='image component section article-promo-img clickable-box even grid_4']")
