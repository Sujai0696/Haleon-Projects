...
public class AbrevaStressAtWorkPage extends BaseClass{
	
	public AbrevaStressAtWorkPage() {
    ...
    @FindBy(xpath = "//a[normalize-space()='Managing Your Triggers']//self::a[@href='/managing-lip-health/cold-sore-triggers/']")
    private static WebElement breadcrumbOne;
    
    @FindBy(xpath = "//a[text()='FIND YOUR SPOT IN THE SHADE']//self::a[@href='/managing-lip-health/cold-sore-triggers/sun-and-cold-sores/']//ancestor::div[@class='image component section article-promo-img clickable-box first odd grid_4 alpha']")
    private static WebElement wholeCardSecOne;
    
    @FindBy(xpath = "//a[text()='THE TRUTH ABOUT COLD SORE REMEDIES']//self::a[@href='/managing-lip-health/dealing-with-cold-sores/truth-about-cold-sore-remedies/']//ancestor::div[@class='image component section article-promo-img clickable-box even grid_4']")
