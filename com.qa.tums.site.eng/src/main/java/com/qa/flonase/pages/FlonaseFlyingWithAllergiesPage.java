...
public class FlonaseFlyingWithAllergiesPage extends BaseClass{
	
	public FlonaseFlyingWithAllergiesPage() {
	...
	@FindBy(xpath = "//a[@href='https://www.flonase.com/allergies/what-is-pollen/' and text()='pollen']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.flonase.com/allergies/symptoms-causes/' and text()='allergy symptoms']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.flonase.com/products/' and text()='FLONASE allergy relief nasal sprays']")
