...
public class FlonaseReduceFallAllergensFromDogsPage extends BaseClass{
	
	public FlonaseReduceFallAllergensFromDogsPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/spring-vs-fall-allergies/' and text()='fall allergens']")
	...
	public void clickBtnBuyNow() throws Exception {
		...
		if (isElementPresent(btnBuyNow)) {
			...
			pageLoad();
			System.out.println("btnBuyNow is clicked successfully");
		} else {
			System.out.println("bynBuyNow is not presented in the page");
