...
public class FlonaseSensimistFamilyPackDrugFactsPage extends BaseClass{
	
	public FlonaseSensimistFamilyPackDrugFactsPage() {
	...
	@FindBy(xpath = "//a[@href='/products/sensimist-family-pack/' and text()='About']")
	private static WebElement bannerImgLinkOne;
	
	@FindBy(xpath = "//a[@href='/products/sensimist-family-pack/how-to-use/' and text()='How to use']")
	private static WebElement bannerImgLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/sensimist-family-pack/drug-facts/' and text()='Drug facts']")
	private static WebElement bannerImgLinkThree;
	
	@FindBy(xpath = "//a[@href='/products/sensimist-family-pack/faqs/' and text()='FAQs']")
	...
	@FindBy(xpath = "//a[@href='/products/sensimist-family-pack/' and text()='Children’s FLONASE SENSIMIST Allergy Relief']")
