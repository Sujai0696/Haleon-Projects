...
public class FlonaseTypesOfAllergiesPage extends BaseClass{
	
	public FlonaseTypesOfAllergiesPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/reduce-indoor-allergens/' and text()='avoid transporting pollen inside your home']")
	private static WebElement hyperLinkFourteen;
	
	@FindBy(xpath = "//a[@href='/products/' and text()='FLONASE']")
