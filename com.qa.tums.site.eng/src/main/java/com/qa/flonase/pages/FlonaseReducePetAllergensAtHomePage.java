...
public class FlonaseReducePetAllergensAtHomePage extends BaseClass{
	
	public FlonaseReducePetAllergensAtHomePage() {
	...
	@FindBy(xpath = "//a[@href='https://www.aafa.org/pet-dog-cat-allergies/' and text()='three in 10 Americans']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.aafa.org/pet-dog-cat-allergies/' and text()='keeping a pet-free home']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='https://www.aafa.org/pet-dog-cat-allergies/' and text()='equip their vacuums with HEPA filters']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='https://www.aafa.org/pet-dog-cat-allergies/' and text()='may reduce airborne allergens']")
