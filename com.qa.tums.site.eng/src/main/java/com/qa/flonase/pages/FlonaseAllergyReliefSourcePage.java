...
public class FlonaseAllergyReliefSourcePage extends BaseClass{
	
	public FlonaseAllergyReliefSourcePage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/anatomy-of-an-allergy-attack/' and text()='your body overreacts']")
	...
	@FindBy(xpath = "//a[@href='/allergies/treatment/' and text()='allergy treatments']")
	private static WebElement hyperLinkEight;
	
	@FindBy(xpath = "//a[@href='/allergies/allergy-pills-vs-nasal-allergy-sprays/' and text()='allergy pills and intranasal steroid sprays']")
