...
public class FlonaseChildrenAllergiesCausesAndTriggersPage extends BaseClass{
	
	public FlonaseChildrenAllergiesCausesAndTriggersPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/what-is-pollen/' and text()='Pollen: Miracle of Plant Life, Menace of Seasonal Allergies']")
	...
	@FindBy(xpath = "//a[@href='/allergies/mold-allergy-facts/' and text()='Mold. The Fungus Among Us']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='https://www.flonase.com/allergies/anatomy-of-an-allergy-attack/' and text()='anatomy of an allergy attack']")
	private static WebElement hyperLinkSix;
	
	@FindBy(xpath = "//a[@href='https://www.flonase.com/products/childrens-sensimist/' and text()='Children’s FLONASE SENSIMIST Allergy Relief']")
	...
	@FindBy(xpath = "//a[@href='/allergies/#flonase-products' and normalize-space()='Flonase Products']")
