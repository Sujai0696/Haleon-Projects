...
public class FlonaseBaseballSpringAllergiesChecklistPage extends BaseClass{
	
	public FlonaseBaseballSpringAllergiesChecklistPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/when-and-what-is-allergy-season/' and text()='allergy season']")
	...
	@FindBy(xpath = "//a[@href='/allergies/sneezing-facts/' and text()='frequent sneezing']")
	...
	@FindBy(xpath = "//a[@href='/products/' and text()='FLONASE nasal sprays']")
