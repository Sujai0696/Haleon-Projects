...
public class FlonaseHypoallergenicPetsFactOrFictionPage extends BaseClass{
	
	public FlonaseHypoallergenicPetsFactOrFictionPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/when-and-what-is-allergy-season/' and text()='28 Pets for Allergy Sufferers']")
