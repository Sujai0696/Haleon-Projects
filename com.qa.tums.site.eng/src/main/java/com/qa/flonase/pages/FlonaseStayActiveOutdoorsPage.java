...
public class FlonaseStayActiveOutdoorsPage extends BaseClass{
	
	public FlonaseStayActiveOutdoorsPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/' and text()='allergies']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/allergies/sensimist-effective-allergy-relief/']")
