...
public class FlonaseWinterAllergiesPage extends BaseClass{
	
	public FlonaseWinterAllergiesPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/reduce-indoor-allergens/' and text()='stopping for indoor allergens']")
	...
	@FindBy(xpath = "//a[@href='/allergies/mold-allergies/' and text()='indoor mold']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='/allergies/allergies-or-cold/' and text()='cold or allergies']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='/allergies/#winter-allergies' and text()='Winter Allergies']")
