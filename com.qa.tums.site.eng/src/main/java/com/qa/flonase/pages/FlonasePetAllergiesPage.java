...
public class FlonasePetAllergiesPage extends BaseClass{
	
	public FlonasePetAllergiesPage() {
	...
	@FindBy(xpath = "//a[@href='/allergies/living-with-cat-allergies/' and text()='Cat allergies']")
	...
	@FindBy(xpath = "//a[@href='/allergies/reduce-pet-allergens-at-home/' and text()='5 ways to reduce pet allergens in your home']")
