...
public class SensodyneSensodyeRapidReleifPage extends BaseClass{
	
	public SensodyneSensodyeRapidReleifPage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Rapid Relief - Extra Fresh']")
	...
	private static WebElement learbMore;
	...
	public void clickMint() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(mint);
	...
	public void clickSensodyneRapidReleifYoutube() throws Exception{
		waitForPageLoadJava();
	...
	public void clickLearnMore() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(learbMore);
		clickElementUsingJavaScript(learbMore);
		pageLoad();
	}
	
	public void clickDentistRecommendYoutubeLink() throws Exception{
		waitForPageLoadJava();
