...
public class SensodyneCanYouBrushTeethTooHardPage extends BaseClass{
	
	public SensodyneCanYouBrushTeethTooHardPage() {
	...
	@FindBy(xpath = "//a[text()='Brushing twice a day, choosing a good toothbrush']")
	private static WebElement isItPossibleLinkOne;
	
	@FindBy(xpath = "//a[text()='The Super Dentists']")
	private static WebElement isItPossibleLinkTwo;
	
	@FindBy(xpath = "//a[text()='gum recession and enamel wear']")
	private static WebElement damagedCausedLink;
	
	@FindBy(xpath = "//a[text()='Sensodyne Rapid Relief Toothpaste']")
	private static WebElement howToBrushCorrectlyLink;
	...
	public void clickIsItPossibleLinkOne() throws Exception{
		scrollDownUsingElement(isItPossibleLinkOne);
		clickElementUsingJavaScript(isItPossibleLinkOne);
		waitForPageLoadJava();
	}
	
	public void clickIsItPossibleLinkTwo() throws Exception{
		scrollDownUsingElement(isItPossibleLinkTwo);
		clickElementUsingJavaScript(isItPossibleLinkTwo);
		waitForPageLoadJava();
	}
	
	public void clickDamagedCausedLink() throws Exception{
		scrollDownUsingElement(damagedCausedLink);
		clickElementUsingJavaScript(damagedCausedLink);
		waitForPageLoadJava();
	}
	
	public void clickHowToBrushCorrectlyLink() throws Exception{
		scrollDownUsingElement(howToBrushCorrectlyLink);
		clickElementUsingJavaScript(howToBrushCorrectlyLink);
		waitForPageLoadJava();
	}
