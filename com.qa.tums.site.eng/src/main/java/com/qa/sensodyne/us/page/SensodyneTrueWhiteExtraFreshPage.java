...
public class SensodyneTrueWhiteExtraFreshPage extends BaseClass{
	
	public SensodyneTrueWhiteExtraFreshPage() {
	...
	@FindBy(xpath = "//span[text()='My Review for True White - Extra Fresh']")
	...
	@FindBy(xpath = "//a[text()='True White Extra Fresh']")
