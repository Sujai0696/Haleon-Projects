...
public class SensodyneFreshMintToothpastePage extends BaseClass{
	
	public SensodyneFreshMintToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Fresh Mint']")
	...
	@FindBy(xpath = "//a[text()='Fresh Mint']")
