...
public class SensodyneSensodyneRepairProtectWhietningToothpastePage extends BaseClass{
	
	public SensodyneSensodyneRepairProtectWhietningToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Repair & Protect - Whitening']")
