...
public class SensodyneStopLivingWithToothSenstivity extends BaseClass{
	public SensodyneStopLivingWithToothSenstivity() {
	...
	@FindBy(xpath = "//a[text()='Do your teeth hurt when its cold out?']")
