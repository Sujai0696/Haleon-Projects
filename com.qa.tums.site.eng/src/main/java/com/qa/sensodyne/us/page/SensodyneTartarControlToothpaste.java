...
public class SensodyneTartarControlToothpaste extends BaseClass {
	public SensodyneTartarControlToothpaste() {
	...
	@FindBy(xpath = "//span[text()='My Review for Tartar Control']")
...
//	private static WebElement extraFresh;
	...
	@FindBy(xpath = "(//a[text()='Repair and Protect'])[2]")
	...
	@FindBy(xpath = "(//a[text()='Repair and Protect'])[1]")
