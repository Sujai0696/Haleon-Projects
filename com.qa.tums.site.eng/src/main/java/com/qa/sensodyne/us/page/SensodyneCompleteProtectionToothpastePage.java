...
public class SensodyneCompleteProtectionToothpastePage extends BaseClass{
	
	public SensodyneCompleteProtectionToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Complete Protection']")
	...
	@FindBy(xpath = "(//a[text()='Complete Protection'])[2]")
	...
	@FindBy(xpath = "(//a[text()='Complete Protection'])[1]")
	...
	public void clickExtraFresh() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(extraFresh);
