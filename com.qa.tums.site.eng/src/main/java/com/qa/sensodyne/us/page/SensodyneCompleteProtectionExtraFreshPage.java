...
public class SensodyneCompleteProtectionExtraFreshPage extends BaseClass{
	
	public SensodyneCompleteProtectionExtraFreshPage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Complete Protection - Extra Fresh']")
	...
	@FindBy(xpath = "//a[text()='Complete Protection Extra Fresh']")
