...
public class SensodyneTrueWhiteMintToothpastePage extends BaseClass{
	
	public SensodyneTrueWhiteMintToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for True White - Mint']")
