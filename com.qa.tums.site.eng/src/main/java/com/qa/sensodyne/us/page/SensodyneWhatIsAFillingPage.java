...
public class SensodyneWhatIsAFillingPage extends BaseClass{
	
	public SensodyneWhatIsAFillingPage() {
	...
	@FindBy(xpath = "//a[text()='oral health']")
	private static WebElement oralHealth;
	
	@FindBy(xpath = "//a[text()='how to improve gum health']")
	private static WebElement howToImprove;
	
	@FindBy(xpath = "//a[text()='the importance of flossing']")
	private static WebElement theImportance;
	...
	public void clickHowToImprove() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(howToImprove);
		clickElementUsingJavaScript(howToImprove);
		pageLoad();
	}
	
	public void clickTheImportance() throws Exception{
		waitForPageLoadJava();
		scrollDownUsingElement(theImportance);
		clickElementUsingJavaScript(theImportance);
		pageLoad();
	}
