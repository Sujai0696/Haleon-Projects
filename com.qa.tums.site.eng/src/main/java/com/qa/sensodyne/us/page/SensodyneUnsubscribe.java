...
public class SensodyneUnsubscribe extends BaseClass{
	public SensodyneUnsubscribe() {
	...
	@FindBy(xpath = "(//input[@class='gigya-input-submit'])[3]")
	...
	public void clickUnsubscribe() throws Exception{
