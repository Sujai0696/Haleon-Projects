...
public class SensodyneDeepCleanToothpastePage extends BaseClass{
	
	public SensodyneDeepCleanToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Deep Clean']")
	...
	@FindBy(xpath = "//a[text()='Deep Clean']")
