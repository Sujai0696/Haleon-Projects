...
public class SensodyneRepairProtectToothpastePage extends BaseClass{
	
	public SensodyneRepairProtectToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Repair & Protect']")
