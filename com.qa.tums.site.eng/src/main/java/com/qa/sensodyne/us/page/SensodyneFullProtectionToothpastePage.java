...
public class SensodyneFullProtectionToothpastePage extends BaseClass{
	
	public SensodyneFullProtectionToothpastePage() {
	...
	@FindBy(xpath = "//span[text()='My Review for Full Protection']")
	...
	@FindBy(xpath = "//a[text()='Full Protection']")
	...
	public void clickYoutubeLink() throws Exception{
