...
public class SensodyneInSensitiveToothbrushPage extends BaseClass{
	
	public SensodyneInSensitiveToothbrushPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::li[normalize-space()='Sensodyne Sensitive Soft toothbrush']")
	...
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::a[text()='Deep Clean Toothbrush']//self::a[@href='/products/deep-clean-toothbrush.html']")
	private static WebElement mostPopularProductsTwo;
	
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::a[text()='Sensitivity & Gum Tooth brush']//self::a[@href='/products/sensitive-teeth-gums-toothbrush.html']")
