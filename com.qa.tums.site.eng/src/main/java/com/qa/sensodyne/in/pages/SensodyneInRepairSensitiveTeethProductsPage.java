...
public class SensodyneInRepairSensitiveTeethProductsPage extends BaseClass{
	
	public SensodyneInRepairSensitiveTeethProductsPage() {
		PageFactory.initElements(driver, this);
	}
	
	
	@FindBy(xpath = "//strong[text()='Repair and Protect ']//ancestor::a[@href='/products/sensodyne-repair-protect-toothpaste.html']")
	private static WebElement prdtCardText;
	
	@FindBy(xpath = "//img[@alt='Sensodyne Repair and Protect toothpaste']//ancestor::a[@href='/products/sensodyne-repair-protect-toothpaste.html']")
