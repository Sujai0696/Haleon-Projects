...
public class SensodyneInSensitiveTeethGumsToothbrushPage extends BaseClass{
	
	public SensodyneInSensitiveTeethGumsToothbrushPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::li[text()=' Sensodyne Sensitivity Gum Soft toothbrush ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[@class='button-text' and text()='Buy Now']//ancestor::a")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//span[text()='Sensitivity & Gum Toothpaste']//ancestor::a[@href='/products/sensitivity-gum-toothpaste.html']")
	private static WebElement availablePrdtText;
	
	@FindBy(xpath = "//a[@href='']//img[@alt='Sensodyne Sensitivity and Gum Toothpaste Pack']")
	private static WebElement availablePrdtImg;
	
	
	@FindBy(xpath = "//a[@href='/products/sensitivity-gum-toothpaste.html' and text()='Sensodyne Sensitivity & Gum Toothpaste']")
	...
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::a[text()='Repair and Protect']//self::a[@href='/products/sensodyne-repair-protect-toothpaste.html']")
