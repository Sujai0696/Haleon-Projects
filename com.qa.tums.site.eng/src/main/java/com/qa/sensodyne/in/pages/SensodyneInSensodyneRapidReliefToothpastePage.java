...
public class SensodyneInSensodyneRapidReliefToothpastePage extends BaseClass{
	
	public SensodyneInSensodyneRapidReliefToothpastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::li[text()=' Rapid Relief ']")
