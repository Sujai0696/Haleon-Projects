...
public class SensodyneInWhiterTeethProductsPage extends BaseClass{
	
	public SensodyneInWhiterTeethProductsPage() {
		PageFactory.initElements(driver, this);
	}
	
	@FindBy(xpath = "//strong[text()='Whitening']//ancestor::a[@href='/products/sensodyne-whitening-toothpaste.html']")
	private static WebElement prdtCardText;
	
	@FindBy(xpath = "//img[@alt='Sensodyne Rapid Relief Whitening Toothpaste']//ancestor::a[@href='/products/sensodyne-whitening-toothpaste.html']")
	...
	@FindBy(xpath = "//a[@href='/products/product-results/fresh-breath-products.html']//self::a[text()='freshens breath']")
	private static WebElement hyperLinkFreshBreath;
	...
	public void clickHyperLinkFreshBreath() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkFreshBreath)) {
			scrollDownUsingElement(hyperLinkFreshBreath);
			clickElementUsingJavaScript(hyperLinkFreshBreath);
			pageLoad();
			System.out.println("hyperLinkFreshBreath clicked successfully");
		} else {
			System.out.println("hyperLinkFreshBreath is not presented in the page");
			throw new Exception("hyperLinkFreshBreath is not presented in the page");
		}
	}
