...
public class SensodyneInExpertToothbrushPage extends BaseClass{
	
	public SensodyneInExpertToothbrushPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::li[text()=' Sensodyne Expert Soft toothbrush ']")
