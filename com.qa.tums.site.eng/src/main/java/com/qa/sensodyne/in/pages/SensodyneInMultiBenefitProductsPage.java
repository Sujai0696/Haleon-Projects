...
public class SensodyneInMultiBenefitProductsPage extends BaseClass{
	
	public SensodyneInMultiBenefitProductsPage() {
		PageFactory.initElements(driver, this);
	}
	
	
	@FindBy(xpath = "//strong[text()='Complete Protection +']//ancestor::a[@href='/products/sensodyne-complete-protection-cool-mint-toothpaste.html']")
	private static WebElement prdtCardText;
	
	@FindBy(xpath = "//img[@alt='Sensodyne Complete Protection toothpaste']//ancestor::a[@href='/products/sensodyne-complete-protection-cool-mint-toothpaste.html']")
