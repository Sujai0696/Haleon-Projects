...
public class SensodyneCaCoolMintMouthwashPage extends BaseClass{
	
	public SensodyneCaCoolMintMouthwashPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Cool Mint Mouthwash']//self::a[@href='/en-ca/products/cool-mint-mouthwash/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[text()='Buy now']//self::a[@href='/en-ca/where-to-buy/']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//span[text()='Complete Protection Toothpaste']//ancestor::a[@href='/en-ca/products/complete-protection-original/']")
