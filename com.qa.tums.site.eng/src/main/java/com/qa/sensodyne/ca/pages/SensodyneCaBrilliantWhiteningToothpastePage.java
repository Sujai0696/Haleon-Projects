...
public class SensodyneCaBrilliantWhiteningToothpastePage extends BaseClass{
	
	public SensodyneCaBrilliantWhiteningToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Brilliant Whitening']//self::a[@href='/en-ca/products/brilliant-whitening-toothpaste/']")
