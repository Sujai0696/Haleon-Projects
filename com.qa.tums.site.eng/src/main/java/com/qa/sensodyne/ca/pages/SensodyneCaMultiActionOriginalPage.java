...
public class SensodyneCaMultiActionOriginalPage extends BaseClass{
	
	public SensodyneCaMultiActionOriginalPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Multi-Action']//self::a[@href='/en-ca/products/multi-action-original/']")
