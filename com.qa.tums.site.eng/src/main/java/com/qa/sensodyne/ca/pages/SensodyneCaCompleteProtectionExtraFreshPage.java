...
public class SensodyneCaCompleteProtectionExtraFreshPage extends BaseClass{
	
	public SensodyneCaCompleteProtectionExtraFreshPage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Complete Protection Extra Fresh']//self::a[@href='/en-ca/products/complete-protection-extra-fresh/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[text()='Buy now']//self::a[@href='/en-ca/where-to-buy/']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//span[text()='Original']//ancestor::a[@href='/en-ca/products/complete-protection-original/']")
