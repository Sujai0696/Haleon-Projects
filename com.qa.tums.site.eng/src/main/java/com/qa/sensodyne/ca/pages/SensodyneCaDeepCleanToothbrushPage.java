...
public class SensodyneCaDeepCleanToothbrushPage extends BaseClass{
	
	public SensodyneCaDeepCleanToothbrushPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Sensodyne Deep Clean toothbrush']//self::a[@href='/en-ca/products/deep-clean-toothbrush/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[text()='Buy now']//self::a[@href='/en-ca/where-to-buy/']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//span[text()='Deep Clean']//ancestor::a[@href='/en-ca/products/deep-clean-toothpaste/']")
	...
	@FindBy(xpath = "//a[text()='Sensodyne toothpaste']//self::a[@href='/en-ca/products/deep-clean-toothpaste/']")
	...
	@FindBy(xpath = "//a[text()='Find out how to brush your teeth.']//self::a[@href='/en-ca/sensitive-teeth-toothbrushes/how-to-brush-teeth/']")
