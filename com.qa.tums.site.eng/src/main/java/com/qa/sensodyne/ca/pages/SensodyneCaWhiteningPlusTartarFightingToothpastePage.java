...
public class SensodyneCaWhiteningPlusTartarFightingToothpastePage extends BaseClass{
	
	public SensodyneCaWhiteningPlusTartarFightingToothpastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Whitening Plus Tartar Fighting']//self::a[@href='/en-ca/products/whitening-plus-tartar-fighting-toothpaste/']")
