...
public class SensodyneCaDeepCleanToothpastePage extends BaseClass{
	
	public SensodyneCaDeepCleanToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Deep Clean']//self::a[@href='/en-ca/products/deep-clean-toothpaste/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[text()='Buy now']//self::a[@href='/en-ca/where-to-buy/']")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//a[text()='Deep Clean Toothbrush']//self::a[@href='/en-ca/products/deep-clean-toothbrush/']")
	private static WebElement availableProductTextOne;
	
	@FindBy(xpath = "//a[@href='/en-ca/products/deep-clean-toothbrush/']//img[@alt='Sensodyne Deep Clean toothbrush']")
