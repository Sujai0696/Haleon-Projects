...
public class SensodyneCaUltraFreshToothpastePage extends BaseClass{
	
	public SensodyneCaUltraFreshToothpastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Ultra Fresh']//self::a[@href='/en-ca/products/ultra-fresh-toothpaste/']")
