...
public class SensodyneEnGbSensodyneOriginalMintToothpastePage extends BaseClass{
	
	public SensodyneEnGbSensodyneOriginalMintToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Original Mint']//self::a[@href='/en-gb/products/sensodyne-original-mint-toothpaste/']")
