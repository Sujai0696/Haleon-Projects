...
public class SensodyneEnGbDailyCareGentleWhiteningToothpastePage extends BaseClass{
	
	
	public SensodyneEnGbDailyCareGentleWhiteningToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Gentle Whitening']//self::a[@href='/en-gb/products/daily-care-gentle-whitening-toothpaste/']")
