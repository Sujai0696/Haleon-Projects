...
public class SensodyneEnGbPronamelGentleWhiteningToothpastePage extends BaseClass{
	
	public SensodyneEnGbPronamelGentleWhiteningToothpastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even ']//ancestor::a[text()='Our Products']//self::a[@href='/en-gb/products/']")
	private static WebElement breadcrumbTwo;
	
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Pronamel Gentle Whitening']//self::a[@href='/en-gb/products/pronamel-gentle-whitening-toothpaste/']")
	...
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::a[text()='Pronamel Daily Protection']//self::a[@href='/en-gb/products/pronamel-daily-protection-toothpaste/']")
	private static WebElement mostPopularProductsOne;
	
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::span[text()='Pronamel Gentle Whitening']//ancestor::a[@href='/en-gb/products/pronamel-gentle-whitening-toothpaste/']")
	private static WebElement mostPopularProductsTwo;
	
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::a[text()='Pronamel Intensive Enamel Repair Extra Fresh']//self::a[@href='/en-gb/products/pronamel-intensive-enamel-repair-toothpaste/']")
	private static WebElement mostPopularProductsThree;
	
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::span[text()='Pronamel Intensive Enamel Repair Whitening']//ancestor::a[@href='/en-gb/products/pronamel-intensive-enamel-repair/']")
