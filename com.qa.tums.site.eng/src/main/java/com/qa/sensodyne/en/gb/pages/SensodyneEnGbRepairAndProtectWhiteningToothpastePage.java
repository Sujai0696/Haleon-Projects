...
public class SensodyneEnGbRepairAndProtectWhiteningToothpastePage extends BaseClass{
	
	public SensodyneEnGbRepairAndProtectWhiteningToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override col-xs-12 breadcrumbs-article fixed-component']//ancestor::a[text()='Repair and Protect Whitening']//self::a[@href='/en-gb/products/repair-and-protect-whitening-toothpaste/']")
	...
	@FindBy(xpath = "//span[text()='Extra Fresh']//ancestor::a[@href='/en-gb/products/repair-and-protect-extra-fresh-toothpaste/']")
