...
public class SensodyneEnGbRapidReliefExtraFreshToothpastePage extends BaseClass{
	
	public SensodyneEnGbRapidReliefExtraFreshToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override col-xs-12 breadcrumbs-article fixed-component']//ancestor::a[text()='Rapid Relief Extra Fresh']//self::a[@href='/en-gb/products/rapid-relief-extra-fresh-toothpaste/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[@class='ps-button-label' and text()='Buy Now']//ancestor::a")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[@class='ps-product-name' and text()='Sensodyne Rapid Relief Extra Fresh Toothpaste']")
	...
	@FindBy(xpath = "//a[@href='/en-gb/products/rapid-relief-whitening-toothpaste/']//following::img[@alt='Sensodyne Rapid Relief Whitening Toothpaste Pack']")
	private static WebElement availableProductImgOne;
	
	@FindBy(xpath = "//a[@href='/en-gb/products/rapid-relief-whitening-toothpaste/' and text()='Whitening']")
	private static WebElement availableProductLinkOne;
	
	@FindBy(xpath = "//a[@href='/en-gb/products/rapid-relief-toothpaste/']//img[@alt='Sensodyne Rapid Relief toothpaste']")
	private static WebElement availableProductImgTwo;
	
	@FindBy(xpath = "//span[text()='Rapid Relief']//ancestor::a[@href='/en-gb/products/rapid-relief-toothpaste/']")
