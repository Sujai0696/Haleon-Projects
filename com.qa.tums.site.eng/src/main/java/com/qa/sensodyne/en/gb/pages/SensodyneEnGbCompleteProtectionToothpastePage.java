...
public class SensodyneEnGbCompleteProtectionToothpastePage extends BaseClass{
	
	public SensodyneEnGbCompleteProtectionToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Complete Protection']//self::a[@href='/en-gb/products/complete-protection-toothpaste/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[@class='ps-button-label' and text()='Buy Now']//ancestor::a")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[@class='ps-product-name' and text()='Sensodyne Complete Protection Toothpaste']")
	...
	@FindBy(xpath = "//a[@href='/en-gb/products/complete-protection-extra-fresh-toothpaste/']//img[@alt='Sensodyne Complete Protection toothpaste in Extra Fresh']")
	private static WebElement availableProductImgOne;
	
	@FindBy(xpath = "//span[text()='Extra Fresh']//ancestor::a[@href='/en-gb/products/complete-protection-extra-fresh-toothpaste/']")
	private static WebElement availableProductLinkOne;
	
	@FindBy(xpath = "//a[@href='/en-gb/products/complete-protection-advanced-whitening-toothpaste/']//img[@alt='Sensodyne Complete Protection toothpaste in Advanced Whitening']")
	private static WebElement availableProductImgTwo;
	
	@FindBy(xpath = "//span[text()='Advanced whitening']//ancestor::a[@href='/en-gb/products/complete-protection-advanced-whitening-toothpaste/']")
