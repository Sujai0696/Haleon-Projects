...
public class SensodyneEnGbCompleteProtectionExtraFreshToothpastePage extends BaseClass{
	
	public SensodyneEnGbCompleteProtectionExtraFreshToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Complete Protection Extra Fresh']//self::a[@href='/en-gb/products/complete-protection-extra-fresh-toothpaste/']")
	...
	@FindBy(xpath = "//a[@href='/en-gb/products/complete-protection-toothpaste/']//img[@alt='Sensodyne Complete Protection toothpaste']")
	private static WebElement availableProductImgOne;
	
	@FindBy(xpath = "//span[text()='Original']//ancestor::a[@href='/en-gb/products/complete-protection-toothpaste/']")
