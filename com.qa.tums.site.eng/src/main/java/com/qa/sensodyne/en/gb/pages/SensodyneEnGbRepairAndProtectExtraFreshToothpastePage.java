...
public class SensodyneEnGbRepairAndProtectExtraFreshToothpastePage extends BaseClass{
	
	public SensodyneEnGbRepairAndProtectExtraFreshToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override col-xs-12 breadcrumbs-article fixed-component']//ancestor::a[text()='Repair and Protect Extra Fresh']//self::a[@href='/en-gb/products/repair-and-protect-extra-fresh-toothpaste/']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//span[@class='ps-button-label' and text()='Buy Now']//ancestor::a")
	private static WebElement buyNow;
	
	@FindBy(xpath = "//h2[@class='ps-product-name' and text()='Sensodyne Repair & Protect Extra Fresh Toothpaste']")
	...
	@FindBy(xpath = "//a[@href='/en-gb/products/repair-and-protect-whitening-toothpaste/']//img[@alt='Sensodyne Repair and Protect toothpaste in Whitening']")
	private static WebElement availableProductImgOne;
	
	@FindBy(xpath = "//span[text()='Whitening']//ancestor::a[@href='/en-gb/products/repair-and-protect-whitening-toothpaste/']")
	private static WebElement availableProductLinkOne;
	
	@FindBy(xpath = "//a[@href='/en-gb/products/repair-and-protect-toothpaste/']//img[@alt='Sensodyne Repair and Protect toothpaste']")
	private static WebElement availableProductImgTwo;
	
	@FindBy(xpath = "//span[text()='Original']//ancestor::a[@href='/en-gb/products/repair-and-protect-toothpaste/']")
	private static WebElement availableProductLinkTwo;
	
	@FindBy(xpath = "//a[@href='/en-gb/products/repair-and-protect-toothbrush/']//img[@alt='Sensodyne Repair and Protect toothbrush']")
	private static WebElement availableProductImgThree;
	
	@FindBy(xpath = "//a[@href='/en-gb/products/repair-and-protect-toothbrush/']//span[@class='light-blue-txt-light-18-roboto'][normalize-space()='Repair & Protect Toothbrush']")
	private static WebElement availableProductLinkThree;
	...
	@FindBy(xpath = "//span[text()='Most Popular Products']//following::span[text()='Repair & Protect Toothbrush']//ancestor::a[@href='/en-gb/products/repair-and-protect-toothbrush/']")
...
//	        Assert.assertFalse(hasValidUrl);
	...
	public void clickAvailableProductImgThree() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(availableProductImgThree)) {
			scrollDownUsingElement(availableProductImgThree);
			clickElementUsingJavaScript(availableProductImgThree);
			pageLoad();
		} else {
			System.out.println("Available Product Img Three is not presented in the page");
			throw new Exception("Available Product Img Three is not presented in the page");
		}
	}
	
	public void clickAvailableProductLinkThree() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(availableProductLinkThree)) {
			scrollDownUsingElement(availableProductLinkThree);
			clickElementUsingJavaScript(availableProductLinkThree);
			pageLoad();
		} else {
			System.out.println("Available Product Link Three is not presented in the page");
			throw new Exception("Available Product Link Three is not presented in the page");
		}
	}
