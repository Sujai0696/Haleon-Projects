...
public class SensodyneEnGbPronamelMultiActionToothpastePage extends BaseClass{
	
	public SensodyneEnGbPronamelMultiActionToothpastePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Pronamel Multi-Action']//self::a[@href='/en-gb/products/pronamel-multi-action-toothpaste/']")
