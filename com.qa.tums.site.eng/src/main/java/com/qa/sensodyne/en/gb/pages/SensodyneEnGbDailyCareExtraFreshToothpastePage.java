...
public class SensodyneEnGbDailyCareExtraFreshToothpastePage extends BaseClass{
	
	public SensodyneEnGbDailyCareExtraFreshToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override first odd last col-xs-12']//ancestor::a[text()='Extra Fresh']//self::a[@href='/en-gb/products/daily-care-extra-fresh-toothpaste/']")
