...
public class SensodyneEnGbRapidReliefWhiteningToothpastePage extends BaseClass{
	
	public SensodyneEnGbRapidReliefWhiteningToothpastePage() {
	...
	@FindBy(xpath = "//div[@class='breadcrumbs component section breadcrumbs-comp container-override col-xs-12 breadcrumbs-article fixed-component']//ancestor::a[text()='Rapid Relief Whitening']//self::a[@href='/en-gb/products/rapid-relief-whitening-toothpaste/']")
	...
	@FindBy(xpath = "//a[@href='/en-gb/products/rapid-relief-extra-fresh-toothpaste/']//img[@alt='Sensodyne Rapid Relief toothpaste in Extra Fresh']")
	private static WebElement availableProductImgOne;
	
	@FindBy(xpath = "//span[text()='Extra Fresh']//ancestor::a[@href='/en-gb/products/rapid-relief-extra-fresh-toothpaste/']")
