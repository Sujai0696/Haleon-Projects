...
public class QuitStephenieArticlePage extends BaseClass{

	public QuitStephenieArticlePage() {
	...
	@FindBy(xpath = "//div[@class='pagevideo']//img[@title=\"Stephenie's Article\"]")
	...
	@FindBy(xpath = "//a[text()='NRT Education' and @href='/support-hub.html']")
	...
	@FindBy(xpath = "//div[@class='image component section rel-art-blue related-art-img related-art-img3 even last grid_4']")
