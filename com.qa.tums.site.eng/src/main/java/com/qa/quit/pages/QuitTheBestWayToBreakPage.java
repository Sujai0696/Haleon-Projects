...
public class QuitTheBestWayToBreakPage extends BaseClass{
	
	public QuitTheBestWayToBreakPage() {
	...
	@FindBy(xpath = "//a[text()='triggers' and @href='/support-hub/overcome-smoking-triggers.html']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[text()='It takes two: Getting healthy may be easier with a partner' and @href='/news-and-events/it-takes-two.html']")
