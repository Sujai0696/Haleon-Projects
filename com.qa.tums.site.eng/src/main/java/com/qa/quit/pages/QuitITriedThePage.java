...
public class QuitITriedThePage extends BaseClass{
	
	public QuitITriedThePage() {
	...
	@FindBy(xpath = "//a[text()='The only 7 things you can control in life' and @href='/news-and-events/the-only-7-things.html']")
