...
public class Quit7WorstHeartHealthMistakesPages extends BaseClass{
	
	public Quit7WorstHeartHealthMistakesPages() {
	...
	@FindBy(xpath = "//a[text()='7 simple clean eating recipes for busy weeknights' and @href='/news-and-events/7-simple-clean.html']")
