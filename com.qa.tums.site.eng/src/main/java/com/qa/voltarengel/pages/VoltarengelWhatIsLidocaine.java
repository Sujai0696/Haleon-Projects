...
public class VoltarengelWhatIsLidocaine extends BaseClass{
	public VoltarengelWhatIsLidocaine() {
	...
	@FindBy(xpath = "//a[text()='manage their pain topically']")
	private static WebElement ManageTheirPainTopically;
	...
	@FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/over-the-counter-diclofenac-gel/']//ancestor::div[@class='box component section articleCard padding-20-bottom-dt padding-20-top-dt padding-30-right-dt first odd col-xs-12 col-md-6']")
	private static WebElement OverTheCounterDiclofenacGel;
	
	@FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/how-otc-arthritis-cream-gel-works/']//ancestor::div[@class='box component section articleCard padding-15-left-dt padding-20-bottom-dt padding-20-top-dt even last col-xs-12 col-md-6']")
	private static WebElement HowOTCArthritisCreamsWork;
	...
	public void clickonManageTheirPainTopically() throws Exception {
		waitForPageLoadJava();
		moveToElement(ManageTheirPainTopically);
		actionClick(ManageTheirPainTopically);
	}
	...
	public void clickonHowOTCArthritisCreamsWork() throws Exception {
		waitForPageLoadJava();
		moveToElement(HowOTCArthritisCreamsWork);
		actionClick(HowOTCArthritisCreamsWork);
	}
