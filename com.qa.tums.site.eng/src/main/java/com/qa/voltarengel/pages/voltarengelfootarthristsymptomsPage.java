...
public class voltarengelfootarthristsymptomsPage extends BaseClass{
	
	public voltarengelfootarthristsymptomsPage() {
    ...
    private static WebElement footarthristsymptoms_breadcrumbs;				
    ...
    @FindBy(xpath = "//a[text()='foot exercises']")
    private static WebElement footexercises;
	
    @FindBy(xpath = "//span[text()='Foot Exercises for Arthritis Pain Relief']")
    private static WebElement footexercises_txt;
...
//methods
    ...
    public void clickonfootarthristsymptoms_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(footarthristsymptoms_breadcrumbs);
    	clickElementUsingJavaScript(footarthristsymptoms_breadcrumbs);
    	pageLoad();
    }				
    public void clickonVoltarenarthristpainsymptoms() throws Exception {
    	waitForPageLoadJava();
    ...
    public void clickonFootexercises() throws Exception {
    	waitForPageLoadJava();
    	scrollDownUsingElement(footexercises);
    	moveToElement(footexercises);
    	clickElementUsingJavaScript(footexercises);
    	visibilityOf(footexercises_txt);
    	boolean elementIsDisplayed=elementIsDisplayed(footexercises_txt);
    	Assert.assertTrue(elementIsDisplayed);
    	System.out.println(getElementText(footexercises_txt));
    	pageLoad();
    }			
