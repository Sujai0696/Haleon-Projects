...
public class VoltarengelHandPage extends BaseClass{
	
	public VoltarengelHandPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/hand/']//self::a[text()='Hand Exercises for Arthritis Pain Relief']")
    private static WebElement breadcrumbFour;
    
    @FindBy(xpath = "//a[@href='/what-is-arthritis/']//self::a[text()='hand arthritis']")
    private static WebElement hyperLinkHandArthristis;
    ...
    @FindBy(xpath = "//a[@href='/understanding-pain/about-pain/']//self::a[text()='joint pain due to arthritis']")
    private static WebElement hyperLinkJointPainDueToArthritis;
    
    @FindBy(xpath = "//a[@href='/what-is-arthritis/symptoms/']//self::a[text()='arthritis symptoms']")
    private static WebElement hyperLinkArthritisSymptoms;
	...
	public void clickHyperLinkHandArthristis() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkHandArthristis)) {
			scrollDownUsingElement(hyperLinkHandArthristis);
			clickElementUsingJavaScript(hyperLinkHandArthristis);
			pageLoad();
			System.out.println("Hyper Link Hand Arthristis is clicked successfully");
		} else {
			System.out.println("Hyper Link Hand Arthristis is not preseneted in the page");
			throw new Exception("Hyper Link Hand Arthristis is not preseneted in the page");
		}
	}
	...
	public void clickHyperLinkJointPainDueToArthritis() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkJointPainDueToArthritis)) {
			scrollDownUsingElement(hyperLinkJointPainDueToArthritis);
			clickElementUsingJavaScript(hyperLinkJointPainDueToArthritis);
			pageLoad();
			System.out.println("Hyper Link Joint Pain Due To Arthritis is clicked successfully");
		} else {
			System.out.println("Hyper Link Joint Pain Due To Arthritis is not preseneted in the page");
			throw new Exception("Hyper Link Joint Pain Due To Arthritis is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkArthritisSymptoms() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkArthritisSymptoms)) {
			scrollDownUsingElement(hyperLinkArthritisSymptoms);
			clickElementUsingJavaScript(hyperLinkArthritisSymptoms);
			pageLoad();
			System.out.println("Hyper Link Arthritis Symptoms is clicked successfully");
		} else {
			System.out.println("Hyper Link Arthritis Symptoms is not preseneted in the page");
			throw new Exception("Hyper Link Arthritis Symptoms is not preseneted in the page");
		}
	}
