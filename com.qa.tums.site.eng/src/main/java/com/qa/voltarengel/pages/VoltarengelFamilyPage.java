...
public class VoltarengelFamilyPage extends BaseClass{
	
	public VoltarengelFamilyPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/family/']//self::a[text()='Managing Arthritis With Your Family']")
    private static WebElement breadcrumbFour;
    
    @FindBy(xpath = "//a[@href='/understanding-pain/']//self::a[text()='pain']")
    private static WebElement hyperLinkPain;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/']//self::a[text()='arthritis more manageable']")
    private static WebElement hyperLinkArthritisMoreManageable;
    
    @FindBy(xpath = "//a[@href='/what-is-arthritis/']//self::a[text()='what your condition is']")
    private static WebElement hyperLinkWhatYourConditionIs;
    
    @FindBy(xpath = "//a[@href='/understanding-pain/about-pain/']//self::a[text()='pain caused by arthritis']")
    private static WebElement hyperLinkPainCausedByArthritis;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/alone/']//self::a[text()='stressors']")
    private static WebElement hyperLinkStressors;
	...
	public void clickHyperLinkPain() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkPain)) {
			scrollDownUsingElement(hyperLinkPain);
			clickElementUsingJavaScript(hyperLinkPain);
			pageLoad();
			System.out.println("Hyper Link Pain is clicked successfully");
		} else {
			System.out.println("Hyper Link Pain is not preseneted in the page");
			throw new Exception("Hyper Link Pain is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkArthritisMoreManageable() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkArthritisMoreManageable)) {
			scrollDownUsingElement(hyperLinkArthritisMoreManageable);
			clickElementUsingJavaScript(hyperLinkArthritisMoreManageable);
			pageLoad();
			System.out.println("Hyper Link Arthritis More Manageable is clicked successfully");
		} else {
			System.out.println("Hyper Link Arthritis More Manageable is not preseneted in the page");
			throw new Exception("Hyper Link Arthritis More Manageable is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkWhatYourConditionIs() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkWhatYourConditionIs)) {
			scrollDownUsingElement(hyperLinkWhatYourConditionIs);
			clickElementUsingJavaScript(hyperLinkWhatYourConditionIs);
			pageLoad();
			System.out.println("Hyper Link What Your Condition Is is clicked successfully");
		} else {
			System.out.println("Hyper Link What Your Condition Is is not preseneted in the page");
			throw new Exception("Hyper Link What Your Condition Is is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkPainCausedByArthritis() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkPainCausedByArthritis)) {
			scrollDownUsingElement(hyperLinkPainCausedByArthritis);
			clickElementUsingJavaScript(hyperLinkPainCausedByArthritis);
			pageLoad();
			System.out.println("Hyper Link Pain Caused By Arthritis is clicked successfully");
		} else {
			System.out.println("Hyper Link Pain Caused By Arthritis is not preseneted in the page");
			throw new Exception("Hyper Link Pain Caused By Arthritis is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkStressors() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkStressors)) {
			scrollDownUsingElement(hyperLinkStressors);
			clickElementUsingJavaScript(hyperLinkStressors);
			pageLoad();
			System.out.println("Hyper Link Stressors is clicked successfully");
		} else {
			System.out.println("Hyper Link Stressors is not preseneted in the page");
			throw new Exception("Hyper Link Stressors is not preseneted in the page");
		}
	}
