...
public class VoltarengelFootPage extends BaseClass{
	
	public VoltarengelFootPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/foot/']//self::a[text()='Foot Arthritis Exercises for Pain Relief']")
    private static WebElement breadcrumbFour;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/how-to-relieve-arthritis-pain/']//self::a[text()='arthritis pain']")
