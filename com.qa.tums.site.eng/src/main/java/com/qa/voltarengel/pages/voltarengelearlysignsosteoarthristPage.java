...
public class voltarengelearlysignsosteoarthristPage extends BaseClass{
	
	public voltarengelearlysignsosteoarthristPage() {
    ...
    private static WebElement earlysignsOsteoarthrist_breadcrumbs;		
...
//methods
    ...
    public void clickonearlysignsArthrists_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(earlysignsOsteoarthrist_breadcrumbs);
    	clickElementUsingJavaScript(earlysignsOsteoarthrist_breadcrumbs);
    	pageLoad();
    }			
