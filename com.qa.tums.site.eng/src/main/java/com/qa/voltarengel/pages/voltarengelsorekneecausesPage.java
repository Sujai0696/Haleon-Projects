...
public class voltarengelsorekneecausesPage extends BaseClass{
	
	public voltarengelsorekneecausesPage() {
    ...
    @FindBy(xpath = "//a[text()='Sore Knees Causes']")
    private static WebElement sorekneecauses_breadcrumbs;		
	
    @FindBy(xpath = "//a[text()='alleviate your sore knees']")
    private static WebElement alleviatesoreknees;
	
    @FindBy(xpath = "//span[text()='How to Find Arthritis Pain Relief']")
    private static WebElement alleviatesoreknees_txt;
	
    @FindBy(xpath = "//a[text()='Voltaren Arthritis Pain']")
    private static WebElement voltarenarthristpain;
	
    @FindBy(xpath = "//h1[text()='What is Voltaren Arthritis Pain Relief Gel?']")
    private static WebElement voltarenarthristpain_txt;
	
    @FindBy(xpath = "//a[text()='at-home treatment options']")
    private static WebElement hometreatmentoptions;
	
    @FindBy(xpath = "//span[text()='Arthritis Pain Relief at Home']")
    private static WebElement hometreatmentoptions_txt;
...
//methods
    ...
    public void clickonSorekneecauses_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(sorekneecauses_breadcrumbs);
    	clickElementUsingJavaScript(sorekneecauses_breadcrumbs);
    	pageLoad();
    }				
    public void clickonAlleviatessorecauses() throws Exception {
    	waitForPageLoadJava();
    	scrollDownUsingElement(alleviatesoreknees);
    	moveToElement(alleviatesoreknees);
    	clickElementUsingJavaScript(alleviatesoreknees);
    	visibilityOf(alleviatesoreknees_txt);
    	boolean elementIsDisplayed=elementIsDisplayed(alleviatesoreknees_txt);
    	Assert.assertTrue(elementIsDisplayed);
    	System.out.println(getElementText(alleviatesoreknees_txt));
    	pageLoad();
    }				
    public void clickonVoltarenArthristpain() throws Exception {
    	waitForPageLoadJava();
    	scrollDownUsingElement(voltarenarthristpain);
    	moveToElement(voltarenarthristpain);
    	clickElementUsingJavaScript(voltarenarthristpain);
    	visibilityOf(voltarenarthristpain_txt);
    	boolean elementIsDisplayed=elementIsDisplayed(voltarenarthristpain_txt);
    	Assert.assertTrue(elementIsDisplayed);
    	System.out.println(getElementText(voltarenarthristpain_txt));
    	pageLoad();
    }				
    public void clickonHometreatmentOptions() throws Exception {
    	waitForPageLoadJava();
    	scrollDownUsingElement(hometreatmentoptions);
    	moveToElement(hometreatmentoptions);
    	clickElementUsingJavaScript(hometreatmentoptions);
    	visibilityOf(hometreatmentoptions_txt);
    	boolean elementIsDisplayed=elementIsDisplayed(hometreatmentoptions_txt);
    	Assert.assertTrue(elementIsDisplayed);
    	System.out.println(getElementText(hometreatmentoptions_txt));
    	pageLoad();
    }				
