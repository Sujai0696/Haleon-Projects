...
public class VoltarengelElbowPage extends BaseClass{
	
	public VoltarengelElbowPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/elbow/']//self::a[text()='Elbow Arthritis Exercises for Pain Relief']")
    private static WebElement breadcrumbFour;
    
    @FindBy(xpath = "//a[@href='/understanding-pain/about-pain/']//self::a[text()='discomfort and pain']")
    private static WebElement hyperLinkDiscomfortAndPain;
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/how-to-relieve-arthritis-pain/']//self::a[text()='relieve arthritis pain']")
    private static WebElement hyperLinkRelieveArthritisPain;
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/alone/']//ancestor::strong[text()='READ MORE']")
	...
	public void clickHyperLinkDiscomfortAndPain() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkDiscomfortAndPain)) {
			scrollDownUsingElement(hyperLinkDiscomfortAndPain);
			clickElementUsingJavaScript(hyperLinkDiscomfortAndPain);
			pageLoad();
			System.out.println("Hyper Link Discomfort And Pain is clicked successfully");
		} else {
			System.out.println("Hyper Link Discomfort And Pain is not preseneted in the page");
			throw new Exception("Hyper Link Discomfort And Pain is not preseneted in the page");
		}
	}
	...
	public void clickHyperLinkRelieveArthritisPain() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkRelieveArthritisPain)) {
			scrollDownUsingElement(hyperLinkRelieveArthritisPain);
			clickElementUsingJavaScript(hyperLinkRelieveArthritisPain);
			pageLoad();
			System.out.println("Hyper Link Relieve Arthritis Pain is clicked successfully");
		} else {
			System.out.println("Hyper Link Relieve Arthritis Pain is not preseneted in the page");
			throw new Exception("Hyper Link Relieve Arthritis Pain is not preseneted in the page");
		}
	}
