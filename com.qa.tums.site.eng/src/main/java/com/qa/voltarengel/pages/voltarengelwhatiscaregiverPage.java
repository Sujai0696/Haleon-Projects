...
public class voltarengelwhatiscaregiverPage extends BaseClass{
	
	public voltarengelwhatiscaregiverPage() {
    ...
    private static WebElement whatiscaregiver_breadcrumbs;			
...
//methods
    ...
    public void clickonwhatiscaregiver_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(whatiscaregiver_breadcrumbs);
    	clickElementUsingJavaScript(whatiscaregiver_breadcrumbs);
    	pageLoad();
    }					
