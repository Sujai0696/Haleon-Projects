...
public class voltarengelmorningjointpainPage extends BaseClass{
	
	public voltarengelmorningjointpainPage() {
    ...
    private static WebElement morningjointpain_breadcrumbs;	
...
//methods
    ...
    public void clickonMorningjointpain_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(morningjointpain_breadcrumbs);
    	clickElementUsingJavaScript(morningjointpain_breadcrumbs);
    	pageLoad();
    }				
