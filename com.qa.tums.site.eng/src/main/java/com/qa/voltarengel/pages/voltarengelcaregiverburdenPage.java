...
public class voltarengelcaregiverburdenPage extends BaseClass{
	
	public voltarengelcaregiverburdenPage() {
    ...
    private static WebElement whatiscaregiverburden_breadcrumbs;		
    ...
    @FindBy(xpath = "//a[@href='/supporting-caregivers/what-is-caregiver-role-strain/']")
...
//methods
    ...
    public void clickonwhatiscaregiverburden_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(whatiscaregiverburden_breadcrumbs);
    	clickElementUsingJavaScript(whatiscaregiverburden_breadcrumbs);
    	pageLoad();
    }						
