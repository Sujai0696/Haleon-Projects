...
public class VoltarengelHowToPreventArthritisPage extends BaseClass{
	
	public VoltarengelHowToPreventArthritisPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/how-to-prevent-arthritis/']//self::a[text()='How to prevent arthritis']")
    private static WebElement breadcrumbFour;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/wrist/']//self::a[text()='wrists']")
    private static WebElement hyperLinkWrists;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/knee/']//self::a[text()='knees']")
    private static WebElement hyperLinkKnees;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/ankle/']//self::a[text()='ankles']")
    private static WebElement hyperLinkAnkles;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/foot/']//self::a[text()=' feet']")
    private static WebElement hyperLinkFeet;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/']//self::a[text()='pain relief exercises']")
    private static WebElement hyperLinkPainReliefExercises;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/']//self::a[text()='arthritis management tips']")
    private static WebElement hyperLinkArthritisManagementTips;
	...
	public void clickHyperLinkWrists() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkWrists)) {
			scrollDownUsingElement(hyperLinkWrists);
			clickElementUsingJavaScript(hyperLinkWrists);
			pageLoad();
			System.out.println("Hyper Link Wrists is clicked successfully");
		} else {
			System.out.println("Hyper Link Wrists is not preseneted in the page");
			throw new Exception("Hyper Link Wrists is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkKnees() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkKnees)) {
			scrollDownUsingElement(hyperLinkKnees);
			clickElementUsingJavaScript(hyperLinkKnees);
			pageLoad();
			System.out.println("Hyper Link Knees is clicked successfully");
		} else {
			System.out.println("Hyper Link Knees is not preseneted in the page");
			throw new Exception("Hyper Link Knees is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkAnkles() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkAnkles)) {
			scrollDownUsingElement(hyperLinkAnkles);
			clickElementUsingJavaScript(hyperLinkAnkles);
			pageLoad();
			System.out.println("Hyper Link Ankles is clicked successfully");
		} else {
			System.out.println("Hyper Link Ankles is not preseneted in the page");
			throw new Exception("Hyper Link Ankles is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkFeet() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkFeet)) {
			scrollDownUsingElement(hyperLinkFeet);
			clickElementUsingJavaScript(hyperLinkFeet);
			pageLoad();
			System.out.println("Hyper Link Feet is clicked successfully");
		} else {
			System.out.println("Hyper Link Feet is not preseneted in the page");
			throw new Exception("Hyper Link Feet is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkPainReliefExercises() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkPainReliefExercises)) {
			scrollDownUsingElement(hyperLinkPainReliefExercises);
			clickElementUsingJavaScript(hyperLinkPainReliefExercises);
			pageLoad();
			System.out.println("Hyper Link Pain Relief Exercises is clicked successfully");
		} else {
			System.out.println("Hyper Link Pain Relief Exercises is not preseneted in the page");
			throw new Exception("Hyper Link Pain Relief Exercises is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkArthritisManagementTips() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkArthritisManagementTips)) {
			scrollDownUsingElement(hyperLinkArthritisManagementTips);
			clickElementUsingJavaScript(hyperLinkArthritisManagementTips);
			pageLoad();
			System.out.println("Hyper Link Arthritis Management Tips is clicked successfully");
		} else {
			System.out.println("Hyper Link Arthritis Management Tips is not preseneted in the page");
			throw new Exception("Hyper Link Arthritis Management Tips is not preseneted in the page");
		}
	}
