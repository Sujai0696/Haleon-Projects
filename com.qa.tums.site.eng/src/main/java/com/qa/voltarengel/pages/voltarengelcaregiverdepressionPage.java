...
public class voltarengelcaregiverdepressionPage extends BaseClass{
	
	public voltarengelcaregiverdepressionPage() {
    ...
    private static WebElement caregiverDepression_breadcrumbs;		
...
//methods
    ...
    public void clickonCaregiverDepression_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(caregiverDepression_breadcrumbs);
    	clickElementUsingJavaScript(caregiverDepression_breadcrumbs);
    	pageLoad();
    }				
