...
public class VoltarengelMorningRoutineArthritisReliefPage extends BaseClass{
	
	public VoltarengelMorningRoutineArthritisReliefPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/morning-routine-arthritis-relief/']//self::a[text()='Morning Routine for Arthritis Relief']")
    private static WebElement breadcrumbThree;
    
    @FindBy(xpath = "//a[@href='https://www.voltarengel.com/what-is-arthritis/']//self::a[text()='osteoarthritis']")
    private static WebElement hyperLinkOsteoarthritis;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/']//self::a[text()='Exercise']")
    private static WebElement hyperLinkExercise;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/how-otc-arthritis-cream-gel-works/']//self::a[text()='topical creams']")
    private static WebElement hyperLinkTopicalCreams;
    ...
    @FindBy(xpath = "//a[@href='/']//self::a[text()='Voltaren webpage']")
    private static WebElement hyperLinkVoltarenWebpage;
	...
	public void clickHyperLinkOsteoarthritis() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkOsteoarthritis)) {
			scrollDownUsingElement(hyperLinkOsteoarthritis);
			clickElementUsingJavaScript(hyperLinkOsteoarthritis);
			pageLoad();
			System.out.println("Hyper Link Osteoarthritis is clicked successfully");
		} else {
			System.out.println("Hyper Link Osteoarthritis is not preseneted in the page");
			throw new Exception("Hyper Link Osteoarthritis is not preseneted in the page");
		}
	}
	...
	public void clickHyperLinkTopicalCreams() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkTopicalCreams)) {
			scrollDownUsingElement(hyperLinkTopicalCreams);
			clickElementUsingJavaScript(hyperLinkTopicalCreams);
			pageLoad();
			System.out.println("Hyper Link Topical Creams is clicked successfully");
		} else {
			System.out.println("Hyper Link Topical Creams is not preseneted in the page");
			throw new Exception("Hyper Link Topical Creams is not preseneted in the page");
		}
	}
	...
	public void clickHyperLinkVoltarenWebpage() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkVoltarenWebpage)) {
			scrollDownUsingElement(hyperLinkVoltarenWebpage);
			clickElementUsingJavaScript(hyperLinkVoltarenWebpage);
			pageLoad();
			System.out.println("Hyper Link Voltaren Webpage is clicked successfully");
		} else {
			System.out.println("Hyper Link Voltaren Webpage is not preseneted in the page");
			throw new Exception("Hyper Link Voltaren Webpage is not preseneted in the page");
		}
	}
