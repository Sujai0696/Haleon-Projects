...
public class voltarengelkneestrechesarthristPage extends BaseClass{
	
	public voltarengelkneestrechesarthristPage() {
    ...
    private static WebElement standingstrechesarthristpain_breadcrumbs;		
...
//methods
    ...
    public void clickonstandingstrechespain_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(standingstrechesarthristpain_breadcrumbs);
    	clickElementUsingJavaScript(standingstrechesarthristpain_breadcrumbs);
    	pageLoad();
    }				
