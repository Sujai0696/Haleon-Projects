...
public class voltarengelcaregiverselfcaretipsPage extends BaseClass{
	
	public voltarengelcaregiverselfcaretipsPage() {
    ...
    private static WebElement selfcaretips_breadcrumbs;	
    ...
    @FindBy(xpath = "//div[@class='richTextEnhanced richText section richTextHyperlinkedImage default-style even last component col-xs-12']//a[@href='/supporting-caregivers/health-wellness-tips-for-caregivers/']")
...
//methods
    ...
    public void clickonselfcaretips_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(selfcaretips_breadcrumbs);
    	clickElementUsingJavaScript(selfcaretips_breadcrumbs);
    	pageLoad();
    }		
