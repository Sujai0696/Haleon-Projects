...
public class VoltarengelKneePage extends BaseClass{
	
	public VoltarengelKneePage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/knee/']//self::a[text()='Knee Exercises for Arthritis Pain Relief']")
    ...
    @FindBy(xpath = "//a[@href='/what-is-arthritis/causes/']//self::a[text()='arthritis']")
    private static WebElement hyperLinkArthritis;
    
    @FindBy(xpath = "//a[@href='/understanding-pain/about-pain/']//self::a[text()='pain']")
    ...
    @FindBy(xpath = "//a[@href='/what-is-arthritis/']//self::a[text()='arthritis knee pain']")
    private static WebElement hyperLinkArthritisKneePain;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/how-to-relieve-arthritis-pain/']//self::a[text()='knee pain relief']")
    private static WebElement hyperLinkKneePainRelief;
	...
	public void clickHyperLinkArthritisKneePain() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkArthritisKneePain)) {
			scrollDownUsingElement(hyperLinkArthritisKneePain);
			clickElementUsingJavaScript(hyperLinkArthritisKneePain);
			pageLoad();
			System.out.println("Hyper Link Arthritis Knee Pain is clicked successfully");
		} else {
			System.out.println("Hyper Link Arthritis Knee Pain is not preseneted in the page");
			throw new Exception("Hyper Link Arthritis Knee Pain is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkKneePainRelief() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkKneePainRelief)) {
			scrollDownUsingElement(hyperLinkKneePainRelief);
			clickElementUsingJavaScript(hyperLinkKneePainRelief);
			pageLoad();
			System.out.println("Hyper Link Knee Pain Relief is clicked successfully");
		} else {
			System.out.println("Hyper Link Knee Pain Relief is not preseneted in the page");
			throw new Exception("Hyper Link Knee Pain Relief is not preseneted in the page");
		}
	}
