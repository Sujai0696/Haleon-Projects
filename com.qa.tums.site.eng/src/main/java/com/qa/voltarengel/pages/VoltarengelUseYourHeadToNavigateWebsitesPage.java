...
public class VoltarengelUseYourHeadToNavigateWebsitesPage extends BaseClass{
	
	public VoltarengelUseYourHeadToNavigateWebsitesPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/use-your-head-to-navigate-websites/']//self::a[text()='Use Your Head to Navigate Websites']")
    private static WebElement breadcrumbThree;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/']//self::a[text()='living with arthritis']")
    private static WebElement hyperLinkLivingWithArthritis;
    
    @FindBy(xpath = "//a[contains(@href,'https://www.voltarengel.com/living-with-arthritis/first-arthritis-friendly-site/')]//self::a[text()='tools']")
    private static WebElement hyperLinkTools;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/how-to-relieve-arthritis-pain/']//self::a[text()='arthritis relief']")
    private static WebElement hyperLinkArthritisRelief;
    
    @FindBy(xpath = "//a[@href='https://www.apple.com/accessibility/']//self::a[text()='website']")
    private static WebElement hyperLinkWebsite;
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/home/']//ancestor::strong[text()='READ MORE']")
	...
	public void clickHyperLinkLivingWithArthritis() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkLivingWithArthritis)) {
			scrollDownUsingElement(hyperLinkLivingWithArthritis);
			clickElementUsingJavaScript(hyperLinkLivingWithArthritis);
			pageLoad();
			System.out.println("Hyper Link Living With Arthritis is clicked successfully");
		} else {
			System.out.println("Hyper Link Living With Arthritis is not preseneted in the page");
			throw new Exception("Hyper Link Living With Arthritis is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkTools() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkTools)) {
			scrollDownUsingElement(hyperLinkTools);
			clickElementUsingJavaScript(hyperLinkTools);
			pageLoad();
			System.out.println("Hyper Link Tools is clicked successfully");
		} else {
			System.out.println("Hyper Link Tools is not preseneted in the page");
			throw new Exception("Hyper Link Tools is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkArthritisRelief() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkArthritisRelief)) {
			scrollDownUsingElement(hyperLinkArthritisRelief);
			clickElementUsingJavaScript(hyperLinkArthritisRelief);
			pageLoad();
			System.out.println("Hyper Link Arthritis Relief is clicked successfully");
		} else {
			System.out.println("Hyper Link Arthritis Relief is not preseneted in the page");
			throw new Exception("Hyper Link Arthritis Relief is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkWebsite() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkWebsite)) {
			scrollDownUsingElement(hyperLinkWebsite);
			clickElementUsingJavaScript(hyperLinkWebsite);
			pageLoad();
			System.out.println("Hyper Link Website is clicked successfully");
		} else {
			System.out.println("Hyper Link Website is not preseneted in the page");
			throw new Exception("Hyper Link Website is not preseneted in the page");
		}
	}
