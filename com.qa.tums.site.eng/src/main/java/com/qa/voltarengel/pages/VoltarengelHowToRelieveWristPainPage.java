...
public class VoltarengelHowToRelieveWristPainPage extends BaseClass{
	
	public VoltarengelHowToRelieveWristPainPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/how-to-relieve-wrist-pain/']//self::a[text()='How to Relieve Wrist Pain']")
    private static WebElement breadcrumbThree;
    
    @FindBy(xpath = "//a[@href='https://www.voltarengel.com/understanding-pain/']//self::a[text()='wrist pain']")
    private static WebElement hyperLinkWristPain;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/']//self::a[text()='strengthening and flexibility exercises']")
    private static WebElement hyperLinkFlexibilityExercises;
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/wrist/']//self::a[text()='wrist exercises for arthritis relief']")
	...
	public void clickHyperLinkWristPain() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkWristPain)) {
			scrollDownUsingElement(hyperLinkWristPain);
			clickElementUsingJavaScript(hyperLinkWristPain);
			pageLoad();
			System.out.println("Hyper Link Wrist Pain is clicked successfully");
		} else {
			System.out.println("Hyper Link Wrist Pain is not preseneted in the page");
			throw new Exception("Hyper Link Wrist Pain is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkFlexibilityExercises() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkFlexibilityExercises)) {
			scrollDownUsingElement(hyperLinkFlexibilityExercises);
			clickElementUsingJavaScript(hyperLinkFlexibilityExercises);
			pageLoad();
			System.out.println("Hyper Link Flexibility Exercises is clicked successfully");
		} else {
			System.out.println("Hyper Link Flexibility Exercises is not preseneted in the page");
			throw new Exception("Hyper Link Flexibility Exercises is not preseneted in the page");
		}
	}
