...
public class VoltarenWhatIsCaregiverRoleStrain extends BaseClass{
	public VoltarenWhatIsCaregiverRoleStrain() {
	...
	@FindBy(xpath = "//a[@href='/supporting-caregivers/what-is-caregiver-burden/']//ancestor::div[@class='box component section articleCard padding-15-right-dt padding-20-bottom-dt padding-20-top-dt first odd col-xs-12 col-md-6']")
	private static WebElement Article1;
	
	@FindBy(xpath = "//a[@href='/supporting-caregivers/caregiver-burnout-and-stress/']//ancestor::div[@class='box component section articleCard padding-15-left-dt padding-20-bottom-dt padding-20-top-dt even last col-xs-12 col-md-6']")
