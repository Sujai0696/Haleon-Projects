...
public class VoltarengelHowToRelieveJointPainPage extends BaseClass{
	
	public VoltarengelHowToRelieveJointPainPage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/how-to-relieve-joint-pain/']//self::a[text()='How to Relieve Joint Pain']")
    private static WebElement breadcrumbThree;
     
    @FindBy(xpath = "//a[@href='/what-is-arthritis/symptoms/']//self::a[text()='symptoms']")
	...
	public void clickHyperLinkSymptoms() throws Exception{
		...
		if (isElementPresent(hyperLinkSymptoms)) {
			...
			pageLoad();
			System.out.println("Hyper Link Symptoms is clicked successfully");
		} else {
			System.out.println("Hyper Link Symptoms is not preseneted in the page");
			throw new Exception("Hyper Link Symptoms is not preseneted in the page");
		}
	}
