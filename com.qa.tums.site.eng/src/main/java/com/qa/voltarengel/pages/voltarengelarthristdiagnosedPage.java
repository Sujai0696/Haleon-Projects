...
public class voltarengelarthristdiagnosedPage extends BaseClass{
	
	public voltarengelarthristdiagnosedPage() {
    ...
    @FindBy(xpath = "//a[text()='symptoms of arthritis']")
    private static WebElement symptomsArthrist;	
	
    @FindBy(xpath = "//h1[@class='innerHeading text-center']")
    private static WebElement symptomsArthrist_txt;	
	
    @FindBy(xpath = "//a[text()='excercise']")
...
//methods
    ...
    public void clickonSymptomsArthrist() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(symptomsArthrist);
    	clickElementUsingJavaScript(symptomsArthrist);
    	visibilityOf(symptomsArthrist_txt);
    	boolean elementIsDisplayed=elementIsDisplayed(symptomsArthrist_txt);
    	Assert.assertTrue(elementIsDisplayed);
    	System.out.println(getElementText(symptomsArthrist_txt));
    	pageLoad();
    }				
