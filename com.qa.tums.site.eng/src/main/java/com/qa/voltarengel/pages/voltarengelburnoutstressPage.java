...
public class voltarengelburnoutstressPage extends BaseClass{
	
	public voltarengelburnoutstressPage() {
    ...
    private static WebElement carewalkssupport_breadcrumbs;			
			
    @FindBy(xpath = "//a[text()='What Is Caregiver Burnout and Stress?']")
    private static WebElement caregiverburnoutstress_breadcrumbs;			
    ...
    @FindBy(xpath = "//div[@class='richTextEnhanced richText section richTextHyperlinkedImage default-style even last component col-xs-12']//a[@href='/supporting-caregivers/caregiver-fatigue/']")
...
//methods
    ...
    public void clickonCarewalkssupportResource_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(carewalkssupport_breadcrumbs);
    	clickElementUsingJavaScript(carewalkssupport_breadcrumbs);
    	pageLoad();
    }				
    public void clickoncaregiverburnout_Breadcrumbs() throws Exception {
    	waitForPageLoadJava();
    	moveToElement(caregiverburnoutstress_breadcrumbs);
    	clickElementUsingJavaScript(caregiverburnoutstress_breadcrumbs);
    	pageLoad();
    }						
