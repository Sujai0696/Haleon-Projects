...
public class VoltarengelAnklePage extends BaseClass{
	
	public VoltarengelAnklePage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/exercises/ankle/']//self::a[text()='Ankle Arthritis Exercises for Pain Relief']")
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/family/']//ancestor::strong[text()='READ MORE']")
