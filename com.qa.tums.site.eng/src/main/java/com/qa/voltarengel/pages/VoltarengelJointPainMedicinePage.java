...
public class VoltarengelJointPainMedicinePage extends BaseClass{
	
	public VoltarengelJointPainMedicinePage() {
    ...
    @FindBy(xpath = "//a[@href='/living-with-arthritis/joint-pain-medicine/']//self::a[text()='Joint Pain Medicine']")
    ...
    @FindBy(xpath = "//a[contains(@href,'https://www.advil.com/our-products/?')]//self::a[text()='Advil']")
    private static WebElement hyperLinkAdvil;
    
    @FindBy(xpath = "//a[@href='/understanding-pain/about-pain/']//self::a[text()='about pain']")
    private static WebElement hyperLinkAboutPain;
    
    @FindBy(xpath = "//a[@href='/living-with-arthritis/managing-arthritis/']//self::a[text()='managing your arthritis symptoms']")
    private static WebElement hyperLinkManagingYourArthritisSymptoms;
    ...
    @FindBy(xpath = "//a[contains(@href,'https://www.voltarengel.com/living-with-arthritis/natural-remedies/')]//ancestor::strong[text()='READ MORE']")
    private static WebElement relatedArticleReadMoreOne;
    
    @FindBy(xpath = "//a[contains(@href,'https://www.voltarengel.com/what-is-arthritis/symptoms/')]//ancestor::strong[text()='READ MORE']")
	...
	public void clickHyperLinkAdvil() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkAdvil)) {
			scrollDownUsingElement(hyperLinkAdvil);
			clickElementUsingJavaScript(hyperLinkAdvil);
			pageLoad();
			System.out.println("Hyper Link Advil is clicked successfully");
		} else {
			System.out.println("Hyper Link Advil is not preseneted in the page");
			throw new Exception("Hyper Link Advil is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkAboutPain() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkAboutPain)) {
			scrollDownUsingElement(hyperLinkAboutPain);
			clickElementUsingJavaScript(hyperLinkAboutPain);
			pageLoad();
			System.out.println("Hyper Link About Pain is clicked successfully");
		} else {
			System.out.println("Hyper Link About Pain is not preseneted in the page");
			throw new Exception("Hyper Link About Pain is not preseneted in the page");
		}
	}
	
	public void clickHyperLinkManagingYourArthritisSymptoms() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(hyperLinkManagingYourArthritisSymptoms)) {
			scrollDownUsingElement(hyperLinkManagingYourArthritisSymptoms);
			clickElementUsingJavaScript(hyperLinkManagingYourArthritisSymptoms);
			pageLoad();
			System.out.println("Hyper Link Managing Your Arthritis Symptoms is clicked successfully");
		} else {
			System.out.println("Hyper Link Managing Your Arthritis Symptoms is not preseneted in the page");
			throw new Exception("Hyper Link Managing Your Arthritis Symptoms is not preseneted in the page");
		}
	}
