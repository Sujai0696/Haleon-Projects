...
public class EnoUnderstandingAcidity extends BaseClass{
	public EnoUnderstandingAcidity() {
	...
	@FindBy(xpath = "//img[@title='Living life acidity free']/../..")
	private static WebElement LivingLifeAcidityFree;
	
	@FindBy(xpath = "//img[@title='Home Remedies to Cure Acidity']/../..")
	private static WebElement HomeRemediestoCureAcidity;
	...
	public void clickonHomeRemediestoCureAcidity() throws Exception {
		waitForPageLoadJava();
		scrollDownUsingElement(HomeRemediestoCureAcidity);
		clickElementUsingJavaScript(HomeRemediestoCureAcidity);
	}
