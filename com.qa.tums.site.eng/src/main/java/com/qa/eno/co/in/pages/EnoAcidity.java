...
public class EnoAcidity extends BaseClass{
	public EnoAcidity() {
	...
	@FindBy(xpath = "//figure//a[@title='Initial Symptoms Of Acidity']/..")
	private static WebElement InitialSymptomsOfAcidity;
	
	@FindBy(xpath = "//figure//a[@title='Dealing acidity at Night']/..")
	private static WebElement DealingWithAcidityAtNight;
	
	@FindBy(xpath = "//figure//a//img[@title='Home remedies for acidity']/..")
	...
	public void clickonInitialSymptomsOfAcidity() throws Exception {
		waitForPageLoadJava();
		scrollDownUsingElement(InitialSymptomsOfAcidity);
		clickElementUsingJavaScript(InitialSymptomsOfAcidity);
	}
