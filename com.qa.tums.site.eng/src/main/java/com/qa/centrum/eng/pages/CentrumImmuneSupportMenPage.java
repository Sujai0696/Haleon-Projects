...
public class CentrumImmuneSupportMenPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum Minis Immune Men']")
	...
	@FindBy(xpath = "//h2[text()='Centrum Minis Men Immune Support 160ct']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Minis Immune Support Men ']")
