...
public class CentrumFolicAcidPage extends BaseClass{
	...
	@FindBy(xpath = "//h2[text()='Centrum  ADULT 130CT']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Folic Acid']")
	...
	public void clickGigyaForm() throws Exception {
		...
		public void clickProductSilverAdults() throws Exception {
			...
			scrollDownUsingElement(featuredProducts);
			clickElementUsingJavaScript(featuredProducts);
			if (isElementPresent(productSilverAdults)) {
				scrollDownUsingElement(productSilverAdults);
				clickElementUsingJavaScript(productSilverAdults);
			} else {
