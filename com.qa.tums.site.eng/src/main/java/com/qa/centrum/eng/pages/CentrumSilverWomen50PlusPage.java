...
public class CentrumSilverWomen50PlusPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum Silver Women']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Silver Women 50+']")
