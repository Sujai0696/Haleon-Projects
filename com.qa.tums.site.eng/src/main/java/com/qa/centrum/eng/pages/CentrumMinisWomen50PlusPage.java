...
public class CentrumMinisWomen50PlusPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum Minis Women']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Minis Women 50+']")
