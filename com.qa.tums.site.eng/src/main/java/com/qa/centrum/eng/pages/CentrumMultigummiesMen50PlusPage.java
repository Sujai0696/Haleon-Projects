...
public class CentrumMultigummiesMen50PlusPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for centrum-multigummies-men50']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum MultiGummies Men 50+ Multivitamin']")
