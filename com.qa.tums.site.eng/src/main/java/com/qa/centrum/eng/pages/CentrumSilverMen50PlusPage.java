...
public class CentrumSilverMen50PlusPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum Silver Men']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Silver Men 50+']")
