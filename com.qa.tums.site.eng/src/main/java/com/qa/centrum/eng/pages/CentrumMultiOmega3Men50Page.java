...
public class CentrumMultiOmega3Men50Page extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum MultiI+Omega Men']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Multi + Omega-3 Men 50+']")
