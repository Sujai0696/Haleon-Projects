...
public class CentrumAllArticlesPage extends BaseClass{
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='All Articles']")
...
//				elementClick(showMoreArticle);
	...
	public void clickWorkFromHome() throws Exception {
		scrollArticleOne();
		scrollDownUsingElement(workFromHome);
	...
	public void clickHealthAndStrong() throws Exception {
		scrollArticleOne();
		scrollArticleOne();
		scrollDownUsingElement(healthAndStrong);
		clickElementUsingJavaScript(healthAndStrong);
	}
