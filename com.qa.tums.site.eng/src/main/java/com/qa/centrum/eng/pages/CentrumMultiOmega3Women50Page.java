...
public class CentrumMultiOmega3Women50Page extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum Multi+Omega Women']")
	...
	@FindBy(xpath = "//div[@class='richText component section product-detail-buttons reset-margin-y even col-xs-6']//ancestor::a[text()='Get Coupons']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Multi + Omega-3 Women 50+']")
