...
public class CentrumMultigummiesWomenPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum MultiGummies Women']")
	...
	@FindBy(xpath = "//div[@class='ps-product-details']//following::h2[text()='Centrum MultiGummies Women']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum MultiGummies Women ']")
