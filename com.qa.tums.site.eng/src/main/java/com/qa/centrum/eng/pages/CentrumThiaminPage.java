...
public class CentrumThiaminPage extends BaseClass{
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Thiamin']")
	...
	public void clickGigyaForm() throws Exception {
		...
		public void clickProductAdultsFiftyPlus() throws Exception {
			...
			scrollDownUsingElement(featuredProducts);
			clickElementUsingJavaScript(featuredProducts);
			if (isElementPresent(productAdultsFiftyPlus)) {
				scrollDownUsingElement(productAdultsFiftyPlus);
				clickElementUsingJavaScript(productAdultsFiftyPlus);
			} else {
