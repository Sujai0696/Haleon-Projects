...
public class CentrumCopperPage extends BaseClass {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Copper']")
	...
	public void clickGigyaForm() throws Exception {
		...
		public void clickProductSilverMen() throws Exception {
			...
			scrollDownUsingElement(featuredProducts);
			clickElementUsingJavaScript(featuredProducts);
			if (isElementPresent(productSilverMen)) {
				scrollDownUsingElement(productSilverMen);
				clickElementUsingJavaScript(productSilverMen);
			} else {
