...
public class CentrumDebunkingVitaminPage extends BaseClass{
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even ']//ancestor::a[text()='How Supplements Work']")
	private static WebElement breadcrumbFour;

	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Debunking Myths Around Vitamins']")
