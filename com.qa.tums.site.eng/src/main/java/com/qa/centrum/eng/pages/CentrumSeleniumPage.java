...
public class CentrumSeleniumPage extends BaseClass{
	...
	@FindBy(xpath = "//strong[text()='Immune Health']//ancestor::div[contains(@class,'box component section bg-color-white rounded')]")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Selenium']")
