...
public class CentrumMinisAdults50PlusPage extends BaseClass{
	...
	@FindBy(xpath = "//span[text()='My Review for Centrum Minis Adult']")
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//ancestor::a[text()='Centrum Minis Adults 50+']")
