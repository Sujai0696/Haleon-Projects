...
public class TherafluShareHomeNotColdPage extends BaseClass{
	
	public TherafluShareHomeNotColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Cleaning Your House During Cold and Flu Season ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/cold-flu-prevention/' and text()='germ free']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/prevention/how-to-wash-your-hands/' and text()='Wash your hands']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/survive-flu-with-kids/' and text()='protecting your children']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/avoid-catching-kids-cold/' and text()='fall sick yourself']")
	...
	@FindBy(xpath = "//h4[text()='How To Avoid Catching a Cold From Your Kids']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
