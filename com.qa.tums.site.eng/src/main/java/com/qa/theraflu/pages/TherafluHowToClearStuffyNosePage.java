...
public class TherafluHowToClearStuffyNosePage extends BaseClass{
	
	public TherafluHowToClearStuffyNosePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' How to Clear a Stuffy Nose ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/what-is-common-cold/' and text()='common cold']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/what-is-common-cold/' and text()='flu']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/sore-throat/' and text()='sore throat pain']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/products/sinus-and-pain-product/' and text()='Theraflu Sinus & Pain Hot Liquid Powder,']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/' and text()='Theraflu Symptoms Hub']")
