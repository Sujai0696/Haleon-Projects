...
public class TherafluHowToCleanYourHouseAfterTheFluPage extends BaseClass{
	
	public TherafluHowToCleanYourHouseAfterTheFluPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Disinfect Your House After the Flu ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/what-is-flu/' and text()='flu']")
	private static WebElement bannerImgLinkOne;
	
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/prevention/' and text()='resource center']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-long-cold-flu-last/' and text()='cold and flu']")
	...
	@FindBy(xpath = "//h4[text()='Hand Sanitizer vs. Hand Washing']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
