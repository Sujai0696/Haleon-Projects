...
public class TherafluDaytimeFluReliefMaxStrengthHotLiquidPowderPage extends BaseClass{
	
	public TherafluDaytimeFluReliefMaxStrengthHotLiquidPowderPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Daytime Flu Relief Max Strength Hot Liquid Powder']")
	...
	@FindBy(xpath = "//span[text()='My Review for THERAFLU MAX STRENGTH RELIEF DT 6CT']")
	private static WebElement txtReview;
	
	@FindBy(xpath = "//button[@class='bv-mbox-close bv-focusable' and @name='Cancel']")
	...
	@FindBy(xpath = "//a[@href='/products/nighttime-flu-relief-max-strength-hot-liquid-powder/' and text()='Nighttime Flu Relief Max Strength Hot Liquid Powder']")
