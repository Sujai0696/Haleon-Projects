...
public class TherafluComboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersPage extends BaseClass{
	
	public TherafluComboDayNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowdersPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Combo Daytime/Nighttime Severe Cold Relief Honey Lemon Flavor Hot Liquid Powders']")
	...
	@FindBy(xpath = "//span[text()='My Review for Day/Night - Hot Liquid Powder Value Pack']")
	...
	@FindBy(xpath = "(//li[@class='imageGallery-thumbnail even'])[2]")
	...
	@FindBy(xpath = "//li[@class='imageGallery-thumbnail odd last']")
	private static WebElement imgFive;
	
	@FindBy(xpath = "//li[@class='imageGallery-thumbnail odd last is-active']")
	private static WebElement imgActiveFive;
	...
	@FindBy(xpath = "//a[text()='How Important Is Sleep When You Have A Cold?']//ancestor::div[@class='component-content left']")
	private static WebElement relatedArticleTwo;
	
	
	
	
	@FindBy(xpath = "(//h4[text()='Daytime Severe Cold Relief Berry Burst Flavor Hot Liquid Powder'])[2]")
	private static WebElement featuredProductsOne;
	
	@FindBy(xpath = "(//h4[text()='Nighttime Severe Cold Relief Citrus Green Tea Flavor Hot Liquid Powder'])[2]")
	private static WebElement featuredProductsTwo;
	
	@FindBy(xpath = "(//h4[text()='Theraflu Nighttime Multi-Symptom Severe Cold Hot Liquid Powder'])[2]")
...
//			clickElementUsingJavaScript(breadcrumbTwo);
	...
	public void clickImgCarousel() throws Exception{
		...
		if (isElementPresent(imgActiveOne)) {
			...
			pageLoad();
			clickElementUsingJavaScript(imgFive);
			visibilityOf(imgActiveFive);
			Assert.assertTrue(elementIsDisplayed(imgActiveFive));
			pageLoad();
