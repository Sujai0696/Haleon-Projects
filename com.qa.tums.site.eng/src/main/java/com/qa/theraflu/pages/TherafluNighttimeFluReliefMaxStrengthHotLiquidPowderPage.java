...
public class TherafluNighttimeFluReliefMaxStrengthHotLiquidPowderPage extends BaseClass{
	
	public TherafluNighttimeFluReliefMaxStrengthHotLiquidPowderPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Nighttime Flu Relief Max Strength Hot Liquid Powder']")
	...
	@FindBy(xpath = "//span[text()='My Review for THERAFLU MAX STRENGTH RELIEF NT 6CT']")
	...
	@FindBy(xpath = "//a[@href='/products/daytime-flu-relief-max-strength-hot-liquid-powder/' and text()='Daytime Flu Relief Max Strength Hot Liquid Powder']")
