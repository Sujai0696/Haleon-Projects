...
public class TherafluSoreThroatPage extends BaseClass{
	
	public TherafluSoreThroatPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' What Is a Sore Throat? ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-cold-and-flu-viruses-spread/' and text()='cold or the flu.']")
	...
	@FindBy(xpath = "//a[@href='/products/' and text()='over-the-counter cold and flu medicines']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "(//a[@href='/products/flu-sore-throat/' and text()='Theraflu'])[1]")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "(//a[@href='/products/flu-sore-throat/'])[2]")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "(//a[@href='/products/flu-sore-throat/'])[3]")
	...
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/sinus-congestion/' and text()='sinus congestion']")
	...
	@FindBy(xpath = "//h4[text()='Sore Throat Home Remedies']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='Cold and Flu Symptoms: Nasal Congestion']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
