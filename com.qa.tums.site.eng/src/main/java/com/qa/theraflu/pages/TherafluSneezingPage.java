...
public class TherafluSneezingPage extends BaseClass{
	
	public TherafluSneezingPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' What Causes Sneezing ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/prevention/how-to-wash-your-hands/' and text()='wash your hands']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-to-clean-your-house-after-the-flu/' and text()='clean any nearby surfaces']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/avoid-catching-kids-cold/' and text()='young children']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/products/expressmax-severe-cold-cough-caplets-value-pack/']")
