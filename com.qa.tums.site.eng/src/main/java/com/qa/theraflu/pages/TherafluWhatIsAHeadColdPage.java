...
public class TherafluWhatIsAHeadColdPage extends BaseClass{
	
	public TherafluWhatIsAHeadColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' What Is a Head Cold? ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/products/expressmax-severe-cold-flu-syrup/' and text()='Theraflu ExpressMax Severe Cold and Flu Syrup']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/products/nighttime-severe-cold-relief-citrus-green-tea-flavor-hot-liquid-powder/' and text()='Theraflu Multi-Symptom Hot Liquid Powder']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/' and text()='Theraflu products']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/why-you-need-to-see-a-doctor/' and text()='go to the doctor']")
	...
	@FindBy(xpath = "//h4[text()='What Causes a Common Cold?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
