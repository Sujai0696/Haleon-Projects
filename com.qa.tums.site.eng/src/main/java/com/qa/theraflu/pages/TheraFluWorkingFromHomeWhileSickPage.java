...
public class TheraFluWorkingFromHomeWhileSickPage extends BaseClass{
	
	public TheraFluWorkingFromHomeWhileSickPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Work from Home While Sick ']")
	...
	@FindBy(xpath = "//h4[text()='Share Your Home, Not Your Cold']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesTwo;
	
	@FindBy(xpath = "//h4[text()='Healthy Ways to Travel During Flu Season']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesThree;
	
	@FindBy(xpath = "//h4[text()='Should You Work Out When You’re Sick?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
