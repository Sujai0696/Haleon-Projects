...
public class TherafluHowToRelieveSinusPressurePage extends BaseClass{
	
	public TherafluHowToRelieveSinusPressurePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' How to Relieve Sinus Pressure ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/products/sinus-and-nasal-congestion/']//strong[text()='Over-the-counter nasal decongestants']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/sinus-congestion/']//strong[text()='sinus congestion']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/combo-day-nighttime-severe-cold-relief-honey-lemon-flavor-hot-liquid-powders/']//strong[text()='Theraflu Day/Night Cold and Flu Hot Liquid Powder Value Pack']")
