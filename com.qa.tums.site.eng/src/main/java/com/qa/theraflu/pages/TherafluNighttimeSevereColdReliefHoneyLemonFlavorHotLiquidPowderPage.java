...
public class TherafluNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage extends BaseClass{
	
	public TherafluNighttimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Nighttime Severe Cold Relief Honey Lemon Flavor Hot Liquid Powder']")
	...
	@FindBy(xpath = "//span[text()='My Review for Nighttime Severe Cold & Cough - Hot Liquid Powder']")
	...
	@FindBy(xpath = "//a[text()='Theraflu Daytime Severe Cold Relief.' and @href='/products/daytime-severe-cold-relief-berry-burst-flavor-hot-liquid-powder/']")
	...
	@FindBy(xpath = "//a[text()='Best Food & Drink for a Sore Throat']//ancestor::div[@class='component-content left']")
	...
	@FindBy(xpath = "(//h4[text()='Combo Daytime/Nighttime Severe Cold Relief Honey Lemon Flavor Hot Liquid Powders'])[2]")
	private static WebElement featuredProductsTwo;
	
	@FindBy(xpath = "(//h4[text()='Daytime Severe Cold Relief Honey Lemon Flavor Hot Liquid Powder'])[2]")
