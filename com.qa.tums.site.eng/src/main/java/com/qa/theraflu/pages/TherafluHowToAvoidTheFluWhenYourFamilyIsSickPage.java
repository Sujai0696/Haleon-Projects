...
public class TherafluHowToAvoidTheFluWhenYourFamilyIsSickPage extends BaseClass{
	
	public TherafluHowToAvoidTheFluWhenYourFamilyIsSickPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Avoid the Flu When Your Family Has It ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/' and text()='flu symptoms']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/prevention/hand-sanitizer-vs-hand-washing/' and text()='alcohol-based hand sanitizer']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/prevention/' and text()='Theraflu Power Living center']")
