...
public class TherafluShouldYouDrinkAlcoholWhenYouHaveColdPage extends BaseClass{
	
	public TherafluShouldYouDrinkAlcoholWhenYouHaveColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Should You Drink Alcohol When You Have a Cold? ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='http://www.labfinder.com/' and text()='LabFinder']")
