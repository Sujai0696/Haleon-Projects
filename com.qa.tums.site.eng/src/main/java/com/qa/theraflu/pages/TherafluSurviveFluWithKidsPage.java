...
public class TherafluSurviveFluWithKidsPage extends BaseClass{
	
	public TherafluSurviveFluWithKidsPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Parenting While Sick With the Flu ']")
	...
	@FindBy(xpath = "//h4[text()='How to Clean Your House After Someone Gets Sick']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='What to Drink When You Have the Flu']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesThree;
	
	@FindBy(xpath = "//h4[text()='What Are the First Signs of the Flu?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
