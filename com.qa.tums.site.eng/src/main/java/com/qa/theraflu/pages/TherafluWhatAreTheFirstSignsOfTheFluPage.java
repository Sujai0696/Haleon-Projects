...
public class TherafluWhatAreTheFirstSignsOfTheFluPage extends BaseClass{
	
	public TherafluWhatAreTheFirstSignsOfTheFluPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' First Symptoms of the Flu ']")
	...
	@FindBy(xpath = "//a[@href='/treating-cold-flu/fighting-flu/' and text()='Theraflu Power Living']")
	...
	@FindBy(xpath = "//h4[text()='Flu Recovery Timeline']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
