...
public class TherafluHowToBreakAFeverPage extends BaseClass{
	
	public TherafluHowToBreakAFeverPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How To Break a Fever ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-to-treat-fever/' and text()='fever']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/what-is-a-low-grade-fever/' and text()='low-grade.']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/all/' and text()='Theraflu.']")
