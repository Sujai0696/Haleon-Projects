...
public class TherafluHowToRelieveFluBodyAchesPage extends BaseClass{
	
	public TherafluHowToRelieveFluBodyAchesPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to relieve body aches from flu ']")
	...
	@FindBy(xpath = "//a[@href='/treating-cold-flu/early-signs-cold-flu/' and text()='early signs of the flu']")
