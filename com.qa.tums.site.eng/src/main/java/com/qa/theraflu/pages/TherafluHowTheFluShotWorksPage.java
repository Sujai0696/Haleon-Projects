...
public class TherafluHowTheFluShotWorksPage extends BaseClass{
	
	public TherafluHowTheFluShotWorksPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How Does the Flu Shot Work? ']")
	...
	@FindBy(xpath = "//a[@href='/treating-cold-flu/cold-flu-prevention/' and text()=' flu']")
