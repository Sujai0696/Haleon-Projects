...
public class TherafluSoreThroatHomeRemediesPage extends BaseClass{
	
	public TherafluSoreThroatHomeRemediesPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Home Remedies to Help Treat a Sore Throat ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/prevention/immune-system-boosting-tips/' and text()='immune system']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/prevention/antibiotics-dont-work-for-everything/' and text()='Usually, antibiotics aren’t prescribed to treat sore throats']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "(//a[@href='/treating-cold-flu/symptoms/nasal-congestion/' and text()='nasal congestion'])[1]")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/why-drink-fluids-when-sick/' and text()='Staying hydrated and keeping your fluids up']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/products/flu-sore-throat/']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/sore-throat/' and text()='symptoms of your sore throat']")
	private static WebElement hyperLinkSix;
	
	@FindBy(xpath = "(//a[@href='/treating-cold-flu/symptoms/nasal-congestion/' and text()='nasal congestion'])[2]")
	private static WebElement hyperLinkSeven;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/headache/' and text()='headache']")
	private static WebElement hyperLinkEight;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/symptoms/sore-throat/' and text()='causes of sore throats']")
	private static WebElement hyperLinkNine;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/cold-flu-prevention/' and text()='prevent getting colds and the flu']")
	...
	@FindBy(xpath = "//h4[text()='How to stay hydrated when sick']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
