...
public class TherafluHowToTreatFluSymptomsPage extends BaseClass{
	
	public TherafluHowToTreatFluSymptomsPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Treat Flu Symptoms ']")
