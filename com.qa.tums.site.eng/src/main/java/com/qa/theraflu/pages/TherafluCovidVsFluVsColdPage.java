...
public class TherafluCovidVsFluVsColdPage extends BaseClass{
	
	public TherafluCovidVsFluVsColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' COVID vs. Flu vs. Cold ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/what-causes-the-flu/' and text()='the flu']")
	private static WebElement bannerImgLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/what-causes-common-cold/' and text()='the common cold']")
	private static WebElement bannerImgLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/coronavirus/2019-ncov/index.html']")
	private static WebElement bannerImgLinkThree;
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/facts-about-flu-vaccine/' and text()='getting vaccinated against the flu']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/coronavirus/2019-ncov/prevent-getting-sick/about-face-coverings.html' and text()='mask']")
	...
	@FindBy(xpath = "//h4[text()='Can You Drink Coffee When You Feel Sick?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='Should You Drink Alcohol When You Have a Cold?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
