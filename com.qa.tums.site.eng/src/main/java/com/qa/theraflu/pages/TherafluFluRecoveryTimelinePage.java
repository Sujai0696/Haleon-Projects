...
public class TherafluFluRecoveryTimelinePage extends BaseClass{
	
	public TherafluFluRecoveryTimelinePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Flu Recovery Timeline ']")
