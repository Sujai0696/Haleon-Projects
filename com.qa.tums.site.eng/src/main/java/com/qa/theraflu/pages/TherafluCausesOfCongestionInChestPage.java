...
public class TherafluCausesOfCongestionInChestPage extends BaseClass{
	
	public TherafluCausesOfCongestionInChestPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Causes of Congestion in Chest ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/why-drink-fluids-when-sick/' and text()='stay hydrated']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/what-causes-common-cold/' and text()='common cold is caused by a viral infection']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/' and text()='cold and flu symptoms']")
