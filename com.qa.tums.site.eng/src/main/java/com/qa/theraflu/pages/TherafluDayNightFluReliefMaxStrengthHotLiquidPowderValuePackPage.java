...
public class TherafluDayNightFluReliefMaxStrengthHotLiquidPowderValuePackPage extends BaseClass{
	
	public TherafluDayNightFluReliefMaxStrengthHotLiquidPowderValuePackPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Day/Night Flu Relief Max Strength Hot Liquid Powder Value Pack']")
	...
	@FindBy(xpath = "//span[text()='My Review for THERAFLU MAX STRENGTH RELIEF DT/NT 2X6CT']")
