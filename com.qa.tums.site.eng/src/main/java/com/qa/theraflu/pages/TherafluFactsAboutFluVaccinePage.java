...
public class TherafluFactsAboutFluVaccinePage extends BaseClass{
	
	public TherafluFactsAboutFluVaccinePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Here Are the Facts About The Influenza Vaccine ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/prevent/vaccine-benefits.htm' and text()='according to the Centers for Disease Control and Prevention']")
	private static WebElement bannerImgkLinkOne;
	
	
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/vaccines/index.htm' and text()='antibodies develop throughout']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/vaccines/index.htm' and text()='research is conducted annually']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/about/viruses/types.htm' and text()=\"influenza A (H1N1) virus, an influenza A (H3N2) virus, and influenza B\"]")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/consumer/vaccinations.htm' and text()=\"the CDC strongly recommends\"]")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[text()='Dr. Jason Kessler']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='/products/' and text()='Theraflu Multi-Symptom Severe Cold']")
	private static WebElement hyperLinkSix;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/at-home-cold-remedies/' and text()='home remedies page']")
	private static WebElement hyperLinkSeven;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/about/qa/misconceptions.htm' and text()='According to the CDC']")
	private static WebElement hyperLinkEight;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/about/qa/misconceptions.htm' and text()='The CDC advises against this']")
	...
	@FindBy(xpath = "//h4[text()='Flu Shots: Myths vs. Facts']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesTwo;
	
	@FindBy(xpath = "//h4[text()='How To Survive The Flu When You Have Kids']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
...
//			clickElementUsingJavaScript(breadcrumbTwo);
	...
	public void clickBannerImgLinkOne() throws Exception{
		waitForPageLoadJava();
		if (isElementPresent(bannerImgkLinkOne)) {
			scrollDownUsingElement(bannerImgkLinkOne);
			clickElementUsingJavaScript(bannerImgkLinkOne);
			pageLoad();
			System.out.println("bannerImgkLinkOne clicked successfully");
		} else {
			System.out.println("bannerImgkLinkOne is not presented in the page");
			throw new Exception("bannerImgkLinkOne is not presented in the page");
		}
	}
