...
public class TherafluHowColdAndFluVirusesSpreadPage extends BaseClass{
	
	public TherafluHowColdAndFluVirusesSpreadPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How Cold and Flu Viruses Spread ']")
