...
public class TherafluAvoidCatchingKidsColdPage extends BaseClass{
	
	public TherafluAvoidCatchingKidsColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Avoid Catching a Cold From Your Kids ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/handwashing/why-handwashing.html' and text()='the mouth, nose, and eyes']")
	private static WebElement bannerImgLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/handwashing/why-handwashing.html' and text()='greatly reduce']")
	...
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/handwashing/why-handwashing.html' and text()='Handwashing with soap']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/school/cleaning.htm' and text()='surfaces in common areas']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/features/rhinoviruses/index.html' and text()='additional germ spreading']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='https://www.mayoclinic.org/healthy-lifestyle/fitness/in-depth/aerobic-exercise/art-20045541' and text()='exercise are important']")
	private static WebElement hyperLinkFour;
	
	
	@FindBy(xpath = "//a[@href='https://www.mayoclinic.org/symptoms/nasal-congestion/basics/when-to-see-doctor/sym-20050644' and text()='mucus less favorable for the germs']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='https://www.mayoclinic.org/diseases-conditions/insomnia/expert-answers/lack-of-sleep/faq-20057757' and text()='sleep deprivation can reduce immunity']")
	...
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/features/rhinoviruses/index.html' and text()='signs of contagiousness']")
	private static WebElement hyperLinkEight;
	
	@FindBy(xpath = "//a[@href='/prevention/' and text()='Theraflu Prevention page']")
	...
	@FindBy(xpath = "//h4[text()='At-Home Cold Remedies']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesOne;
	
	@FindBy(xpath = "//h4[text()='How to Wash Your Hands']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='How to Clean Your House After the Flu']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
