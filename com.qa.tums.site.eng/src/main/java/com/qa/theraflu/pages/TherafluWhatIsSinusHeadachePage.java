...
public class TherafluWhatIsSinusHeadachePage extends BaseClass{
	
	public TherafluWhatIsSinusHeadachePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' What Is a Sinus Headache? ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/' and text()='cold or viral upper respiratory infection']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/products/sinus-and-nasal-congestion/' and text()='Theraflu Sinus & Pain']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/hot-liquid-powders/' and text()='Theraflu Hot Liquid Powder']")
	...
	@FindBy(xpath = "//h4[text()='What Is a Headache?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//a[@href='/treating-cold-flu/tips-good-night-sleep-when-sick/']//ancestor::div[@class='image component section article-card anchor-box dynamic-article-card zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesThree;
	
	@FindBy(xpath = "//h4[text()='Cold and Flu: Do’s and Don’ts']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
