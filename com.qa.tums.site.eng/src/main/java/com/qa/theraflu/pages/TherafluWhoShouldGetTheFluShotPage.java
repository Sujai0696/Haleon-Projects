...
public class TherafluWhoShouldGetTheFluShotPage extends BaseClass{
	
	
	public TherafluWhoShouldGetTheFluShotPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Who Should Get the Flu Shot ']")
