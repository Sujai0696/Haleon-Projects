...
public class TherafluBodyAchesPage extends BaseClass{
	
	public TherafluBodyAchesPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Cold & Flu Symptoms – Body Aches ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/the-difference-between-colds-allergies/' and text()='easiest way to tell the difference']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/fighting-flu-together-old/' and text()='fighting the flu']")
	...
	@FindBy(xpath = "//h4[text()='How to Avoid Cold & Flu']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
