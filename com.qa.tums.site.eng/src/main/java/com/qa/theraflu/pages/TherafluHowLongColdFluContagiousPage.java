...
public class TherafluHowLongColdFluContagiousPage extends BaseClass{
	
	public TherafluHowLongColdFluContagiousPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How Long Is the Flu or a Cold Contagious? ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/cold-flu-prevention/' and text()='prevent becoming infected with a cold or flu']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-long-cold-flu-last/' and text()='cold and flu symptoms']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/nasal-congestion/' and text()='flu symptoms']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/prevention/face-masks-for-protection/' and text()='wear a face mask']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/should-you-workout-when-you-are-sick/' and text()='if you should exercise or rest']")
	...
	@FindBy(xpath = "(//a[@href='/products/daytime-severe-cold-relief-honey-lemon-flavor-hot-liquid-powder/'])[2]")
	private static WebElement hyperLinkSeven;
	
	@FindBy(xpath = "//a[@href='/products/expressmax-severe-cold-flu-syrup/' and text()='Theraflu ExpressMax Severe Cold & Flu Syrup']")
	...
	@FindBy(xpath = "//h4[text()='How Long Do Cold or Flu Symptoms Last?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='Getting Over the Common Cold']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
