...
public class TherafluDifferenceBetweenColdAndFluPage extends BaseClass {
	
	public TherafluDifferenceBetweenColdAndFluPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Cold Vs. Flu: What Is the Difference? ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/cold-flu-treatment/' and text()=\"treat your symptoms\"]")
	...
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/what-are-the-first-signs-of-the-flu/' and text()='flu comes on more abruptly']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/products/hot-liquid-powders/' and text()=\"Theraflu’s great-tasting hot liquid powders\"]")
