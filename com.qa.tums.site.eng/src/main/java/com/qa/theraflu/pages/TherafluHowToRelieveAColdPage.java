...
public class TherafluHowToRelieveAColdPage extends BaseClass{
	
	public TherafluHowToRelieveAColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Relieve a Cold ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-to-stay-healthy-during-holiday-travel-season/' and text()='traveling during the holiday season']")
	private static WebElement bannerImgLinkOne;
	
	
	
	
	@FindBy(xpath = "//a[@href='/prevention/how-to-wash-your-hands/']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/prevention/what-is-social-distancing/']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/expressmax-daytime-severe-cold-cough/' and text()='Theraflu ExpressMax Daytime Severe Cold & Cough Syrup']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/fighting-cold/' and text()='common cold resources']")
	...
	@FindBy(xpath = "//h4[text()='Flu Shot Benefits']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
