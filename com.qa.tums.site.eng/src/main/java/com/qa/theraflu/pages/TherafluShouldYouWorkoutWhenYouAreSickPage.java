...
public class TherafluShouldYouWorkoutWhenYouAreSickPage extends BaseClass{
	
	public TherafluShouldYouWorkoutWhenYouAreSickPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Should You Work Out When You Are Sick? ']")
	...
	@FindBy(xpath = "//h4[text()='How to Treat Cold and Flu Symptoms']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='Is Zinc Good for Colds?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
