...
public class TherafluDayNightFluReliefMaxStrengthSyrupValuePackPage extends BaseClass{
	
	public TherafluDayNightFluReliefMaxStrengthSyrupValuePackPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Day/ Night Flu Relief Max Strength Syrup Value Pack']")
	...
	@FindBy(xpath = "//span[text()='My Review for THERAFLU MAX STRGTH RELIEF DT/NT 2X8.3CT']")
