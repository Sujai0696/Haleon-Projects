...
public class TherafluRecoveringFromFatigueAfterFluPage extends BaseClass{
	
	public TherafluRecoveringFromFatigueAfterFluPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Recovering from Fatigue After the Flu ']")
	...
	@FindBy(xpath = "//a[@href='/products/' and text()='over-the-counter products']")
