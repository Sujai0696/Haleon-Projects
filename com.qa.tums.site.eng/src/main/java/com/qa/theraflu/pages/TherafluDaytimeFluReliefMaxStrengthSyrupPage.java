...
public class TherafluDaytimeFluReliefMaxStrengthSyrupPage extends BaseClass{
	
	public TherafluDaytimeFluReliefMaxStrengthSyrupPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Daytime Flu Relief Max Strength Syrup']")
	...
	@FindBy(xpath = "//span[text()='My Review for THERAFLU MAX STRENGTH RELIEF DT 8.3OZ']")
