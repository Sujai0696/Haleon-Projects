...
public class TherafluNighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderPage extends BaseClass{
	
	public TherafluNighttimeSevereColdReliefCitrusGreenTeaFlavorHotLiquidPowderPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Nighttime Severe Cold Relief Citrus Green Tea Flavor Hot Liquid Powder']")
	...
	@FindBy(xpath = "//span[text()='My Review for Nighttime Multi-Symptom Severe Cold - Hot Liquid Powder']")
	...
	@FindBy(xpath = "//a[text()='Can You Drink Coffee When Sick?']//ancestor::div[@class='component-content left']")
	...
	@FindBy(xpath = "(//h4[text()='Theraflu Sinus & Pain Hot Liquid Powder'])[2]")
