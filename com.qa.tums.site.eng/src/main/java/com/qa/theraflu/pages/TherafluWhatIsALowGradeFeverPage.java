...
public class TherafluWhatIsALowGradeFeverPage extends BaseClass{
	
	public TherafluWhatIsALowGradeFeverPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' What Is a Low Grade Fever ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/why-chills-with-fever/' and text()='chills']")
	private static WebElement bannerImgLinkOne;
	
	
	@FindBy(xpath = "//a[@href='/prevention/' and text()='resource center']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/' and text()='cold and flu']")
