...
public class TherafluSecretsToStayHealthyColdAndFluSeasonPage extends BaseClass{
	
	public TherafluSecretsToStayHealthyColdAndFluSeasonPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Stay Healthy Through Cold and Flu Season ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/about/season/flu-season.htm' and text()='flu season']")
	private static WebElement bannerImgLinkOne;
	
	
	
	
	@FindBy(xpath = "//a[@href='https://medlineplus.gov/ency/article/007165.htm' and text()='Physical activity']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/products/nighttime-severe-cold-relief-citrus-green-tea-flavor-hot-liquid-powder/' and text()='Theraflu Nighttime Multi-Symptom Severe Cold Hot Liquid Powder']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/prevention/how-to-wash-your-hands/' and text()='Washing your hands']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/when-to-call-in-sick/' and text()='take the day off']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='/prevention/grab-and-go-5-drinks-and-foods-to-boost-your-immunity/' and text()='your immune system']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/facts-about-flu-vaccine/' and text()='the flu vaccine']")
	private static WebElement hyperLinkSix;
	
	@FindBy(xpath = "//a[@href='https://www.cdc.gov/flu/prevent/whoshouldvax.htm' and text()='CDC website']")
	...
	@FindBy(xpath = "//h4[text()='Here Are the Facts About the Influenza Vaccine']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
