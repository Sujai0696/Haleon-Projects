...
public class TherafluCoughReliefHotLiquidWorksPage extends BaseClass{
	
	public TherafluCoughReliefHotLiquidWorksPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Managing Your Cough: How Theraflu Works on Coughs ']")
	private static WebElement breadcrumbFour;
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/cough/' and text()='disruptive coughs']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "(//a[@href='https://www.theraflu.com/products/daytime-cough-relief/'])[1]")
	...
	@FindBy(xpath = "//a[@href='/about-theraflu/cold-flu-ingredients/' and text()='2 active ingredients']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/how-to-manage-annoying-cough/' and text()='calm down a bad cough']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/symptoms/sore-throat-home-remedies/' and text()='honey is also a good way to soothe a sore throat']")
	private static WebElement hyperLinkSix;
	
	@FindBy(xpath = "(//a[@href='https://www.theraflu.com/products/daytime-cough-relief/'])[2]")
	...
	@FindBy(xpath = "//h4[text()='11 Tips for Getting a Good Night’s Sleep When You’re Sick']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
