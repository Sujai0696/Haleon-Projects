...
public class TherafluDaytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderPage extends BaseClass{
	
	public TherafluDaytimeSevereColdReliefHoneyGingerFlavorHotLiquidPowderPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Daytime Severe Cold Relief Honey Ginger Flavor Hot Liquid Powder']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/products/nighttime-severe-cold-relief-honey-lemon-flavor-hot-liquid-powder/' and text()='Theraflu Nighttime Severe Cold Relief']")
	...
	@FindBy(xpath = "//span[text()='Warnings']//ancestor::header[@class='accordion-head']")
	private static WebElement AccFour;
	
	@FindBy(xpath = "//span[text()='Warnings']//ancestor::li[@class='accordion-slide even is-active']")
	private static WebElement AccActiveFour;
	
	@FindBy(xpath = "//span[text()='Warnings']//ancestor::li[@class='accordion-slide even']")
