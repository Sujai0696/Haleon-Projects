...
public class TherafluWhatCausesTheFluPage extends BaseClass{
	
	public TherafluWhatCausesTheFluPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' What Causes the Flu? ']")
	private static WebElement breadcrumbThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/when-cold-flu-season/' and text()='cold and flu season']")
	private static WebElement bannerImgLinkOne;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/the-difference-between-colds-allergies/' and text()='cold & flu tracker']")
