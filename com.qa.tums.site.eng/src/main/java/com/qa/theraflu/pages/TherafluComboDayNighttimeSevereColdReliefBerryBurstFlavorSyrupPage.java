...
public class TherafluComboDayNighttimeSevereColdReliefBerryBurstFlavorSyrupPage extends BaseClass{
	
	public TherafluComboDayNighttimeSevereColdReliefBerryBurstFlavorSyrupPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Combo Daytime/Nighttime Severe Cold Relief Berry Burst Flavor Syrup']")
	...
	@FindBy(xpath = "//span[text()='My Review for ExpressMax® Day/Night Value Pack Syrup']")
	...
	@FindBy(xpath = "(//h4[text()='Theraflu ExpressMax Severe Cold & Flu Syrup'])[2]")
	private static WebElement featuredProductsOne;
	
	@FindBy(xpath = "(//h4[text()='Theraflu ExpressMax Severe Cold & Cough Value Pack Caplets'])[2]")
