...
public class TherafluHowToTreatTheFluEarlyPage extends BaseClass{
	
	public TherafluHowToTreatTheFluEarlyPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Fighting Early Flu Symptoms ']")
