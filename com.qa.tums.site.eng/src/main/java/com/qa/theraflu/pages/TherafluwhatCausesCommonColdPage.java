...
public class TherafluwhatCausesCommonColdPage extends BaseClass{
	
	public TherafluwhatCausesCommonColdPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Common Cold Causes ']")
	...
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/why-drink-fluids-when-sick/' and text()='plenty of fluids']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/should-you-drink-alcohol-when-you-have-cold/' and text()='Alcohol can worsen cold symptoms']")
	...
	@FindBy(xpath = "//h4[text()='Learn How Cold and Flu Viruses Spread']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesTwo;
	
	@FindBy(xpath = "//h4[text()='Home Remedies to Help Treat a Sore Throat']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
