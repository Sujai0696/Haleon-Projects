...
public class TherafluFrequentColdsPage extends BaseClass{
	
	public TherafluFrequentColdsPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' What Causes Frequent Colds? ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/when-cold-flu-season/' and text()='peak cold & flu season']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/the-difference-between-colds-allergies/' and text()='confused for a cold']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/prevention/immune-system-boosting-tips/' and text()='prevent catching the common cold']")
	...
	@FindBy(xpath = "//h4[text()='What Is a Head Cold?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
