...
public class TherafluDaytimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage extends BaseClass{
	
	public TherafluDaytimeSevereColdReliefHoneyLemonFlavorHotLiquidPowderPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='Daytime Severe Cold Relief Honey Lemon Flavor Hot Liquid Powder']")
	...
	@FindBy(xpath = "//span[text()='My Review for Multi-Symptom Severe Cold - Hot Liquid Powder']")
	...
	@FindBy(xpath = "//a[text()='Theraflu Nighttime Severe Cold Relief' and @href='/products/nighttime-severe-cold-relief-honey-lemon-flavor-hot-liquid-powder/']")
	...
	@FindBy(xpath = "//a[text()='Why It’s So Important to Drink Fluids When You’re Sick']//ancestor::div[@class='component-content left']")
	private static WebElement relatedArticleTwo;
	
	
	
	
	@FindBy(xpath = "//li[@class='carousel-slide clearfix odd is-active first lslide active']//div[@class='snippetReference component section bg-color-white product-listing first odd last reference-Nighttime-Severe-Cold-Cough-Hot-Liquid-Powder']")
	private static WebElement featuredProductsOne;
	
	@FindBy(xpath = "//li[@class='carousel-slide clearfix even lslide']//div[@class='snippetReference component section bg-color-white product-listing first odd last reference-Cough-Relief-Hot-Liquid-Powder']")
	private static WebElement featuredProductsTwo;
	
	@FindBy(xpath = "//li[@class='carousel-slide clearfix odd lslide']//div[@class='snippetReference component section bg-color-white product-listing first odd last reference-Daytime-Severe-Cold-Cough-Hot-Liquid-Powder']")
	private static WebElement featuredProductsThree;
	
	@FindBy(xpath = "//li[@class='carousel-slide clearfix even last lslide']//div[@class='snippetReference component section bg-color-white product-listing first odd last reference-Theraflu-Flu-and-Sore-Throat-Hot-Liquid-Powder']")
