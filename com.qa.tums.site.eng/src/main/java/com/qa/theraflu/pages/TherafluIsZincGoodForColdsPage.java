...
public class TherafluIsZincGoodForColdsPage extends BaseClass{
	
	public TherafluIsZincGoodForColdsPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Is Zinc Good for Colds? ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='https://www.mayoclinic.org/drugs-supplements-zinc/art-20366112' and text()='Zinc is found']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5418896/' and text()='2017 analysis']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3136969/' and text()='review from 2011 of 13 studies']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='https://www.mayoclinic.org/drugs-supplements-zinc/art-20366112' and text()='are generally well tolerated']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='/products/daytime-severe-cold-relief-berry-burst-flavor-hot-liquid-powder/' and text()='Theraflu Daytime Severe Cold & Cough Hot Liquid Powder']")
	private static WebElement hyperLinkFive;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/at-home-cold-remedies/' and text()='at-home remedies']")
	private static WebElement hyperLinkSix;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/tips-good-night-sleep-when-sick/' and text()='getting enough sleep']")
	...
	@FindBy(xpath = "//h4[text()='Can Ginseng Cure My Cold?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	...
	@FindBy(xpath = "//h4[text()='Immune System Boosting Tips']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
