...
public class TherafluHowToTreatFeverPage extends BaseClass{
	
	public TherafluHowToTreatFeverPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' How to Treat a Fever ']")
	...
	@FindBy(xpath = "//a[@href='/products/flu-sore-throat/' and text()='Theraflu Flu & Sore Throat Hot Liquid Powder']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/prevention/' and text()='Theraflu Prevention and Care hub']")
	...
	@FindBy(xpath = "//h4[text()='What Is a Fever?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
	private static WebElement recommendedArticlesThree;
	
	@FindBy(xpath = "//h4[text()='Why Do We Get the Chills When We Have a Fever?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
