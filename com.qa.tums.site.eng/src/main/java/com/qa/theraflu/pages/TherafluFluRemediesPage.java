...
public class TherafluFluRemediesPage extends BaseClass{
	
	public TherafluFluRemediesPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Home Remedies for the Flu ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/tips-for-flu-recovery/' and text()='ease your flu symptoms']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='/products/flu-sore-throat/' and text()='provide soothing comfort,']")
	...
	@FindBy(xpath = "//a[@href='/treating-cold-flu/facts-about-flu-vaccine/' and text()='flu vaccine']")
