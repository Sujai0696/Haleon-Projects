...
public class TherafluSinusProblemsGuidePage extends BaseClass{
	
	public TherafluSinusProblemsGuidePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Sinus Problems Guide ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/getting-over-common-cold/' and text()='cold']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/amp/strange-facts-about-flu-virus.html' and text()='flu']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='/products/sinus-and-nasal-congestion/' and text()='Theraflu Sinus & Pain products']")
	...
	@FindBy(xpath = "//h4[text()='What Causes Sneezing?']//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
