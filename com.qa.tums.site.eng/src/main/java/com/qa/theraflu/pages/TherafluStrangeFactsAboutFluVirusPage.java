...
public class TherafluStrangeFactsAboutFluVirusPage extends BaseClass{
	
	public TherafluStrangeFactsAboutFluVirusPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Unusual Facts About the Flu ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='https://sph.umd.edu/news-item/flu-may-be-spread-just-breathing-new-study-shows-coughing-and-sneezing-not-required' and text()='research']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.sciencedaily.com/releases/2018/04/180403173707.htm' and text()='can actually protect us from infections']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.sciencedaily.com/releases/2016/02/160223102851.htm' and text()='Researchers at Aarhus University']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='/treating-cold-flu/how-the-flu-shot-works/' and text()='yearly flu shot']")
