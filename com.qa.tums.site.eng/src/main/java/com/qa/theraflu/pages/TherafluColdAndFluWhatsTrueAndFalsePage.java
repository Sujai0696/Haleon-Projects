...
public class TherafluColdAndFluWhatsTrueAndFalsePage extends BaseClass{
	
	public TherafluColdAndFluWhatsTrueAndFalsePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//self::li[text()=' Cold & Flu Do’s and Don’ts ']")
	private static WebElement breadcrumbThree;
	
	
	
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/is-feed-a-cold-starve-a-fever-true/' and text()='feed a cold and starve a fever']")
	private static WebElement hyperLinkOne;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/prevention/antibiotics-dont-work-for-everything/' and text()='antibiotics']")
	private static WebElement hyperLinkTwo;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/treating-cold-flu/how-the-flu-shot-works/' and text()='flu shot']")
	private static WebElement hyperLinkThree;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/prevention/healthy-chicken-soup-recipes/' and text()='Chicken soup']")
	private static WebElement hyperLinkFour;
	
	@FindBy(xpath = "//a[@href='https://www.theraflu.com/products/' and text()='Theraflu']")
	...
	@FindBy(xpath = "//h4[text()=\"Why Do I Get Sick in the Winter?\"]//ancestor::div[@class='image component section anchor-box zglazyload line-height-h3-1-2 related-articles first odd last']")
