...
public class RinazinaSprayNasalePage extends BaseClass{
	
	public RinazinaSprayNasalePage() {
		...
		private static WebElement RinazinaspraynasaleBreadcrumbs;	
		...
		public void clickonRinazinasprayNasaleBreadcrumbs() throws Exception {
			waitForPageLoadJava();
			visibilityOf(RinazinaspraynasaleBreadcrumbs);
			if (isElementPresent(RinazinaspraynasaleBreadcrumbs)) {
				Assert.assertTrue(elementIsDisplayed(RinazinaspraynasaleBreadcrumbs));
			} else {
				throw new Exception("RinazinaspraynasaleBreadcrumbs is  not Display");
			}
		}
