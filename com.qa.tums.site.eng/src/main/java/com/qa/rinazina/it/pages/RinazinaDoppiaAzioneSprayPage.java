...
public class RinazinaDoppiaAzioneSprayPage extends BaseClass{
	
	public  RinazinaDoppiaAzioneSprayPage() {
		...
		@FindBy(xpath = "//ol[@class=\"breadcrumbs-list breadcrumbs-without-separator\"]//child::a[text()='Home']")
		...
		@FindBy(xpath = "//ol[@class=\"breadcrumbs-list breadcrumbs-without-separator\"]//child::a[text()='Rinazina Doppia Azione Spray Nasale']")
		private static WebElement RinazinaDoppiaAzioneBreadcrumbs;	
		...
		public void clickonRinazinaDoppiaAzioneBreadcrumbs() throws Exception {
			waitForPageLoadJava();
			visibilityOf(RinazinaDoppiaAzioneBreadcrumbs);
			if (isElementPresent(RinazinaDoppiaAzioneBreadcrumbs)) {
				Assert.assertTrue(elementIsDisplayed(RinazinaDoppiaAzioneBreadcrumbs));
				
			} else {
				throw new Exception("Element RinazinaDoppiaAzioneBreadcrumbs is not presented on page");
			}
		}
