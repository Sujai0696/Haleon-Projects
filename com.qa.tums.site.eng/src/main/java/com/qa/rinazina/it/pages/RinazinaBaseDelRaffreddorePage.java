...
public class RinazinaBaseDelRaffreddorePage extends BaseClass{
	
	public RinazinaBaseDelRaffreddorePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item odd last is-current ']//ancestor::a[text()='CosՏ il raffreddore: gli aspetti scientifici alla base del raffreddore.']")
	...
	@FindBy(xpath = "//a[text()='Puoi detergere il naso e ripristinare la sua funzione di filtro grazie a un lavaggio con soluzione salina. ']//ancestor::div[@class='article-teaser teaserClick']")
