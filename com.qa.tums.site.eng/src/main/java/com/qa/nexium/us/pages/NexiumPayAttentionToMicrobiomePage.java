...
public class NexiumPayAttentionToMicrobiomePage extends BaseClass {
	
	public NexiumPayAttentionToMicrobiomePage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Do You Pay Attention to Your Microbiome? ']")
