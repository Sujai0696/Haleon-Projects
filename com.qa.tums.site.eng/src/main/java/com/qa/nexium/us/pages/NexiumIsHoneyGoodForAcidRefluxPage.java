...
public class NexiumIsHoneyGoodForAcidRefluxPage extends BaseClass{
	
	public NexiumIsHoneyGoodForAcidRefluxPage() {
	...
	@FindBy(xpath = "//li[@class='breadcrumb-list-item even last is-current ']//self::li[text()=' Heartburn Relief: Is Honey Good for Acid Reflux? ']")
